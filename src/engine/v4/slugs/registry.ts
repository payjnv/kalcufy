...
export const SLUG_REGISTRY: SlugEntry[] = [
  ...
  { id: "severance-calculator", category: "finance", slugs: { en: "severance-calculator", es: "calculadora-finiquito-liquidacion", pt: "calculadora-rescisao-trabalho", fr: "calculateur-indemnites-licenciement", de: "abfindungs-rechner" } },
  { id: "vat-calculator", category: "finance", slugs: { en: "vat-calculator", es: "calculadora-iva", pt: "calculadora-iva", fr: "calculateur-tva", de: "mehrwertsteuer-rechner" } },
  { id: "liters-to-gallons", category: "conversion", slugs: { en: "liters-to-gallons-calculator", es: "calculadora-litros-a-galones", pt: "calculadora-litros-para-galoes", fr: "calculateur-litres-vers-gallons", de: "liter-zu-gallonen-rechner" } },
  { id: "ml-to-oz", category: "conversion", slugs: { en: "ml-to-oz-calculator", es: "calculadora-ml-a-onzas-liquidas", pt: "calculadora-ml-para-oncas-fluidas", fr: "calculateur-ml-vers-onces-liquides", de: "ml-zu-fluessigkeitsunzen-rechner" } },
  { id: "ml-to-cups", category: "conversion", slugs: { en: "ml-to-cups-calculator", es: "calculadora-ml-tazas", pt: "calculadora-ml-para-xicaras", fr: "calculateur-ml-vers-tasses", de: "milliliter-zu-tassen-rechner" } },
  { id: "kmh-to-mph", category: "conversion", slugs: { en: "kmh-to-mph-calculator", es: "calculadora-conversion-kmh-mph", pt: "calculadora-kmh-para-mph", fr: "calculateur-conversion-kmh-mph", de: "kmh-zu-mph-rechner" } },
  { id: "square-meters-to-square-feet", category: "conversion", slugs: { en: "square-meters-to-square-feet-calculator", es: "calculadora-metros-cuadrados-a-pies-cuadrados", pt: "calculadora-metros-quadrados-para-pes-quadrados", fr: "calculateur-metres-carres-vers-pieds-carres", de: "quadratmeter-zu-quadratfuss-rechner" } },
  { id: "ml-to-tablespoons", category: "conversion", slugs: { en: "ml-to-tablespoons-calculator", es: "calculadora-ml-a-cucharadas", pt: "calculadora-ml-para-colheres-de-sopa", fr: "calculateur-ml-cuilleres-soupe", de: "milliliter-zu-essloeffel-rechner" } },
  { id: "liters-to-pints", category: "conversion", slugs: { en: "liters-to-pints-calculator", es: "calculadora-litros-a-pintas", pt: "calculadora-litros-para-pints", fr: "calculateur-litres-vers-pintes", de: "liter-zu-pints-rechner" } },
  { id: "teaspoons-to-ml", category: "conversion", slugs: { en: "teaspoons-to-ml-calculator", es: "calculadora-cucharaditas-a-ml", pt: "calculadora-colheres-cha-para-ml", fr: "calculateur-cuilleres-cafe-ml", de: "teeloeffel-zu-ml-rechner" } },
  { id: "grams-to-ounces", category: "conversion", slugs: { en: "grams-to-ounces-calculator", es: "calculadora-gramos-a-onzas", pt: "calculadora-gramas-para-oncas", fr: "calculateur-grammes-vers-onces", de: "gramm-zu-unzen-rechner" } },
  { id: "ounces-to-grams", category: "conversion", slugs: { en: "ounces-to-grams-calculator", es: "calculadora-onzas-a-gramos", pt: "calculadora-oncas-para-gramas", fr: "calculateur-onces-vers-grammes", de: "unzen-zu-gramm-rechner" } },
  { id: "quarts-to-liters", category: "conversion", slugs: { en: "quarts-to-liters-calculator", es: "calculadora-cuartos-a-litros", pt: "calculadora-quartos-para-litros", fr: "calculateur-quarts-vers-litres", de: "quart-zu-liter-rechner" } },
  { id: "hectares-to-acres", category: "conversion", slugs: { en: "hectares-to-acres-calculator", es: "calculadora-hectareas-a-acres", pt: "calculadora-hectares-para-acres", fr: "calculateur-hectares-vers-acres", de: "hektar-zu-acres-rechner" } },
  { id: "acres-to-hectares", category: "conversion", slugs: { en: "acres-to-hectares-calculator", es: "calculadora-acres-hectareas", pt: "calculadora-acres-para-hectares", fr: "calculateur-acres-vers-hectares", de: "acres-zu-hektar-umrechner" } },
  { id: "yards-to-meters", category: "conversion", slugs: { en: "yards-to-meters-calculator", es: "calculadora-yardas-a-metros", pt: "calculadora-jardas-para-metros", fr: "calculateur-yards-vers-metres", de: "yards-zu-meter-rechner" } },
  { id: "meters-to-yards", category: "conversion", slugs: { en: "meters-to-yards-calculator", es: "calculadora-metros-a-yardas", pt: "calculadora-metros-para-jardas", fr: "calculateur-metres-vers-yards", de: "meter-zu-yards-rechner" } },
  { id: "bytes-converter", category: "conversion", slugs: { en: "bytes-converter-calculator", es: "calculadora-conversor-bytes", pt: "calculadora-conversor-bytes", fr: "calculateur-convertisseur-octets", de: "bytes-umrechner" } },
  { id: "mpg-to-km-per-liter", category: "conversion", slugs: { en: "mpg-to-km-per-liter-calculator", es: "calculadora-mpg-a-kilometros-por-litro", pt: "calculadora-mpg-para-km-por-litro", fr: "calculateur-mpg-vers-kilometres-par-litre", de: "meilen-pro-gallone-zu-kilometer-pro-liter-rechner" } },
  { id: "psi-to-bar", category: "conversion", slugs: { en: "psi-to-bar-calculator", es: "calculadora-psi-a-bar", pt: "calculadora-conversao-psi-bar", fr: "calculateur-conversion-psi-bar", de: "psi-zu-bar-umrechner" } },
  { id: "watts-to-horsepower", category: "conversion", slugs: { en: "watts-to-horsepower-calculator", es: "calculadora-vatios-caballos-fuerza", pt: "calculadora-watts-para-cavalos-vapor", fr: "calculateur-watts-vers-chevaux-vapeur", de: "watt-zu-pferdestaerke-rechner" } },
  { id: "degrees-to-radians", category: "conversion", slugs: { en: "degrees-to-radians-calculator", es: "calculadora-grados-radianes", pt: "calculadora-graus-para-radianos", fr: "calculateur-degres-vers-radians", de: "grad-zu-bogenmass-rechner" } },
  { id: "hectareas-to-tareas", category: "conversion", slugs: { en: "hectareas-to-tareas-calculator", es: "calculadora-hectareas-a-tareas", pt: "calculadora-hectares-para-tareas", fr: "calculateur-hectares-vers-tareas", de: "hektar-zu-tareas-rechner" } },
  { id: "metros-cuadrados-to-tareas", category: "conversion", slugs: { en: "metros-cuadrados-to-tareas-calculator", es: "calculadora-metros-cuadrados-a-tareas", pt: "calculadora-metros-quadrados-para-tareas", fr: "calculateur-metres-carres-vers-tareas", de: "quadratmeter-zu-tareas-rechner" } },
  { id: "knots-to-mph", category: "conversion", slugs: { en: "knots-to-mph-calculator", es: "calculadora-nudos-mph", pt: "calculadora-nos-para-mph", fr: "convertisseur-noeuds-vers-mph", de: "knoten-zu-meilen-pro-stunde-rechner" } },
  { id: "torque-converter", category: "conversion", slugs: { en: "torque-converter-calculator", es: "calculadora-convertidor-par-motor", pt: "calculadora-conversor-torque", fr: "calculateur-convertisseur-couple", de: "drehmoment-umrechner" } },
  { id: "ml-to-teaspoons", category: "conversion", slugs: { en: "ml-to-teaspoons-calculator", es: "calculadora-ml-cucharaditas", pt: "calculadora-ml-para-colheres-de-cha", fr: "calculateur-ml-vers-cuilleres-cafe", de: "ml-zu-teeloeffel-rechner" } },
  { id: "cups-to-liters", category: "conversion", slugs: { en: "cups-to-liters-calculator", es: "calculadora-tazas-litros", pt: "calculadora-xicaras-para-litros", fr: "calculateur-tasses-vers-litres", de: "tassen-zu-liter-rechner" } },
  { id: "liters-to-cups", category: "conversion", slugs: { en: "liters-to-cups-calculator", es: "calculadora-litros-a-tazas", pt: "calculadora-litros-para-xicaras", fr: "calculateur-litres-vers-tasses", de: "liter-zu-tassen-rechner" } },
  { id: "tablespoons-to-cups", category: "conversion", slugs: { en: "tablespoons-to-cups-calculator", es: "calculadora-cucharadas-a-tazas", pt: "calculadora-colheres-sopa-para-xicaras", fr: "calculateur-cuilleres-soupe-vers-tasses", de: "essloeffel-zu-tassen-rechner" } },
  { id: "oz-to-cups", category: "conversion", slugs: { en: "oz-to-cups-calculator", es: "calculadora-onzas-liquidas-a-tazas", pt: "calculadora-oncas-fluidas-para-xicaras", fr: "calculateur-once-liquide-vers-tasses", de: "fluessigounzen-zu-tassen-rechner" } },
  { id: "cups-to-oz", category: "conversion", slugs: { en: "cups-to-oz-calculator", es: "calculadora-tazas-a-onzas-liquidas", pt: "calculadora-xicaras-para-oncas-fluidas", fr: "calculateur-tasses-vers-onces-liquides", de: "tassen-zu-fluessigounzen-rechner" } },
  { id: "ounces-to-pounds", category: "conversion", slugs: { en: "ounces-to-pounds-calculator", es: "calculadora-onzas-a-libras", pt: "calculadora-oncas-para-libras", fr: "calculateur-onces-vers-livres", de: "unzen-zu-pfund-rechner" } },
  { id: "pounds-to-ounces", category: "conversion", slugs: { en: "pounds-to-ounces-calculator", es: "calculadora-libras-a-onzas", pt: "calculadora-libras-para-oncas", fr: "calculateur-livres-vers-onces", de: "pfund-zu-unzen-rechner" } },
  { id: "kg-to-grams", category: "conversion", slugs: { en: "kg-to-grams-calculator", es: "calculadora-kilogramos-a-gramos", pt: "calculadora-kg-para-gramas", fr: "calculateur-kilogrammes-vers-grammes", de: "kilogramm-zu-gramm-rechner" } },
  { id: "grams-to-kg", category: "conversion", slugs: { en: "grams-to-kg-calculator", es: "calculadora-gramos-a-kilogramos", pt: "calculadora-gramas-para-quilogramas", fr: "calculateur-grammes-vers-kilogrammes", de: "gramm-zu-kilogramm-rechner" } },
  { id: "carats-to-grams", category: "conversion", slugs: { en: "carats-to-grams-calculator", es: "calculadora-quilates-a-gramos", pt: "calculadora-quilates-para-gramas", fr: "calculateur-carats-vers-grammes", de: "karat-zu-gramm-rechner" } },
  { id: "mbps-to-mbytes", category: "conversion", slugs: { en: "mbps-to-mbytes-calculator", es: "calculadora-conversion-mbps-megabytes", pt: "calculadora-conversao-mbps-para-mbs", fr: "calculateur-convertisseur-mbps-vers-mo-s", de: "mbps-zu-mb-s-umrechner" } },
  { id: "kb-to-mb", category: "conversion", slugs: { en: "kb-to-mb-calculator", es: "calculadora-kb-a-mb", pt: "calculadora-kb-para-mb", fr: "calculateur-ko-vers-mo", de: "kilobyte-zu-megabyte-rechner" } },
  { id: "mb-to-gb", category: "conversion", slugs: { en: "mb-to-gb-calculator", es: "calculadora-convertir-mb-a-gb", pt: "calculadora-mb-para-gb", fr: "calculateur-conversion-mb-vers-gb", de: "megabyte-zu-gigabyte-rechner" } },
  { id: "kwh-to-btu", category: "conversion", slugs: { en: "kwh-to-btu-calculator", es: "calculadora-kwh-btu", pt: "calculadora-kwh-para-btu", fr: "calculateur-kwh-vers-btu", de: "kilowattstunden-zu-btu-rechner" } },
  { id: "btu-to-kwh", category: "conversion", slugs: { en: "btu-to-kwh-calculator", es: "calculadora-btu-a-kwh", pt: "calculadora-btu-para-kwh", fr: "calculateur-conversion-btu-kwh", de: "btu-zu-kwh-umrechner" } },
  { id: "joules-to-calories", category: "conversion", slugs: { en: "joules-to-calories-calculator", es: "calculadora-convertidor-julios-calorias", pt: "calculadora-joules-para-calorias", fr: "calculateur-joules-vers-calories", de: "joule-zu-kalorien-umrechner" } },
  { id: "watts-to-kilowatts", category: "conversion", slugs: { en: "watts-to-kilowatts-calculator", es: "calculadora-vatios-a-kilovatios", pt: "calculadora-watts-para-quilowatts", fr: "calculateur-watts-vers-kilowatts", de: "watt-zu-kilowatt-rechner" } },
  { id: "kelvin-converter", category: "conversion", slugs: { en: "kelvin-converter-calculator", es: "calculadora-convertidor-kelvin", pt: "calculadora-conversor-kelvin", fr: "calculateur-convertisseur-kelvin", de: "kelvin-umrechner-rechner" } },
  { id: "bar-to-psi", category: "conversion", slugs: { en: "bar-to-psi-calculator", es: "calculadora-convertidor-bar-a-psi", pt: "calculadora-bar-para-psi", fr: "calculateur-conversion-bar-psi", de: "bar-zu-psi-umrechner" } },
  { id: "radians-to-degrees", category: "conversion", slugs: { en: "radians-to-degrees-calculator", es: "calculadora-radianes-a-grados", pt: "calculadora-radianos-para-graus", fr: "calculateur-radians-vers-degres", de: "radiant-zu-grad-rechner" } },
  { id: "horsepower-to-watts", category: "conversion", slugs: { en: "horsepower-to-watts-calculator", es: "calculadora-caballos-fuerza-a-vatios", pt: "calculadora-cavalos-vapor-para-watts", fr: "calculateur-chevaux-vers-watts", de: "pferdestärke-zu-watt-rechner" } },
  { id: "cm-to-mm", category: "conversion", slugs: { en: "cm-to-mm-calculator", es: "calculadora-centimetros-milimetros", pt: "calculadora-centimetros-para-milimetros", fr: "calculateur-centimetre-vers-millimetre", de: "zentimeter-zu-millimeter-rechner" } },
  { id: "mm-to-cm", category: "conversion", slugs: { en: "mm-to-cm-calculator", es: "calculadora-milimetros-centimetros", pt: "calculadora-milimetros-para-centimetros", fr: "calculateur-mm-vers-cm", de: "millimeter-zu-zentimeter-rechner" } },
  { id: "kilowatts-to-watts", category: "conversion", slugs: { en: "kilowatts-to-watts-calculator", es: "calculadora-kilovatios-a-vatios", pt: "calculadora-quilowatts-para-watts", fr: "calculateur-kilowatts-vers-watts", de: "kilowatt-zu-watt-rechner" } },
]; // END SLUG_REGISTRY
