...
export const SLUG_REGISTRY: SlugEntry[] = [
  ...
  { id: "chinese-gender-predictor", category: "health", slugs: { en: "chinese-gender-predictor-calculator", es: "calculadora-predictor-genero-chino", pt: "calculadora-predictor-genero-chines", fr: "calculateur-predicteur-genre-chinois", de: "chinesischer-geschlechtsprediktor-rechner" } },
  { id: "hcg-calculator", category: "health", slugs: { en: "hcg-calculator", es: "calculadora-hcg", pt: "calculadora-hcg", fr: "calculateur-hcg", de: "hcg-rechner" } },
  ...
  { id: "investment-calculator", category: "finance", slugs: { en: "investment-calculator", es: "calculadora-inversiones", pt: "calculadora-investimento", fr: "calculateur-investissement", de: "investitionsrechner" } },
  ...
  { id: "inflation-calculator", category: "finance", slugs: { en: "inflation-calculator", es: "calculadora-inflacion", pt: "calculadora-inflacao", fr: "calculateur-inflation", de: "inflations-rechner" } },
  { id: "retirement-calculator", category: "finance", slugs: { en: "retirement-calculator", es: "calculadora-jubilacion", pt: "calculadora-aposentadoria", fr: "calculateur-retraite", de: "rentenrechner" } },
  { id: "interest-calculator", category: "finance", slugs: { en: "interest-calculator", es: "calculadora-interes", pt: "calculadora-juros", fr: "calculateur-interets", de: "zinsrechner" } },
  { id: "income-tax-calculator", category: "finance", slugs: { en: "income-tax-calculator", es: "calculadora-impuesto-sobre-la-renta", pt: "calculadora-imposto-renda", fr: "calculateur-impot-revenu", de: "einkommensteuer-rechner" } },
  { id: "paycheck-calculator", category: "finance", slugs: { en: "paycheck-calculator", es: "calculadora-sueldo-neto", pt: "calculadora-contracheque", fr: "calculateur-salaire-net", de: "gehaltsabrechnung-rechner" } },
  { id: "savings-calculator", category: "finance", slugs: { en: "savings-calculator", es: "calculadora-ahorros", pt: "calculadora-poupanca", fr: "calculateur-epargne", de: "sparrechner-rechner" } },
  { id: "home-affordability", category: "finance", slugs: { en: "home-affordability-calculator", es: "calculadora-asequibilidad-vivienda", pt: "calculadora-acessibilidade-moradia", fr: "calculateur-accessibilite-logement", de: "erschwinglichkeit-rechner" } },
  { id: "student-loan", category: "finance", slugs: { en: "student-loan-calculator", es: "calculadora-prestamo-estudiantil", pt: "calculadora-student-loan", fr: "calculateur-student-loan", de: "student-loan-rechner" } },
  { id: "budget-calculator", category: "finance", slugs: { en: "budget-calculator", es: "calculadora-presupuesto", pt: "calculadora-orcamento", fr: "calculateur-budget", de: "haushaltsrechner" } },
