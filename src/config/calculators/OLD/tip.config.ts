...
export const tipCalculatorConfig: CalculatorConfigV3 = {
  ...
  seo: {
    ...
    description: "Calculate your tip quickly and easily with our free online calculator. Get accurate results instantly.",
    shortDescription: "Calculate tip instantly",
    keywords: ["tip calculator", "tip", "free calculator"],
  },
  ...
  educationSections: [
    { id: "whatIs", type: "prose", title: "What is Tip?", icon: "📖", content: "Explanation of what tip is and why it matters..." },
    { id: "howTo", type: "prose", title: "How to Calculate", icon: "⚙️", content: "Step by step guide on how to calculate tip..." },
  ...
  faqs: [
    { question: "What is a tip?", answer: "A tip is..." },
...
export function calculateTip(data: { values: Record<string, unknown> }): CalculatorResults {
