...
export const testAutoCalculatorConfig: CalculatorConfigV3 = {
  id: "test-auto-calculator",
  slug: "test-auto-calculator",
  name: "Test Auto Calculator",
  category: "finance",
  icon: "💰",

  seo: {
    title: "Test Auto Calculator - Free Online Tool",
    description: "Calculate your test auto quickly and easily with our free online calculator. Get accurate results instantly.",
    shortDescription: "Calculate test auto instantly",
    keywords: ["test-auto calculator", "test auto", "free calculator"],
  },

  hero: { badge: "Finance", rating: { average: 4.8, count: 1000 } },
  ...
  educationSections: [
    { id: "whatIs", type: "prose", title: "What is Test Auto?", icon: "📖", content: "Explanation of what test auto is and why it matters..." },
    { id: "howTo", type: "prose", title: "How to Calculate", icon: "⚙️", content: "Step by step guide on how to calculate test auto..." },
  ...
  faqs: [
    { question: "What is a test auto?", answer: "A test auto is..." },
...
export function calculateTestAuto(data: { values: Record<string, unknown> }): CalculatorResults {
...
export default testAutoCalculatorConfig;
