...
export const discountCalculatorConfig: CalculatorConfigV3 = {
  ...
  seo: {
    ...
    description: "Calculate your discount quickly and easily with our free online calculator. Get accurate results instantly.",
    shortDescription: "Calculate discount instantly",
    keywords: ["discount calculator", "discount", "free calculator"],
  },
  ...
  educationSections: [
    { id: "whatIs", type: "prose", title: "What is Discount?", icon: "📖", content: "Explanation of what discount is and why it matters..." },
    { id: "howTo", type: "prose", title: "How to Calculate", icon: "⚙️", content: "Step by step guide on how to calculate discount..." },
  ...
  faqs: [
    { question: "What is a discount?", answer: "A discount is..." },
...
export function calculateDiscount(data: { values: Record<string, unknown> }): CalculatorResults {
