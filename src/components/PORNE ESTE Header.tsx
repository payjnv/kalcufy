...
// Inline Logo Component - V20 Glassmorphism
function KalcufyLogo({ size = 32 }: { size?: number }) {
  return (
    <svg 
      width={size} 
      height={size} 
    ...
    >
      <defs>
        ...
        <filter id="kalcufyShadow" x="-20%" y="-20%" width="140%" height="140%">
      ...
      {/* 3x3 Grid */}
      <circle cx="18" cy="18" r="6" fill="rgba(255,255,255,0.95)"/>
      <circle cx="32" cy="18" r="6" fill="rgba(255,255,255,0.95)"/>
      <circle cx="46" cy="18" r="6" fill="rgba(255,255,255,0.95)"/>
      <circle cx="18" cy="32" r="6" fill="rgba(255,255,255,0.95)"/>
      <circle cx="32" cy="32" r="6" fill="rgba(255,255,255,0.95)"/>
      <circle cx="46" cy="32" r="6" fill="rgba(255,255,255,0.95)"/>
      <circle cx="18" cy="46" r="6" fill="rgba(255,255,255,0.95)"/>
    ...
    <header className="fixed top-0 left-0 right-0 bg-white/95 backdrop-blur-sm border-b border-slate-200 z-40">
      <div className="container">
        <div className="flex items-center justify-between h-16">
          {/* Logo - Updated to V20 Glassmorphism */}
          ...
          <div className="flex items-center gap-3">
            ...
            <button 
              ...
              className="md:hidden p-2 text-slate-600 focus:outline-none focus:ring-2 focus:ring-blue-500 rounded-lg" aria-label={mobileMenuOpen ? "Close menu" : "Open menu"} aria-expanded={mobileMenuOpen} aria-controls="mobile-menu"
            >
