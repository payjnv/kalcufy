...
export const fourOhOneKCalculatorConfig: CalculatorConfigV4 = {
  ...
  // ─── INPUTS ───
  inputs: [
    // Current Age — stepper// Retirement Age — stepper// Annual Salary — currency unitType// Current 401(k) Balance — currency unitType// Contribution % of salary — number + slider// Include Employer Match — toggle// Employer Match % — revealed when toggle ON// Employer Match Limit (% of salary) — revealed when toggle ON// Expected Rate of Return — number + slider// Include Salary Growth — toggle// Annual Salary Increase — revealed when toggle ON// Include Inflation — toggle// Expected Inflation Rate — revealed when toggle ON],
