...
export const litersToGallonsConfig: CalculatorConfigV4 = {
  ...
  presets: [
    { id: "oneLiter", icon: "🥤", values: { amount: 1 } },
    { id: "fiveLiters", icon: "🫗", values: { amount: 5 } },
    { id: "twentyLiters", icon: "⛽", values: { amount: 20 } },
  ],
  ...
  t: {
    en: {
      ...
      breadcrumb: "Liters to Gallons",

      seo: {
        title: "Liters to Gallons Converter - Free Volume Conversion",
        description: "Convert liters to gallons instantly. Supports US and UK gallons with metric equivalents for cooking, fuel, and everyday use.",
        shortDescription: "Convert liters to US and UK gallons instantly for cooking, fuel, and everyday me",
      ...
      presets: {
        oneLiter: { label: "🥤 1 L", description: "1 L (0.26 gal)" },
        fiveLiters: { label: "🫗 5 L", description: "5 L (1.32 gal)" },
        twentyLiters: { label: "⛽ 20 L", description: "20 L (5.28 gal)" },
      },
      ...
      infoCards: {
        ...
        tips: {
          ...
          items: [
            "Quick estimate: 1 liter ≈ 0.264 US gallons (roughly ¼ gallon)",
      ...
      education: {
        whatIs: {
          ...
          content: "Convert liters to gallons instantly. Supports US and UK gallons with metric equivalents for cooking, fuel, and everyday use. This converter supports all related units in the volume category, letting you convert between any combination with a single input.",
        },
        howItWorks: {
        ...
        considerations: {
          ...
          items: [
            { text: "Quick estimate: 1 liter ≈ 0.264 US gallons (roughly ¼ gallon)", type: "info" },
      ...
      faqs: [
        ...
        { question: "What units are supported?", answer: "This converter supports all units in the volume category: L, gal_us, gal_uk, mL, fl_oz, cups, pt_us, qt_us. Select any from the dropdown." },
    ...
    es: {
      "name": "Convertidor de Litros a Galones",
      "slug": "calculadora-litros-a-galones",
      "subtitle": "Convierte litros a galones estadounidenses y británicos al instante para cocina, combustible y medidas cotidianas.",
      "breadcrumb": "Litros a Galones",
      "seo": {
        "title": "Convertidor de Litros a Galones - Conversión de Volumen Gratuita",
        "description": "Convierte litros a galones al instante. Soporta galones estadounidenses y británicos con equivalentes métricos para cocina, combustible y uso cotidiano.",
        "shortDescription": "Convierte litros a galones estadounidenses y británicos al instante para cocina, combustible y medidas cotidianas",
        "keywords": [
          "litros a galones",
          "L a gal",
          "convertidor litro galón",
          "métrico a imperial volumen",
          "conversión litros a galones",
          "convertidor volumen gratuito"
        ]
      },
      "inputs": {
        "amount": {
          "label": "Volumen",
          "helpText": "Ingrese el volumen a convertir"
        }
      },
      "results": {
        "primary": {
      ...
      "presets": {
        "oneLiter": {
          "label": "🥤 1 L",
          "description": "1 L (0,26 gal)"
        },
        "fiveLiters": {
          "label": "🫗 5 L",
          "description": "5 L (1,32 gal)"
        },
        "twentyLiters": {
          "label": "⛽ 20 L",
          "description": "20 L (5,28 gal)"
        }
      },
      "values": {},
      "formats": {
      ...
      "infoCards": {
        ...
        "tips": {
          ...
          "items": [
            "Estimación rápida: 1 litro ≈ 0,264 galones estadounidenses (aproximadamente ¼ de galón)",
            "Selecciona cualquier unidad del menú desplegable para convertir desde esa unidad en su lugar.",
      ...
      "education": {
        "whatIs": {
          ...
          "content": "Convierte litros a galones al instante. Soporta galones estadounidenses y británicos con equivalentes métricos para cocina, combustible y uso cotidiano. Este convertidor soporta todas las unidades relacionadas en la categoría de volumen, permitiéndote convertir entre cualquier combinación con una sola entrada."
        },
        "howItWorks": {
          "title": "Cómo Convertir",
          "content": "Ingresa tu valor y selecciona la unidad de origen del menú desplegable. El convertidor muestra instantáneamente el equivalente en todas las demás unidades de este tipo. Todas las conversiones utilizan factores precisos de estándares internacionales (NIST/BIPM)."
        },
        "considerations": {
          "title": "Notas Importantes",
          "items": [
            {
              "text": "Estimación rápida: 1 litro ≈ 0,264 galones estadounidenses (aproximadamente ¼ de galón)",
              "type": "info"
            },
            {
        ...
        "commonValues": {
          ...
          "items": [
            ...
            {
              "text": "Usa los valores predeterminados arriba para cantidades de uso frecuente.",
              "type": "info"
            },
            {
      ...
      "faqs": [
        ...
        },
        {
          ...
          "answer": "Este convertidor soporta todas las unidades en la categoría de volumen: L, gal_us, gal_uk, mL, fl_oz, tazas, pt_us, qt_us. Selecciona cualquiera del menú desplegable."
        },
        {
    ...
    pt: {
      ...
      "slug": "calculadora-litros-para-galoes",
      "subtitle": "Converta litros para galões americanos e ingleses instantaneamente para culinária, combustível e medições do dia a dia.",
      "breadcrumb": "Litros para Galões",
      "seo": {
        "title": "Conversor de Litros para Galões - Conversão de Volume Gratuita",
        "description": "Converta litros para galões instantaneamente. Suporta galões americanos e ingleses com equivalentes métricos para culinária, combustível e uso cotidiano.",
        "shortDescription": "Converta litros para galões americanos e ingleses instantaneamente para culinária, combustível e uso cotidiano",
        "keywords": [
          "litros para galões",
          "L para gal",
          "conversor litro galão",
          "métrico para imperial volume",
          "conversão litros galões",
          "conversor volume gratuito"
        ]
      },
      "inputs": {
        "amount": {
      ...
      "infoCards": {
        ...
        "tips": {
          ...
          "items": [
            "Estimativa rápida: 1 litro ≈ 0,264 galões americanos (aproximadamente ¼ galão)",
      ...
      "education": {
        "whatIs": {
          ...
          "content": "Converta litros para galões instantaneamente. Suporta galões americanos e ingleses com equivalentes métricos para culinária, combustível e uso cotidiano. Este conversor suporta todas as unidades relacionadas na categoria de volume, permitindo converter entre qualquer combinação com uma única entrada."
        },
        "howItWorks": {
        ...
        "considerations": {
          ...
          "items": [
            {
              "text": "Estimativa rápida: 1 litro ≈ 0,264 galões americanos (aproximadamente ¼ galão)",
              "type": "info"
            },
            {
      ...
      "faqs": [
        ...
        },
        {
          ...
          "answer": "Este conversor suporta todas as unidades na categoria de volume: L, gal_us, gal_uk, mL, fl_oz, xícaras, pt_us, qt_us. Selecione qualquer uma no menu suspenso."
        },
        {
    ...
    fr: {
      "name": "Convertisseur Litres vers Gallons",
      "slug": "calculateur-litres-vers-gallons",
      "subtitle": "Convertissez les litres en gallons américains et britanniques instantanément pour la cuisine, le carburant et les mesures quotidiennes.",
      "breadcrumb": "Litres vers Gallons",
      "seo": {
        "title": "Convertisseur Litres vers Gallons - Conversion de Volume Gratuite",
        "description": "Convertissez les litres en gallons instantanément. Prend en charge les gallons américains et britanniques avec équivalents métriques pour la cuisine, le carburant et l'usage quotidien.",
        "shortDescription": "Convertissez les litres en gallons américains et britanniques instantanément pour la cuisine, le carburant et l'usage quotidien",
        "keywords": [
          "litres vers gallons",
          "L vers gal",
          "convertisseur litre gallon",
          "volume métrique vers impérial",
          "conversion litres vers gallons",
          "convertisseur volume gratuit"
        ]
      },
      "inputs": {
        "amount": {
      ...
      "infoCards": {
        ...
        "tips": {
          ...
          "items": [
            "Estimation rapide : 1 litre ≈ 0,264 gallons américains (environ ¼ de gallon)",
      ...
      "education": {
        "whatIs": {
          ...
          "content": "Convertissez les litres en gallons instantanément. Prend en charge les gallons américains et britanniques avec équivalents métriques pour la cuisine, le carburant et l'usage quotidien. Ce convertisseur prend en charge toutes les unités liées dans la catégorie volume, vous permettant de convertir entre n'importe quelle combinaison avec une seule saisie."
        },
        "howItWorks": {
        ...
        "considerations": {
          ...
          "items": [
            {
              "text": "Estimation rapide : 1 litre ≈ 0,264 gallons américains (environ ¼ de gallon)",
              "type": "info"
            },
            {
        ...
        "commonValues": {
          ...
          "items": [
            {
              "text": "Consultez la carte Référence Rapide pour les valeurs communes.",
              "type": "info"
            },
            {
      ...
      "faqs": [
        ...
        },
        {
          ...
          "answer": "Ce convertisseur prend en charge toutes les unités de la catégorie volume : L, gal_us, gal_uk, mL, fl_oz, tasses, pt_us, qt_us. Sélectionnez n'importe laquelle dans le menu déroulant."
        },
        {
    ...
    de: {
      "name": "Liter zu Gallonen Umrechner",
      "slug": "liter-zu-gallonen-rechner",
      "subtitle": "Rechnen Sie Liter sofort in US- und UK-Gallonen um für Kochen, Kraftstoff und alltägliche Messungen.",
      "breadcrumb": "Liter zu Gallonen",
      "seo": {
        "title": "Liter zu Gallonen Umrechner - Kostenlose Volumen-Umrechnung",
        "description": "Rechnen Sie Liter sofort in Gallonen um. Unterstützt US- und UK-Gallonen mit metrischen Entsprechungen für Kochen, Kraftstoff und den täglichen Gebrauch.",
        "shortDescription": "Rechnen Sie Liter sofort in US- und UK-Gallonen um für Kochen, Kraftstoff und alltägliche Messungen.",
        "keywords": [
          "liter zu gallonen",
          "L zu gal",
          "liter gallonen umrechner",
          "metrisch zu imperial volumen",
          "liter zu gallonen umrechnung",
          "kostenloser volumen umrechner"
        ]
      },
      "inputs": {
        "amount": {
      ...
      "infoCards": {
        ...
        "tips": {
          ...
          "items": [
            "Schnelle Schätzung: 1 Liter ≈ 0,264 US-Gallonen (etwa ¼ Gallone)",
            "Wählen Sie eine beliebige Einheit aus der Dropdown-Liste, um stattdessen von dieser Einheit zu konvertieren.",
      ...
      "education": {
        "whatIs": {
          ...
          "content": "Rechnen Sie Liter sofort in Gallonen um. Unterstützt US- und UK-Gallonen mit metrischen Entsprechungen für Kochen, Kraftstoff und den täglichen Gebrauch. Dieser Umrechner unterstützt alle verwandten Einheiten in der Volumenkategorie und ermöglicht es Ihnen, mit einer einzigen Eingabe zwischen jeder Kombination zu konvertieren."
        },
        "howItWorks": {
        ...
        "considerations": {
          ...
          "items": [
            {
              "text": "Schnelle Schätzung: 1 Liter ≈ 0,264 US-Gallonen (etwa ¼ Gallone)",
              "type": "info"
            },
            {
          ...
          "examples": [
            ...
            },
            {
              ...
              "steps": [
                ...
                "Ihren Wert eingeben",
                "Das Ergebnis in der ursprünglichen Einheit ablesen"
              ],
      ...
      "faqs": [
        ...
        },
        {
          ...
          "answer": "Ja! Ändern Sie einfach die Einheit im Dropdown, um von jeder Einheit zu allen anderen zu konvertieren. Der Umrechner ist vollständig bidirektional."
        },
        {
          "question": "Welche Einheiten werden unterstützt?",
          "answer": "Dieser Umrechner unterstützt alle Einheiten in der Volumenkategorie: L, gal_us, gal_uk, mL, fl_oz, Tassen, pt_us, qt_us. Wählen Sie eine beliebige aus dem Dropdown."
        },
        {
...
export function calculateLitersToGallons(data: {
  ...
  const allUnits = ["L", "gal_us", "gal_uk", "mL", "fl_oz", "cups", "pt_us", "qt_us"];
...
export default litersToGallonsConfig;
