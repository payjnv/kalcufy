...
export const kmhToMphConfig: CalculatorConfigV4 = {
  id: "kmh-to-mph",
  version: "4.0",
  category: "conversion",
  icon: "🏎️",
  ...
  presets: [
    { id: "city", icon: "🏙️", values: { amount: 50 } },
    { id: "highway", icon: "🛣️", values: { amount: 120 } },
    { id: "fast", icon: "🏎️", values: { amount: 200 } },
  ],
  ...
  t: {
    en: {
      ...
      breadcrumb: "KM/H to MPH",

      seo: {
        title: "KM/H to MPH Converter - Speed Conversion Tool",
        description: "Convert kilometers per hour to miles per hour instantly. Essential for travel, driving in the US/UK, and vehicle speed comparisons.",
        shortDescription: "Convert km/h to mph for travel, driving, and speed comparisons worldwide.",
      ...
      presets: {
        city: { label: "🏙️ 50 km/h", description: "50 km/h (31 mph)" },
        highway: { label: "🛣️ 120 km/h", description: "120 km/h (75 mph)" },
        fast: { label: "🏎️ 200 km/h", description: "200 km/h (124 mph)" },
      },
      ...
      infoCards: {
        ...
        tips: {
          ...
          items: [
            "Quick estimate: divide km/h by 1.6 to get mph",
      ...
      education: {
        whatIs: {
          ...
          content: "Convert kilometers per hour to miles per hour instantly. Essential for travel, driving in the US/UK, and vehicle speed comparisons. This converter supports all related units in the speed category, letting you convert between any combination with a single input.",
        },
        howItWorks: {
        ...
        considerations: {
          ...
          items: [
            { text: "Quick estimate: divide km/h by 1.6 to get mph", type: "info" },
      ...
      faqs: [
        ...
        { question: "What units are supported?", answer: "This converter supports all units in the speed category: kmh, mph, ms, knots, fts. Select any from the dropdown." },
    ...
    es: {
      "name": "Convertidor de KM/H a MPH",
      "slug": "calculadora-conversion-kmh-mph",
      "subtitle": "Convierte km/h a mph para viajes, conducción y comparaciones de velocidad en todo el mundo.",
      "breadcrumb": "KM/H a MPH",
      "seo": {
        "title": "Convertidor de KM/H a MPH - Herramienta de Conversión de Velocidad",
        "description": "Convierte kilómetros por hora a millas por hora al instante. Esencial para viajes, conducir en EE.UU./Reino Unido y comparaciones de velocidad de vehículos.",
        "shortDescription": "Convierte km/h a mph para viajes, conducción y comparaciones de velocidad en todo el mundo.",
        "keywords": [
          "kmh a mph",
          "km/h a millas por hora",
          "convertidor velocidad",
          "kph a mph",
          "kilómetros a millas velocidad",
          "conversión velocidad conducción"
        ]
      },
      "inputs": {
        "amount": {
          "label": "Velocidad",
          "helpText": "Ingresa la velocidad a convertir"
        }
      },
      "results": {
        "primary": {
      ...
      "presets": {
        "city": {
          "label": "🏙️ 50 km/h",
          "description": "50 km/h (31 mph)"
        },
        "highway": {
          "label": "🛣️ 120 km/h",
          "description": "120 km/h (75 mph)"
        },
        "fast": {
          "label": "🏎️ 200 km/h",
          "description": "200 km/h (124 mph)"
        }
      },
      "values": {},
      "formats": {
      ...
      "infoCards": {
        ...
        "tips": {
          ...
          "items": [
            "Estimación rápida: divide km/h por 1.6 para obtener mph",
      ...
      "education": {
        "whatIs": {
          ...
          "content": "Convierte kilómetros por hora a millas por hora al instante. Esencial para viajes, conducir en EE.UU./Reino Unido y comparaciones de velocidad de vehículos. Este convertidor soporta todas las unidades relacionadas en la categoría de velocidad, permitiéndote convertir entre cualquier combinación con una sola entrada."
        },
        "howItWorks": {
          "title": "Cómo Convertir",
          "content": "Ingresa tu valor y selecciona la unidad origen del menú desplegable. El convertidor muestra instantáneamente el equivalente en todas las demás unidades de este tipo. Todas las conversiones usan factores precisos de estándares internacionales (NIST/BIPM)."
        },
        "considerations": {
          "title": "Notas Importantes",
          "items": [
            {
              "text": "Estimación rápida: divide km/h por 1.6 para obtener mph",
              "type": "info"
            },
            {
        ...
        "commonValues": {
          ...
          "items": [
            ...
            {
              "text": "Funciona en móvil — úsalo donde sea.",
              "type": "info"
            },
            {
          ...
          "examples": [
            {
              ...
              "steps": [
                "Ingresa el valor en la unidad origen",
                "Lee el resultado en la unidad objetivo",
                "Usa el menú desplegable para cambiar la unidad origen"
              ],
      ...
      "faqs": [
        ...
        },
        {
          ...
          "answer": "Este convertidor soporta todas las unidades en la categoría de velocidad: kmh, mph, ms, nudos, fts. Selecciona cualquiera del menú desplegable."
        },
        {
    ...
    pt: {
      "name": "Conversor KM/H para MPH",
      "slug": "calculadora-kmh-para-mph",
      "subtitle": "Converta km/h para mph para viagens, condução e comparações de velocidade mundiais.",
      "breadcrumb": "KM/H para MPH",
      "seo": {
        "title": "Conversor KM/H para MPH - Ferramenta de Conversão de Velocidade",
        "description": "Converta quilômetros por hora para milhas por hora instantaneamente. Essencial para viagens, condução nos EUA/Reino Unido e comparações de velocidade de veículos.",
        "shortDescription": "Converta km/h para mph para viagens, condução e comparações de velocidade mundiais.",
        "keywords": [
          "kmh para mph",
          "km/h para milhas por hora",
          "conversor de velocidade",
          "kph para mph",
          "quilômetros para milhas velocidade",
          "conversão velocidade condução"
        ]
      },
      "inputs": {
        "amount": {
      ...
      "infoCards": {
        ...
        "tips": {
          ...
          "items": [
            "Estimativa rápida: divida km/h por 1,6 para obter mph",
            "Selecione qualquer unidade no menu suspenso para converter dessa unidade",
            "Os resultados atualizam instantaneamente enquanto digita",
      ...
      "education": {
        "whatIs": {
          ...
          "content": "Converta quilômetros por hora para milhas por hora instantaneamente. Essencial para viagens, condução nos EUA/Reino Unido e comparações de velocidade de veículos. Este conversor suporta todas as unidades relacionadas na categoria de velocidade, permitindo converter entre qualquer combinação com uma única entrada."
        },
        "howItWorks": {
          "title": "Como Converter",
          "content": "Digite o seu valor e selecione a unidade de origem no menu suspenso. O conversor mostra instantaneamente o equivalente em todas as outras unidades deste tipo. Todas as conversões usam fatores precisos dos padrões internacionais (NIST/BIPM)."
        },
        "considerations": {
          "title": "Notas Importantes",
          "items": [
            {
              "text": "Estimativa rápida: divida km/h por 1,6 para obter mph",
              "type": "info"
            },
            {
        ...
        "commonValues": {
          ...
          "items": [
            ...
            {
              "text": "Use as predefinições acima para valores usados frequentemente",
              "type": "info"
            },
            {
              "text": "Todos os resultados atualizam em tempo real enquanto digita",
              "type": "info"
            },
            {
              "text": "Funciona no telemóvel — use em qualquer lugar",
              "type": "info"
            },
            {
              "text": "Partilhe resultados usando o botão Partilhar abaixo",
              "type": "info"
            },
            {
              "text": "Guarde resultados para mais tarde com o botão Guardar",
              "type": "info"
            }
          ]
        },
      ...
      "faqs": [
        {
          "question": "Quão precisas são estas conversões?",
          "answer": "Todas as conversões usam fatores exatos dos padrões internacionais NIST e BIPM. Os resultados são precisos a pelo menos 6 dígitos significativos."
        },
        {
        ...
        },
        {
          ...
          "answer": "Este conversor suporta todas as unidades na categoria de velocidade: kmh, mph, ms, nós, fts. Selecione qualquer uma no menu suspenso."
        },
        {
          "question": "Isto funciona no telemóvel?",
          "answer": "Sim, este conversor é totalmente responsivo e funciona em qualquer dispositivo — telemóvel, tablet ou computador."
        },
        {
          "question": "Posso partilhar o meu resultado de conversão?",
          "answer": "Sim! Use o botão Partilhar Resultados para gerar um link com a sua conversão exata que pode enviar a qualquer pessoa."
        },
        {
          "question": "Este conversor é gratuito?",
          "answer": "Sim, 100% gratuito sem registo necessário. Use quantas vezes precisar."
        }
      ],
      "buttons": {
        "calculate": "Calcular",
    ...
    fr: {
      "name": "Convertisseur KM/H en MPH",
      "slug": "calculateur-conversion-kmh-mph",
      "subtitle": "Convertissez km/h en mph pour les voyages, la conduite et les comparaisons de vitesse dans le monde entier.",
      "breadcrumb": "KM/H en MPH",
      "seo": {
        "title": "Convertisseur KM/H en MPH - Outil de Conversion de Vitesse",
        "description": "Convertissez les kilomètres par heure en miles par heure instantanément. Essentiel pour les voyages, la conduite aux États-Unis/Royaume-Uni et les comparaisons de vitesse des véhicules.",
        "shortDescription": "Convertissez km/h en mph pour les voyages, la conduite et les comparaisons de vitesse dans le monde entier.",
        "keywords": [
          "kmh en mph",
          "km/h en miles par heure",
          "convertisseur de vitesse",
          "kph en mph",
          "kilomètres en miles vitesse",
          "conversion vitesse conduite"
        ]
      },
      "inputs": {
        "amount": {
      ...
      "infoCards": {
        ...
        "tips": {
          ...
          "items": [
            "Estimation rapide : divisez km/h par 1,6 pour obtenir mph",
      ...
      "education": {
        "whatIs": {
          ...
          "content": "Convertissez les kilomètres par heure en miles par heure instantanément. Essentiel pour les voyages, la conduite aux États-Unis/Royaume-Uni et les comparaisons de vitesse des véhicules. Ce convertisseur prend en charge toutes les unités liées dans la catégorie vitesse, vous permettant de convertir entre n'importe quelle combinaison avec une seule saisie."
        },
        "howItWorks": {
        ...
        "considerations": {
          ...
          "items": [
            {
              "text": "Estimation rapide : divisez km/h par 1,6 pour obtenir mph",
              "type": "info"
            },
            {
            ...
            {
              "text": "Pour les nombres très grands ou très petits, la notation scientifique peut être utilisée.",
              "type": "info"
            },
            {
      ...
      "faqs": [
        ...
        },
        {
          ...
          "answer": "Ce convertisseur supporte toutes les unités dans la catégorie vitesse : kmh, mph, ms, nœuds, fts. Sélectionnez n'importe laquelle dans le menu déroulant."
        },
        {
    ...
    de: {
      "name": "KM/H zu MPH Umrechner",
      "slug": "kmh-zu-mph-rechner",
      "subtitle": "Umrechnung von km/h zu mph für Reisen, Autofahren und weltweite Geschwindigkeitsvergleiche.",
      "breadcrumb": "KM/H zu MPH",
      "seo": {
        "title": "KM/H zu MPH Umrechner - Geschwindigkeits-Umrechnungstool",
        "description": "Kilometer pro Stunde sofort in Meilen pro Stunde umrechnen. Unverzichtbar für Reisen, Autofahren in den USA/UK und Fahrzeuggeschwindigkeitsvergleiche.",
        "shortDescription": "Umrechnung von km/h zu mph für Reisen, Autofahren und weltweite Geschwindigkeitsvergleiche.",
        "keywords": [
          "kmh zu mph",
          "km/h zu Meilen pro Stunde",
          "Geschwindigkeitsumrechner",
          "kph zu mph",
          "Kilometer zu Meilen Geschwindigkeit",
          "Fahrgeschwindigkeit Umrechnung"
        ]
      },
      "inputs": {
        "amount": {
      ...
      "infoCards": {
        ...
        "tips": {
          ...
          "items": [
            "Schnelle Schätzung: km/h durch 1,6 teilen um mph zu erhalten",
      ...
      "education": {
        "whatIs": {
          ...
          "content": "Rechnen Sie Kilometer pro Stunde sofort in Meilen pro Stunde um. Unverzichtbar für Reisen, Autofahren in den USA/UK und Fahrzeuggeschwindigkeitsvergleiche. Dieser Umrechner unterstützt alle verwandten Einheiten in der Geschwindigkeitskategorie und ermöglicht es Ihnen, mit einer einzigen Eingabe zwischen beliebigen Kombinationen umzurechnen."
        },
        "howItWorks": {
        ...
        "considerations": {
          ...
          "items": [
            {
              "text": "Schnelle Schätzung: km/h durch 1,6 teilen um mph zu erhalten",
              "type": "info"
            },
            {
      ...
      "faqs": [
        {
          ...
          "answer": "Alle Umrechnungen verwenden exakte Faktoren aus NIST- und BIPM-Internationalstandards. Ergebnisse sind auf mindestens 6 signifikante Stellen genau."
        },
        {
        ...
        },
        {
          ...
          "answer": "Dieser Umrechner unterstützt alle Einheiten in der Geschwindigkeitskategorie: kmh, mph, ms, Knoten, fts. Wählen Sie eine beliebige aus der Dropdown-Liste."
        },
        {
...
export function calculateKmhToMph(data: {
  ...
  const fromUnit = fieldUnits.amount || "kmh";

  if (amount === undefined || amount === null || amount < 0) {
    return { values: {}, formatted: {}, summary: "", isValid: false };
  }

  const unitGroup = UNIT_REGISTRY["speed"];
  ...
  for (const unit of units) {
    try {
      const converted = convert(amount, fromUnit, unit.id, "speed");
  ...
  const allUnits = ["kmh", "mph", "ms", "knots", "fts"];
