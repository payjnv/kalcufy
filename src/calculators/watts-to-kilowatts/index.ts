...
export const wattsToKilowattsConfig: CalculatorConfigV4 = {
  ...
  presets: [
    ...
    { id: "fiveThousand", icon: "☀️", values: { amount: 5000 } },
  ],

  t: {
    en: {
      name: "Watts to Kilowatts Converter",
      slug: "watts-to-kilowatts",
      subtitle: "Convert watts to kilowatts for appliances, solar panels, and electricity calculations.",
      breadcrumb: "Watts to Kilowatts",

      seo: {
        title: "Watts to Kilowatts Converter - Power Conversion Tool",
        description: "Convert watts to kilowatts instantly. 1 kW = 1,000 W. Essential for appliances, solar panels, and electricity.",
        shortDescription: "Convert watts to kilowatts for appliances, solar panels, and electricity calcula",
      ...
      presets: {
        hundred: { label: "💡 100 W", description: "100 W (light bulb)" },
        thousand: { label: "🔌 1,000 W", description: "1,000 W (1 kW)" },
        fiveThousand: { label: "☀️ 5 kW", description: "5 kW (solar system)" },
      },
      ...
      infoCards: {
        ...
        tips: {
          ...
          items: [
            "1 kW = 1,000 W | A typical microwave uses 1,000-1,200 W (1-1.2 kW)",
      ...
      education: {
        whatIs: {
          ...
          content: "Convert watts to kilowatts instantly. 1 kW = 1,000 W. Essential for appliances, solar panels, and electricity. This converter supports all related units in the power category, letting you convert between any combination with a single input.",
        },
        howItWorks: {
        ...
        considerations: {
          ...
          items: [
            { text: "1 kW = 1,000 W | A typical microwave uses 1,000-1,200 W (1-1.2 kW)", type: "info" },
        ...
        commonValues: {
          ...
          items: [
            ...
            { text: "Supports all units in the power group.", type: "info" },
          ],
        },
        examples: {
      ...
      faqs: [
        ...
        { question: "What units are supported?", answer: "This converter supports all units in the power category: W, kW, MW, HP, BTUh, mW. Select any from the dropdown." },
    ...
    es: {
      "name": "Convertidor de Vatios a Kilovatios",
      "slug": "calculadora-vatios-a-kilovatios",
      "subtitle": "Convierte vatios a kilovatios para electrodomésticos, paneles solares y cálculos eléctricos.",
      "breadcrumb": "Vatios a Kilovatios",
      "seo": {
        "title": "Convertidor de Vatios a Kilovatios - Herramienta de Conversión de Potencia",
        "description": "Convierte vatios a kilovatios al instante. 1 kW = 1,000 W. Esencial para electrodomésticos, paneles solares y electricidad.",
        "shortDescription": "Convierte vatios a kilovatios para electrodomésticos, paneles solares y cálculos eléctricos",
        "keywords": [
          "vatios a kilovatios",
          "W a kW",
          "convertidor de potencia",
          "vataje de electrodomésticos",
          "calculadora panel solar",
      ...
      "presets": {
        "hundred": {
          "label": "💡 100 W",
          "description": "100 W (bombilla)"
        },
        "thousand": {
          "label": "🔌 1,000 W",
          "description": "1,000 W (1 kW)"
        },
        "fiveThousand": {
          "label": "☀️ 5 kW",
          "description": "5 kW (sistema solar)"
        }
      },
      "values": {},
      "formats": {
      ...
      "infoCards": {
        ...
        "tips": {
          ...
          "items": [
            "1 kW = 1,000 W | Un microondas típico usa 1,000-1,200 W (1-1.2 kW)",
            ...
            "Usa las preselecciones para valores de conversión comunes."
          ]
        }
      },
      "education": {
        "whatIs": {
          ...
          "content": "Convierte vatios a kilovatios al instante. 1 kW = 1,000 W. Esencial para electrodomésticos, paneles solares y electricidad. Este convertidor admite todas las unidades relacionadas en la categoría de potencia, permitiéndote convertir entre cualquier combinación con una sola entrada."
        },
        "howItWorks": {
        ...
        "considerations": {
          ...
          "items": [
            {
              "text": "1 kW = 1,000 W | Un microondas típico usa 1,000-1,200 W (1-1.2 kW)",
              "type": "info"
            },
            {
        ...
        "commonValues": {
          ...
          "items": [
            {
              "text": "Usa las preselecciones arriba para cantidades utilizadas frecuentemente.",
              "type": "info"
            },
            {
            ...
            {
              "text": "Admite todas las unidades del grupo de potencia.",
              "type": "info"
            }
          ]
        },
      ...
      "faqs": [
        ...
        },
        {
          ...
          "answer": "Este convertidor admite todas las unidades en la categoría de potencia: W, kW, MW, HP, BTUh, mW. Selecciona cualquiera del menú desplegable."
        },
        {
    ...
    pt: {
      "name": "Conversor de Watts para Quilowatts",
      "slug": "calculadora-watts-para-quilowatts",
      "subtitle": "Converta watts para quilowatts para eletrodomésticos, painéis solares e cálculos de eletricidade.",
      "breadcrumb": "Watts para Quilowatts",
      "seo": {
        "title": "Conversor de Watts para Quilowatts - Ferramenta de Conversão de Potência",
        "description": "Converta watts para quilowatts instantaneamente. 1 kW = 1.000 W. Essencial para eletrodomésticos, painéis solares e eletricidade.",
        "shortDescription": "Converta watts para quilowatts para eletrodomésticos, painéis solares e cálculos de eletricidade",
        "keywords": [
          "watts para quilowatts",
          "W para kW",
          "conversor de potência",
          "potência de eletrodomésticos",
          "calculadora painel solar",
      ...
      "infoCards": {
        ...
        "tips": {
          ...
          "items": [
            "1 kW = 1.000 W | Um micro-ondas típico usa 1.000-1.200 W (1-1,2 kW)",
      ...
      "education": {
        "whatIs": {
          ...
          "content": "Converta watts para quilowatts instantaneamente. 1 kW = 1.000 W. Essencial para eletrodomésticos, painéis solares e eletricidade. Este conversor suporta todas as unidades relacionadas na categoria de potência, permitindo converter entre qualquer combinação com uma única entrada."
        },
        "howItWorks": {
        ...
        "considerations": {
          ...
          "items": [
            {
              "text": "1 kW = 1.000 W | Um micro-ondas típico usa 1.000-1.200 W (1-1,2 kW)",
              "type": "info"
            },
            {
        ...
        "commonValues": {
          ...
          "items": [
            ...
            {
              "text": "Suporta todas as unidades no grupo de potência.",
              "type": "info"
            }
          ]
        },
      ...
      "faqs": [
        ...
        },
        {
          ...
          "answer": "Este conversor suporta todas as unidades na categoria de potência: W, kW, MW, HP, BTU/h, mW. Selecione qualquer uma no menu suspenso."
        },
        {
    ...
    fr: {
      "name": "Convertisseur Watts vers Kilowatts",
      "slug": "calculateur-watts-vers-kilowatts",
      "subtitle": "Convertissez les watts en kilowatts pour appareils électroménagers, panneaux solaires et calculs électriques.",
      "breadcrumb": "Watts vers Kilowatts",
      "seo": {
        "title": "Convertisseur Watts vers Kilowatts - Outil de Conversion de Puissance",
        "description": "Convertissez les watts en kilowatts instantanément. 1 kW = 1 000 W. Essentiel pour appareils, panneaux solaires et électricité.",
        "shortDescription": "Convertissez les watts en kilowatts pour appareils électroménagers, panneaux solaires et calculs électriques",
        "keywords": [
          "watts vers kilowatts",
          "W vers kW",
      ...
      "presets": {
        ...
        "fiveThousand": {
          "label": "☀️ 5 kW",
          "description": "5 kW (système solaire)"
        }
      },
      "values": {},
      "formats": {
      ...
      "infoCards": {
        ...
        "tips": {
          ...
          "items": [
            "1 kW = 1 000 W | Un micro-ondes typique utilise 1 000-1 200 W (1-1,2 kW)",
      ...
      "education": {
        "whatIs": {
          ...
          "content": "Convertissez les watts en kilowatts instantanément. 1 kW = 1 000 W. Essentiel pour appareils électroménagers, panneaux solaires et électricité. Ce convertisseur prend en charge toutes les unités connexes dans la catégorie puissance, vous permettant de convertir entre n'importe quelle combinaison avec une seule saisie."
        },
        "howItWorks": {
        ...
        "considerations": {
          ...
          "items": [
            {
              "text": "1 kW = 1 000 W | Un micro-ondes typique utilise 1 000-1 200 W (1-1,2 kW)",
              "type": "info"
            },
            {
        ...
        "commonValues": {
          ...
          "items": [
            ...
            {
              "text": "Prend en charge toutes les unités du groupe puissance.",
              "type": "info"
            }
          ]
        },
      ...
      "faqs": [
        ...
        },
        {
          ...
          "answer": "Ce convertisseur prend en charge toutes les unités de la catégorie puissance : W, kW, MW, HP, BTUh, mW. Sélectionnez n'importe laquelle dans le menu déroulant."
        },
        {
    ...
    de: {
      "name": "Watt zu Kilowatt Umrechner",
      "slug": "watt-zu-kilowatt-rechner",
      "subtitle": "Wandeln Sie Watt in Kilowatt um für Geräte, Solaranlagen und Stromberechnungen.",
      "breadcrumb": "Watt zu Kilowatt",
      "seo": {
        "title": "Watt zu Kilowatt Umrechner - Leistungsumrechnungstool",
        "description": "Wandeln Sie Watt sofort in Kilowatt um. 1 kW = 1.000 W. Unverzichtbar für Geräte, Solaranlagen und Strom.",
        "shortDescription": "Wandeln Sie Watt in Kilowatt um für Geräte, Solaranlagen und Stromberechnungen",
        "keywords": [
          "watt zu kilowatt",
          "W zu kW",
          "leistungsumrechner",
      ...
      "infoCards": {
        ...
        "tips": {
          ...
          "items": [
            "1 kW = 1.000 W | Eine typische Mikrowelle verbraucht 1.000-1.200 W (1-1,2 kW)",
      ...
      "education": {
        "whatIs": {
          ...
          "content": "Wandeln Sie Watt sofort in Kilowatt um. 1 kW = 1.000 W. Unverzichtbar für Geräte, Solaranlagen und Strom. Dieser Umrechner unterstützt alle verwandten Einheiten in der Leistungskategorie und ermöglicht die Umrechnung zwischen beliebigen Kombinationen mit einer einzigen Eingabe."
        },
        "howItWorks": {
        ...
        "considerations": {
          ...
          "items": [
            {
              "text": "1 kW = 1.000 W | Eine typische Mikrowelle verbraucht 1.000-1.200 W (1-1,2 kW)",
              "type": "info"
            },
            {
        ...
        "commonValues": {
          ...
          "items": [
            {
              "text": "Verwenden Sie die obigen Voreinstellungen für häufig verwendete Beträge.",
              "type": "info"
            },
            {
            ...
            {
              "text": "Unterstützt alle Einheiten in der Leistungsgruppe.",
              "type": "info"
            }
          ]
        },
      ...
      "faqs": [
        ...
        },
        {
          ...
          "answer": "Dieser Umrechner unterstützt alle Einheiten in der Leistungskategorie: W, kW, MW, PS, BTUh, mW. Wählen Sie eine beliebige aus dem Dropdown-Menü."
        },
        {
...
export function calculateWattsToKilowatts(data: {
  ...
  const allUnits = ["W", "kW", "MW", "HP", "BTUh", "mW"];
...
export default wattsToKilowattsConfig;
