...
export const mlToOzConfig: CalculatorConfigV4 = {
  id: "ml-to-oz",
  version: "4.0",
  category: "conversion",
  icon: "💧",
  ...
  presets: [
    { id: "shot", icon: "🥃", values: { amount: 30 } },
    { id: "cup", icon: "☕", values: { amount: 240 } },
    { id: "bottle", icon: "🍼", values: { amount: 500 } },
  ],
  ...
  t: {
    en: {
      ...
      breadcrumb: "mL to Fluid Ounces",

      seo: {
        title: "mL to Oz Converter - Milliliters to Fluid Ounces",
        description: "Convert milliliters to fluid ounces instantly. Essential for cooking recipes, medicine dosing, and beverage measurements.",
        shortDescription: "Convert milliliters to fluid ounces for cooking, medicine, and drinks.",
      ...
      presets: {
        shot: { label: "🥃 30 mL", description: "30 mL (1 oz shot)" },
        cup: { label: "☕ 240 mL", description: "240 mL (8 oz cup)" },
        bottle: { label: "🍼 500 mL", description: "500 mL (16.9 oz)" },
      },
      ...
      education: {
        whatIs: {
          ...
          content: "Convert milliliters to fluid ounces instantly. Essential for cooking recipes, medicine dosing, and beverage measurements. This converter supports all related units in the volume category, letting you convert between any combination with a single input.",
        },
        howItWorks: {
        ...
        considerations: {
          ...
          items: [
            { text: "Quick estimate: 30 mL ≈ 1 fl oz", type: "info" },
      ...
      faqs: [
        ...
        { question: "What units are supported?", answer: "This converter supports all units in the volume category: mL, fl_oz, L, cups, tbsp, tsp. Select any from the dropdown." },
    ...
    es: {
      "name": "Conversor de mL a Onzas Líquidas",
      "slug": "calculadora-ml-a-onzas-liquidas",
      "subtitle": "Convierte mililitros a onzas líquidas para cocina, medicina y bebidas.",
      "breadcrumb": "mL a Onzas Líquidas",
      "seo": {
        "title": "Conversor mL a Oz - Mililitros a Onzas Líquidas",
        "description": "Convierte mililitros a onzas líquidas al instante. Esencial para recetas de cocina, dosificación de medicinas y medidas de bebidas.",
        "shortDescription": "Convierte mililitros a onzas líquidas para cocina, medicina y bebidas.",
        "keywords": [
          "ml a oz",
          "mililitros a onzas",
          "ml a onzas líquidas",
      ...
      "presets": {
        "shot": {
          "label": "🥃 30 mL",
          "description": "30 mL (1 oz shot)"
        },
        "cup": {
          "label": "☕ 240 mL",
          "description": "240 mL (8 oz taza)"
        },
        "bottle": {
          "label": "🍼 500 mL",
          "description": "500 mL (16.9 oz)"
        }
      },
      "values": {},
      "formats": {
      ...
      "infoCards": {
        ...
        "tips": {
          ...
          "items": [
            "Estimación rápida: 30 mL ≈ 1 fl oz",
      ...
      "education": {
        "whatIs": {
          ...
          "content": "Convierte mililitros a onzas líquidas al instante. Esencial para recetas de cocina, dosificación de medicinas y medidas de bebidas. Este conversor soporta todas las unidades relacionadas en la categoría de volumen, permitiéndote convertir entre cualquier combinación con una sola entrada."
        },
        "howItWorks": {
          "title": "Cómo Convertir",
          "content": "Ingresa tu valor y selecciona la unidad de origen del menú desplegable. El conversor muestra instantáneamente el equivalente en todas las demás unidades de este tipo. Todas las conversiones usan factores precisos de estándares internacionales (NIST/BIPM)."
        },
        "considerations": {
          "title": "Notas Importantes",
          "items": [
            {
              "text": "Estimación rápida: 30 mL ≈ 1 fl oz",
              "type": "info"
            },
            {
            ...
            {
              "text": "Guarda esta página en marcadores para acceso rápido al conversor.",
              "type": "info"
            }
          ]
        },
        "commonValues": {
          ...
          "items": [
            ...
            {
              "text": "Usa los preajustes arriba para cantidades frecuentemente usadas.",
              "type": "info"
            },
            {
      ...
      "faqs": [
        ...
        },
        {
          ...
          "answer": "¡Sí! Simplemente cambia la unidad en el menú desplegable para convertir de cualquier unidad a todas las demás. El conversor es completamente bidireccional."
        },
        {
          "question": "¿Qué unidades son compatibles?",
          "answer": "Este conversor soporta todas las unidades en la categoría de volumen: mL, fl_oz, L, tazas, cucharadas, cucharaditas. Selecciona cualquiera del menú desplegable."
        },
        {
          "question": "¿Funciona esto en móvil?",
          "answer": "Sí, este conversor es completamente responsivo y funciona en cualquier dispositivo — teléfono, tablet o escritorio."
        },
        {
        ...
        {
          "question": "¿Es gratis este conversor?",
          "answer": "Sí, 100% gratis sin necesidad de registro. Úsalo tantas veces como necesites."
        }
      ],
      "buttons": {
        "calculate": "Calcular",
    ...
    pt: {
      "name": "Conversor de mL para Onças Fluidas",
      "slug": "calculadora-ml-para-oncas-fluidas",
      "subtitle": "Converta mililitros para onças fluidas para culinária, medicina e bebidas.",
      "breadcrumb": "mL para Onças Fluidas",
      "seo": {
        "title": "Conversor mL para Oz - Mililitros para Onças Fluidas",
        "description": "Converta mililitros para onças fluidas instantaneamente. Essencial para receitas culinárias, dosagem de medicamentos e medições de bebidas.",
        "shortDescription": "Converta mililitros para onças fluidas para culinária, medicina e bebidas.",
        "keywords": [
          "ml para oz",
          "mililitros para onças",
          "ml para onças fluidas",
          "conversor mL",
          "métrico para oz",
          "conversão culinária ml oz"
        ]
      },
      "inputs": {
        "amount": {
      ...
      "presets": {
        "shot": {
          "label": "🥃 30 mL",
          "description": "30 mL (1 oz dose)"
        },
        "cup": {
          "label": "☕ 240 mL",
          "description": "240 mL (8 oz xícara)"
        },
        "bottle": {
          "label": "🍼 500 mL",
          "description": "500 mL (16,9 oz)"
      ...
      "infoCards": {
        ...
        "tips": {
          ...
          "items": [
            "Estimativa rápida: 30 mL ≈ 1 fl oz",
      ...
      "education": {
        "whatIs": {
          ...
          "content": "Converta mililitros para onças fluidas instantaneamente. Essencial para receitas culinárias, dosagem de medicamentos e medições de bebidas. Este conversor suporta todas as unidades relacionadas na categoria de volume, permitindo converter entre qualquer combinação com uma única entrada."
        },
        "howItWorks": {
        ...
        "considerations": {
          ...
          "items": [
            {
              "text": "Estimativa rápida: 30 mL ≈ 1 fl oz",
              "type": "info"
            },
            {
      ...
      "faqs": [
        ...
        },
        {
          ...
          "answer": "Este conversor suporta todas as unidades na categoria de volume: mL, fl_oz, L, xícaras, colheres de sopa, colheres de chá. Selecione qualquer uma do menu suspenso."
        },
        {
    ...
    fr: {
      "name": "Convertisseur mL vers Onces Liquides",
      "slug": "calculateur-ml-vers-onces-liquides",
      "subtitle": "Convertissez les millilitres en onces liquides pour la cuisine, les médicaments et les boissons.",
      "breadcrumb": "mL vers Onces Liquides",
      "seo": {
        "title": "Convertisseur mL vers Oz - Millilitres vers Onces Liquides",
        "description": "Convertissez instantanément les millilitres en onces liquides. Essentiel pour les recettes de cuisine, le dosage de médicaments et les mesures de boissons.",
        "shortDescription": "Convertissez les millilitres en onces liquides pour la cuisine, les médicaments et les boissons.",
        "keywords": [
          "ml vers oz",
          "millilitres vers onces",
          "ml vers onces liquides",
          "convertisseur mL",
          "métrique vers oz",
          "conversion cuisine ml oz"
        ]
      },
      "inputs": {
        "amount": {
      ...
      "presets": {
        ...
        "cup": {
          "label": "☕ 240 mL",
          "description": "240 mL (tasse de 8 oz)"
        },
        "bottle": {
          "label": "🍼 500 mL",
          "description": "500 mL (16,9 oz)"
      ...
      "infoCards": {
        ...
        "tips": {
          ...
          "items": [
            "Estimation rapide : 30 mL ≈ 1 oz liquide",
      ...
      "education": {
        "whatIs": {
          ...
          "content": "Convertissez instantanément les millilitres en onces liquides. Essentiel pour les recettes de cuisine, le dosage de médicaments et les mesures de boissons. Ce convertisseur prend en charge toutes les unités associées de la catégorie volume, vous permettant de convertir entre n'importe quelle combinaison avec une seule saisie."
        },
        "howItWorks": {
        ...
        "considerations": {
          ...
          "items": [
            {
              "text": "Estimation rapide : 30 mL ≈ 1 oz liquide",
              "type": "info"
            },
            {
      ...
      "faqs": [
        ...
        },
        {
          ...
          "answer": "Ce convertisseur prend en charge toutes les unités de la catégorie volume : mL, oz liquides, L, tasses, cuillères à soupe, cuillères à café. Sélectionnez n'importe laquelle dans le menu déroulant."
        },
        {
    ...
    de: {
      "name": "mL zu Flüssigkeitsunzen Umrechner",
      "slug": "ml-zu-fluessigkeitsunzen-rechner",
      "subtitle": "Milliliter in Flüssigkeitsunzen umrechnen für Kochen, Medizin und Getränke.",
      "breadcrumb": "mL zu Flüssigkeitsunzen",
      "seo": {
        "title": "mL zu Unzen Umrechner - Milliliter zu Flüssigkeitsunzen",
        "description": "Milliliter sofort in Flüssigkeitsunzen umrechnen. Unverzichtbar für Kochrezepte, Medikamentendosierung und Getränkemessungen.",
        "shortDescription": "Milliliter in Flüssigkeitsunzen umrechnen für Kochen, Medizin und Getränke.",
        "keywords": [
          "ml zu unzen",
          "milliliter zu unzen",
          "ml zu flüssigkeitsunzen",
          "mL umrechner",
          "metrisch zu unzen",
          "koch umrechnung ml unzen"
        ]
      },
      "inputs": {
        "amount": {
      ...
      "presets": {
        "shot": {
          "label": "🥃 30 mL",
          "description": "30 mL (1 Unzen Shot)"
        },
        "cup": {
          "label": "☕ 240 mL",
          "description": "240 mL (8 Unzen Tasse)"
        },
        "bottle": {
          "label": "🍼 500 mL",
          "description": "500 mL (16,9 Unzen)"
        }
      },
      "values": {},
      "formats": {
      ...
      "infoCards": {
        ...
        "tips": {
          ...
          "items": [
            "Schnelle Schätzung: 30 mL ≈ 1 fl oz",
      ...
      "education": {
        "whatIs": {
          ...
          "content": "Rechnen Sie Milliliter sofort in Flüssigkeitsunzen um. Unverzichtbar für Kochrezepte, Medikamentendosierung und Getränkemessungen. Dieser Umrechner unterstützt alle verwandten Einheiten in der Volumenkategorie und ermöglicht es Ihnen, mit einer einzigen Eingabe zwischen beliebigen Kombinationen umzurechnen."
        },
        "howItWorks": {
        ...
        "considerations": {
          ...
          "items": [
            {
              "text": "Schnelle Schätzung: 30 mL ≈ 1 fl oz",
              "type": "info"
            },
            {
          ...
          "examples": [
            ...
            },
            {
              ...
              "steps": [
                ...
                "Ihren Wert eingeben",
                "Ergebnis in ursprünglicher Einheit ablesen"
              ],
      ...
      "faqs": [
        ...
        {
          "question": "Kann ich in umgekehrte Richtung umrechnen?",
        ...
        },
        {
          ...
          "answer": "Dieser Umrechner unterstützt alle Einheiten in der Volumenkategorie: mL, fl_oz, L, Tassen, EL, TL. Wählen Sie eine beliebige aus dem Dropdown."
        },
        {
...
export function calculateMlToOz(data: {
  ...
  const allUnits = ["mL", "fl_oz", "L", "cups", "tbsp", "tsp"];
