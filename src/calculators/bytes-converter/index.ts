...
export const bytesConverterConfig: CalculatorConfigV4 = {
  id: "bytes-converter",
  version: "4.0",
  category: "conversion",
  icon: "💾",
  ...
  presets: [
    { id: "oneGB", icon: "📱", values: { amount: 1 } },
    { id: "hundredGB", icon: "💻", values: { amount: 100 } },
    { id: "oneTB", icon: "🖥️", values: { amount: 1024 } },
  ],

  t: {
    en: {
      name: "Bytes Converter (MB, GB, TB)",
      slug: "bytes-converter",
      subtitle: "Convert between KB, MB, GB, TB, and PB for storage, file sizes, and data management.",
      breadcrumb: "Bytes (MB, GB, TB)",

      seo: {
        title: "Bytes Converter - MB to GB to TB Data Size Tool",
        description: "Convert between bytes, KB, MB, GB, TB, and PB instantly. Essential for storage, file sizes, and data management.",
        shortDescription: "Convert between KB, MB, GB, TB, and PB for storage, file sizes, and data managem",
      ...
      presets: {
        oneGB: { label: "📱 1 GB", description: "1 GB (1,024 MB)" },
        hundredGB: { label: "💻 100 GB", description: "100 GB" },
        oneTB: { label: "🖥️ 1 TB", description: "1 TB (1,024 GB)" },
      },
      ...
      education: {
        whatIs: {
          ...
          content: "Convert between bytes, KB, MB, GB, TB, and PB instantly. Essential for storage, file sizes, and data management. This converter supports all related units in the data category, letting you convert between any combination with a single input.",
        },
        howItWorks: {
        ...
        considerations: {
          ...
          items: [
            { text: "1 GB = 1,024 MB = 1,048,576 KB", type: "info" },
      ...
      faqs: [
        ...
        { question: "What units are supported?", answer: "This converter supports all units in the data category: byte, kb, mb, gb, tb, pb. Select any from the dropdown." },
    ...
    es: {
      "name": "Conversor de Bytes (MB, GB, TB)",
      "slug": "calculadora-conversor-bytes",
      "subtitle": "Convierte entre KB, MB, GB, TB y PB para almacenamiento, tamaños de archivo y gestión de datos.",
      "breadcrumb": "Bytes (MB, GB, TB)",
      "seo": {
        "title": "Conversor de Bytes - Herramienta de Conversión MB a GB a TB",
        "description": "Convierte entre bytes, KB, MB, GB, TB y PB al instante. Esencial para almacenamiento, tamaños de archivo y gestión de datos.",
        "shortDescription": "Convierte entre KB, MB, GB, TB y PB para almacenamiento, tamaños de archivo y gestión de datos",
        "keywords": [
          "conversor de bytes",
          "MB a GB",
          "GB a TB",
      ...
      "education": {
        "whatIs": {
          ...
          "content": "Convierte entre bytes, KB, MB, GB, TB y PB al instante. Esencial para almacenamiento, tamaños de archivo y gestión de datos. Este conversor soporta todas las unidades relacionadas en la categoría de datos, permitiéndote convertir entre cualquier combinación con una sola entrada."
        },
        "howItWorks": {
        ...
        "considerations": {
          ...
          "items": [
            {
              "text": "1 GB = 1,024 MB = 1,048,576 KB",
              "type": "info"
            },
            {
            ...
            {
              "text": "Guarda esta página en marcadores para acceso rápido a este conversor.",
              "type": "info"
            }
          ]
        },
      ...
      "faqs": [
        ...
        },
        {
          ...
          "answer": "Este conversor soporta todas las unidades en la categoría de datos: byte, kb, mb, gb, tb, pb. Selecciona cualquiera del menú desplegable."
        },
        {
    ...
    pt: {
      "name": "Conversor de Bytes (MB, GB, TB)",
      "slug": "calculadora-conversor-bytes",
      "subtitle": "Converta entre KB, MB, GB, TB e PB para armazenamento, tamanhos de arquivo e gerenciamento de dados.",
      "breadcrumb": "Bytes (MB, GB, TB)",
      "seo": {
        "title": "Conversor de Bytes - Ferramenta MB para GB para TB",
        "description": "Converta entre bytes, KB, MB, GB, TB e PB instantaneamente. Essencial para armazenamento, tamanhos de arquivo e gerenciamento de dados.",
        "shortDescription": "Converta entre KB, MB, GB, TB e PB para armazenamento, tamanhos de arquivo e gerenciamento de dados",
        "keywords": [
          "conversor de bytes",
          "MB para GB",
          "GB para TB",
          "conversor tamanho dados",
          "calculadora tamanho arquivo",
      ...
      "education": {
        "whatIs": {
          ...
          "content": "Converta entre bytes, KB, MB, GB, TB e PB instantaneamente. Essencial para armazenamento, tamanhos de arquivo e gerenciamento de dados. Este conversor suporta todas as unidades relacionadas na categoria de dados, permitindo converter entre qualquer combinação com uma única entrada."
        },
        "howItWorks": {
      ...
      "faqs": [
        ...
        },
        {
          ...
          "answer": "Este conversor suporta todas as unidades na categoria de dados: byte, kb, mb, gb, tb, pb. Selecione qualquer uma no menu suspenso."
        },
        {
    ...
    fr: {
      "name": "Convertisseur d'Octets (Mo, Go, To)",
      "slug": "calculateur-convertisseur-octets",
      "subtitle": "Convertir entre Ko, Mo, Go, To et Po pour le stockage, les tailles de fichiers et la gestion des données.",
      "breadcrumb": "Octets (Mo, Go, To)",
      "seo": {
        "title": "Convertisseur d'Octets - Outil de Conversion Mo vers Go vers To",
        "description": "Convertir instantanément entre octets, Ko, Mo, Go, To et Po. Essentiel pour le stockage, les tailles de fichiers et la gestion des données.",
        "shortDescription": "Convertir entre Ko, Mo, Go, To et Po pour le stockage, les tailles de fichiers et la gestion des données",
        "keywords": [
          "convertisseur octets",
          "Mo vers Go",
          "Go vers To",
          "convertisseur taille données",
          "calculateur taille fichier",
      ...
      "inputs": {
        "amount": {
          ...
          "helpText": "Entrez la taille des données à convertir"
        }
      },
      "results": {
        "primary": {
      ...
      "education": {
        "whatIs": {
          ...
          "content": "Convertir instantanément entre octets, Ko, Mo, Go, To et Po. Essentiel pour le stockage, les tailles de fichiers et la gestion des données. Ce convertisseur prend en charge toutes les unités liées dans la catégorie des données, vous permettant de convertir entre n'importe quelle combinaison avec une seule saisie."
        },
        "howItWorks": {
        ...
        "considerations": {
          ...
          "items": [
            {
              "text": "1 Go = 1 024 Mo = 1 048 576 Ko",
              "type": "info"
            },
            {
      ...
      "faqs": [
        ...
        },
        {
          ...
          "answer": "Ce convertisseur supporte toutes les unités dans la catégorie des données : octet, Ko, Mo, Go, To, Po. Sélectionnez n'importe laquelle dans le menu déroulant."
        },
        {
    ...
    de: {
      "name": "Bytes Umrechner (MB, GB, TB)",
      "slug": "bytes-umrechner",
      "subtitle": "Umrechnung zwischen KB, MB, GB, TB und PB für Speicher, Dateigrößen und Datenmanagement.",
      "breadcrumb": "Bytes (MB, GB, TB)",
      "seo": {
        "title": "Bytes Umrechner - MB zu GB zu TB Datengröße Tool",
        "description": "Sofortige Umrechnung zwischen Bytes, KB, MB, GB, TB und PB. Unverzichtbar für Speicher, Dateigrößen und Datenmanagement.",
        "shortDescription": "Umrechnung zwischen KB, MB, GB, TB und PB für Speicher, Dateigrößen und Datenmanagement",
        "keywords": [
          "bytes umrechner",
          "MB zu GB",
          "GB zu TB",
          "datengröße umrechner",
          "dateigröße rechner",
          "speicher umrechner",
          "KB MB GB TB"
        ]
      ...
      "education": {
        "whatIs": {
          ...
          "content": "Sofortige Umrechnung zwischen Bytes, KB, MB, GB, TB und PB. Unverzichtbar für Speicher, Dateigrößen und Datenmanagement. Dieser Umrechner unterstützt alle verwandten Einheiten in der Datenkategorie und ermöglicht die Umrechnung zwischen beliebigen Kombinationen mit einer einzigen Eingabe."
        },
        "howItWorks": {
          "title": "So rechnen Sie um",
          "content": "Geben Sie Ihren Wert ein und wählen Sie die Quelleinheit aus der Dropdown-Liste. Der Umrechner zeigt sofort das Äquivalent in allen anderen Einheiten dieses Typs. Alle Umrechnungen verwenden präzise Faktoren der internationalen Standards (NIST/BIPM)."
        },
        "considerations": {
      ...
      "faqs": [
        {
          ...
          "answer": "Alle Umrechnungen verwenden exakte Faktoren der NIST- und BIPM-Internationalen Standards. Ergebnisse sind auf mindestens 6 signifikante Stellen genau."
        },
        {
        ...
        },
        {
          ...
          "answer": "Dieser Umrechner unterstützt alle Einheiten der Datenkategorie: Byte, KB, MB, GB, TB, PB. Wählen Sie eine beliebige aus der Dropdown-Liste."
        },
        {
...
export function calculateBytesConverter(data: {
  ...
  const fromUnit = fieldUnits.amount || "gb";
  ...
  const allUnits = ["byte", "kb", "mb", "gb", "tb", "pb"];
...
export default bytesConverterConfig;
