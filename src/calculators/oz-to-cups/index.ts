...
export const ozToCupsConfig: CalculatorConfigV4 = {
  id: "oz-to-cups",
  version: "4.0",
  category: "conversion",
  icon: "🥤",
  ...
  t: {
    en: {
      name: "Fluid Ounces to Cups Converter",
      slug: "oz-to-cups",
      subtitle: "Convert fluid ounces to cups for cooking, beverages, and recipe measurements.",
      breadcrumb: "Fluid Ounces to Cups",

      seo: {
        title: "Oz to Cups Converter - Fluid Ounces to Cups",
        description: "Convert fluid ounces to cups for cooking and beverages. 8 fl oz = 1 cup. Includes milliliters and tablespoons.",
        shortDescription: "Convert fluid ounces to cups for cooking, beverages, and recipe measurements.",
      ...
      presets: {
        four: { label: "🥤 4 fl oz", description: "4 fl oz (½ cup)" },
        eight: { label: "☕ 8 fl oz", description: "8 fl oz (1 cup)" },
        sixteen: { label: "🫗 16 fl oz", description: "16 fl oz (2 cups)" },
      },
      ...
      infoCards: {
        ...
        tips: {
          ...
          items: [
            "8 fluid ounces = 1 cup | 1 fl oz ≈ 29.6 mL",
      ...
      education: {
        whatIs: {
          ...
          content: "Convert fluid ounces to cups for cooking and beverages. 8 fl oz = 1 cup. Includes milliliters and tablespoons. This converter supports all related units in the cooking_volume category, letting you convert between any combination with a single input.",
        },
        howItWorks: {
        ...
        considerations: {
          ...
          items: [
            { text: "8 fluid ounces = 1 cup | 1 fl oz ≈ 29.6 mL", type: "info" },
      ...
      faqs: [
        ...
        { question: "What units are supported?", answer: "This converter supports all units in the cooking_volume category: fl_oz, cups, mL, L, tbsp, tsp. Select any from the dropdown." },
    ...
    es: {
      "name": "Convertidor de Onzas Líquidas a Tazas",
      "slug": "calculadora-onzas-liquidas-a-tazas",
      "subtitle": "Convierte onzas líquidas a tazas para cocina, bebidas y medidas de recetas.",
      "breadcrumb": "Onzas Líquidas a Tazas",
      "seo": {
        "title": "Convertidor Onzas a Tazas - Onzas Líquidas a Tazas",
        "description": "Convierte onzas líquidas a tazas para cocina y bebidas. 8 fl oz = 1 taza. Incluye mililitros y cucharadas.",
        "shortDescription": "Convierte onzas líquidas a tazas para cocina, bebidas y medidas de recetas.",
        "keywords": [
          "onzas a tazas",
          "onzas líquidas a tazas",
          "cuántas onzas en una taza",
          "conversión cocina",
          "medida bebidas",
          "convertidor onzas tazas"
        ]
      },
      "inputs": {
        "amount": {
      ...
      "presets": {
        "four": {
          "label": "🥤 4 fl oz",
          "description": "4 fl oz (½ taza)"
        },
        "eight": {
          "label": "☕ 8 fl oz",
          "description": "8 fl oz (1 taza)"
        },
        "sixteen": {
          "label": "🫗 16 fl oz",
          "description": "16 fl oz (2 tazas)"
        }
      },
      "values": {},
      "formats": {
      ...
      "infoCards": {
        ...
        "tips": {
          ...
          "items": [
            "8 onzas líquidas = 1 taza | 1 fl oz ≈ 29.6 mL",
      ...
      "education": {
        "whatIs": {
          ...
          "content": "Convierte onzas líquidas a tazas para cocina y bebidas. 8 fl oz = 1 taza. Incluye mililitros y cucharadas. Este convertidor admite todas las unidades relacionadas en la categoría cooking_volume, permitiéndote convertir entre cualquier combinación con una sola entrada."
        },
        "howItWorks": {
        ...
        "considerations": {
          ...
          "items": [
            {
              "text": "8 onzas líquidas = 1 taza | 1 fl oz ≈ 29.6 mL",
              "type": "info"
            },
            {
        ...
        "commonValues": {
          ...
          "items": [
            ...
            {
              "text": "Admite todas las unidades del grupo cooking_volume.",
              "type": "info"
            }
          ]
        },
      ...
      "faqs": [
        ...
        },
        {
          ...
          "answer": "Este convertidor admite todas las unidades de la categoría cooking_volume: fl_oz, tazas, mL, L, cucharadas, cucharaditas. Selecciona cualquiera del menú desplegable."
        },
        {
    ...
    pt: {
      "name": "Conversor de Onças Fluidas para Xícaras",
      "slug": "calculadora-oncas-fluidas-para-xicaras",
      "subtitle": "Converta onças fluidas para xícaras para culinária, bebidas e medidas de receitas.",
      "breadcrumb": "Onças Fluidas para Xícaras",
      "seo": {
        "title": "Conversor Onças para Xícaras - Onças Fluidas para Xícaras",
        "description": "Converta onças fluidas para xícaras para culinária e bebidas. 8 fl oz = 1 xícara. Inclui mililitros e colheres de sopa.",
        "shortDescription": "Converta onças fluidas para xícaras para culinária, bebidas e medidas de receitas.",
        "keywords": [
          "onças para xícaras",
          "onças fluidas para xícaras",
          "quantas onças em uma xícara",
          "conversão culinária",
          "medida de bebidas",
          "conversor onças xícaras"
        ]
      },
      "inputs": {
        "amount": {
      ...
      "presets": {
        "four": {
          "label": "🥤 4 fl oz",
          "description": "4 fl oz (½ xícara)"
        },
        "eight": {
          "label": "☕ 8 fl oz",
          "description": "8 fl oz (1 xícara)"
        },
        "sixteen": {
          "label": "🫗 16 fl oz",
          "description": "16 fl oz (2 xícaras)"
        }
      },
      "values": {},
      "formats": {
      ...
      "infoCards": {
        ...
        "tips": {
          ...
          "items": [
            "8 onças fluidas = 1 xícara | 1 fl oz ≈ 29,6 mL",
      ...
      "education": {
        "whatIs": {
          ...
          "content": "Converta onças fluidas para xícaras para culinária e bebidas. 8 fl oz = 1 xícara. Inclui mililitros e colheres de sopa. Este conversor suporta todas as unidades relacionadas na categoria cooking_volume, permitindo converter entre qualquer combinação com uma única entrada."
        },
        "howItWorks": {
        ...
        "considerations": {
          ...
          "items": [
            {
              "text": "8 onças fluidas = 1 xícara | 1 fl oz ≈ 29,6 mL",
              "type": "info"
            },
            {
        ...
        "commonValues": {
          ...
          "items": [
            ...
            {
              "text": "Suporta todas as unidades no grupo cooking_volume.",
              "type": "info"
            }
          ]
        },
      ...
      "faqs": [
        {
          "question": "Qual é a precisão dessas conversões?",
        ...
        },
        {
          ...
          "answer": "Este conversor suporta todas as unidades na categoria cooking_volume: fl_oz, xícaras, mL, L, colheres de sopa, colheres de chá. Selecione qualquer uma no menu suspenso."
        },
        {
    ...
    fr: {
      "name": "Convertisseur Once Liquide vers Tasses",
      "slug": "calculateur-once-liquide-vers-tasses",
      "subtitle": "Convertissez les onces liquides en tasses pour la cuisine, les boissons et les mesures de recettes.",
      "breadcrumb": "Once Liquide vers Tasses",
      "seo": {
        "title": "Convertisseur Once vers Tasses - Onces Liquides vers Tasses",
        "description": "Convertissez les onces liquides en tasses pour la cuisine et les boissons. 8 fl oz = 1 tasse. Inclut millilitres et cuillères à soupe.",
        "shortDescription": "Convertissez les onces liquides en tasses pour la cuisine, les boissons et les mesures de recettes.",
        "keywords": [
          "once vers tasses",
          "onces liquides vers tasses",
          "combien d'onces dans une tasse",
          "conversion cuisine",
          "mesure boisson",
          "convertisseur once tasse"
        ]
      },
      "inputs": {
        "amount": {
      ...
      "presets": {
        "four": {
          "label": "🥤 4 fl oz",
          "description": "4 fl oz (½ tasse)"
        },
        "eight": {
          "label": "☕ 8 fl oz",
          "description": "8 fl oz (1 tasse)"
        },
        "sixteen": {
          "label": "🫗 16 fl oz",
          "description": "16 fl oz (2 tasses)"
        }
      },
      "values": {},
      "formats": {
      ...
      "infoCards": {
        ...
        "tips": {
          ...
          "items": [
            "8 onces liquides = 1 tasse | 1 fl oz ≈ 29,6 mL",
      ...
      "education": {
        "whatIs": {
          ...
          "content": "Convertissez les onces liquides en tasses pour la cuisine et les boissons. 8 fl oz = 1 tasse. Inclut millilitres et cuillères à soupe. Ce convertisseur prend en charge toutes les unités associées dans la catégorie volume_cuisine, vous permettant de convertir entre n'importe quelle combinaison avec une seule saisie."
        },
        "howItWorks": {
        ...
        "considerations": {
          ...
          "items": [
            {
              "text": "8 onces liquides = 1 tasse | 1 fl oz ≈ 29,6 mL",
              "type": "info"
            },
            {
      ...
      "faqs": [
        ...
        },
        {
          ...
          "answer": "Ce convertisseur prend en charge toutes les unités de la catégorie volume_cuisine : fl_oz, tasses, mL, L, c. à soupe, c. à thé. Sélectionnez n'importe laquelle dans le menu déroulant."
        },
        {
    ...
    de: {
      "name": "Flüssigunzen zu Tassen Umrechner",
      "slug": "fluessigounzen-zu-tassen-rechner",
      "subtitle": "Wandeln Sie Flüssigunzen in Tassen um für Kochen, Getränke und Rezeptmessungen.",
      "breadcrumb": "Flüssigunzen zu Tassen",
      "seo": {
        "title": "Unzen zu Tassen Umrechner - Flüssigunzen zu Tassen",
        "description": "Wandeln Sie Flüssigunzen in Tassen um für Kochen und Getränke. 8 fl oz = 1 Tasse. Enthält Milliliter und Esslöffel.",
        "shortDescription": "Wandeln Sie Flüssigunzen in Tassen um für Kochen, Getränke und Rezeptmessungen.",
        "keywords": [
          "Unzen zu Tassen",
          "Flüssigunzen zu Tassen",
          "wie viele Unzen in einer Tasse",
          "Koch Umrechnung",
          "Getränke Messung",
          "Unzen Tassen Umrechner"
        ]
      },
      "inputs": {
        "amount": {
      ...
      "infoCards": {
        ...
        "tips": {
          ...
          "items": [
            "8 Flüssigunzen = 1 Tasse | 1 fl oz ≈ 29,6 mL",
      ...
      "education": {
        "whatIs": {
          ...
          "content": "Wandeln Sie Flüssigunzen in Tassen um für Kochen und Getränke. 8 fl oz = 1 Tasse. Enthält Milliliter und Esslöffel. Dieser Umrechner unterstützt alle verwandten Einheiten in der Kategorie Koch-Volumen und ermöglicht es Ihnen, mit einer einzigen Eingabe zwischen beliebigen Kombinationen umzurechnen."
        },
        "howItWorks": {
        ...
        "considerations": {
          ...
          "items": [
            {
              "text": "8 Flüssigunzen = 1 Tasse | 1 fl oz ≈ 29,6 mL",
              "type": "info"
            },
            {
        ...
        "commonValues": {
          ...
          "items": [
            ...
            {
              "text": "Unterstützt alle Einheiten in der Koch-Volumen-Gruppe.",
              "type": "info"
            }
          ]
        },
      ...
      "faqs": [
        ...
        },
        {
          ...
          "answer": "Dieser Umrechner unterstützt alle Einheiten in der Koch-Volumen-Kategorie: fl_oz, Tassen, mL, L, EL, TL. Wählen Sie eine aus dem Dropdown-Menü."
        },
        {
...
export function calculateOzToCups(data: {
  ...
  const fromUnit = fieldUnits.amount || "fl_oz";
  ...
  const allUnits = ["fl_oz", "cups", "mL", "L", "tbsp", "tsp"];
