...
export const acresToHectaresConfig: CalculatorConfigV4 = {
  ...
  presets: [
    ...
    { id: "forty", icon: "🏞️", values: { amount: 40 } },
  ],
  ...
  t: {
    en: {
      ...
      breadcrumb: "Acres to Hectares",

      seo: {
        title: "Acres to Hectares Converter - Land Area Conversion",
        description: "Convert acres to hectares instantly for international real estate, farming, and land measurement.",
        shortDescription: "Convert acres to hectares for international real estate, farming, and property m",
      ...
      presets: {
        one: { label: "🏡 1 acre", description: "1 acre (0.405 ha)" },
        five: { label: "🌾 5 acres", description: "5 acres (2.02 ha)" },
        forty: { label: "🏞️ 40 acres", description: "40 acres (16.2 ha)" },
      },
      ...
      infoCards: {
        ...
        tips: {
          ...
          items: [
            "Quick estimate: 1 acre ≈ 0.405 hectares",
      ...
      education: {
        whatIs: {
          ...
          content: "Convert acres to hectares instantly for international real estate, farming, and land measurement. This converter supports all related units in the area category, letting you convert between any combination with a single input.",
        },
        howItWorks: {
        ...
        considerations: {
          ...
          items: [
            { text: "Quick estimate: 1 acre ≈ 0.405 hectares", type: "info" },
      ...
      faqs: [
        ...
        { question: "What units are supported?", answer: "This converter supports all units in the area category: acres, hectares, m2, km2, ft2, yd2. Select any from the dropdown." },
    ...
    es: {
      "name": "Convertidor de Acres a Hectáreas",
      "slug": "calculadora-acres-hectareas",
      "subtitle": "Convierte acres a hectáreas para bienes raíces internacionales, agricultura y mediciones de propiedades.",
      "breadcrumb": "Acres a Hectáreas",
      "seo": {
        "title": "Convertidor de Acres a Hectáreas - Conversión de Área de Terreno",
        "description": "Convierte acres a hectáreas al instante para bienes raíces internacionales, agricultura y medición de terrenos.",
        "shortDescription": "Convierte acres a hectáreas para bienes raíces internacionales, agricultura y propiedades",
        "keywords": [
          "acres a hectáreas",
          "acres a ha",
          "convertidor de terreno",
          "conversión área agrícola",
          "hectáreas propiedad",
          "calculadora acre hectárea"
        ]
      },
      "inputs": {
        "amount": {
      ...
      "presets": {
        "one": {
          "label": "🏡 1 acre",
          "description": "1 acre (0,405 ha)"
        },
        "five": {
          "label": "🌾 5 acres",
          "description": "5 acres (2,02 ha)"
        },
        "forty": {
          "label": "🏞️ 40 acres",
          "description": "40 acres (16,2 ha)"
        }
      },
      "values": {},
      "formats": {
      ...
      "infoCards": {
        ...
        "tips": {
          ...
          "items": [
            "Estimación rápida: 1 acre ≈ 0,405 hectáreas",
      ...
      "education": {
        "whatIs": {
          ...
          "content": "Convierte acres a hectáreas al instante para bienes raíces internacionales, agricultura y medición de terrenos. Este convertidor admite todas las unidades relacionadas en la categoría de área, permitiéndote convertir entre cualquier combinación con una sola entrada."
        },
        "howItWorks": {
        ...
        "considerations": {
          ...
          "items": [
            {
              "text": "Estimación rápida: 1 acre ≈ 0,405 hectáreas",
              "type": "info"
            },
            {
        ...
        "commonValues": {
          ...
          "items": [
            ...
            {
              "text": "Usa las opciones predefinidas para cantidades frecuentemente utilizadas.",
              "type": "info"
            },
            {
      ...
      "faqs": [
        ...
        },
        {
          ...
          "answer": "Este convertidor admite todas las unidades en la categoría de área: acres, hectáreas, m2, km2, ft2, yd2. Selecciona cualquiera del menú desplegable."
        },
        {
    ...
    pt: {
      "name": "Conversor de Acres para Hectares",
      "slug": "calculadora-acres-para-hectares",
      "subtitle": "Converta acres para hectares para imóveis internacionais, agricultura e medições de propriedades.",
      "breadcrumb": "Acres para Hectares",
      "seo": {
        "title": "Conversor de Acres para Hectares - Conversão de Área de Terra",
        "description": "Converta acres para hectares instantaneamente para imóveis internacionais, agricultura e medição de terras.",
        "shortDescription": "Converta acres para hectares para imóveis internacionais, agricultura e propriedades",
        "keywords": [
          "acres para hectares",
          "acres para ha",
          "conversor de terra",
          "conversão de área agrícola",
          "hectares propriedade",
          "calculadora acre hectare"
        ]
      },
      "inputs": {
        "amount": {
      ...
      "infoCards": {
        ...
        "tips": {
          ...
          "items": [
            "Estimativa rápida: 1 acre ≈ 0,405 hectares",
      ...
      "education": {
        "whatIs": {
          ...
          "content": "Converta acres para hectares instantaneamente para imóveis internacionais, agricultura e medição de terras. Este conversor suporta todas as unidades relacionadas na categoria de área, permitindo converter entre qualquer combinação com uma única entrada."
        },
        "howItWorks": {
        ...
        "considerations": {
          ...
          "items": [
            {
              "text": "Estimativa rápida: 1 acre ≈ 0,405 hectares",
              "type": "info"
            },
            {
      ...
      "faqs": [
        ...
        },
        {
          ...
          "answer": "Este conversor suporta todas as unidades na categoria de área: acres, hectares, m², km², ft², yd². Selecione qualquer uma no menu suspenso."
        },
        {
    ...
    fr: {
      "name": "Convertisseur Acres vers Hectares",
      "slug": "calculateur-acres-vers-hectares",
      "subtitle": "Convertissez les acres en hectares pour l'immobilier international, l'agriculture et les mesures de propriété.",
      "breadcrumb": "Acres vers Hectares",
      "seo": {
        "title": "Convertisseur Acres vers Hectares - Conversion de Superficie",
        "description": "Convertissez instantanément les acres en hectares pour l'immobilier international, l'agriculture et la mesure de terrain.",
        "shortDescription": "Convertissez les acres en hectares pour l'immobilier international, l'agriculture et les propriétés",
        "keywords": [
          "acres vers hectares",
          "acres vers ha",
          "convertisseur terrain",
          "conversion superficie agricole",
          "hectares propriété",
          "calculateur acre hectare"
        ]
      },
      "inputs": {
        "amount": {
      ...
      "infoCards": {
        ...
        "tips": {
          ...
          "items": [
            "Estimation rapide : 1 acre ≈ 0,405 hectares",
      ...
      "education": {
        "whatIs": {
          ...
          "content": "Convertissez instantanément les acres en hectares pour l'immobilier international, l'agriculture et la mesure de terrain. Ce convertisseur prend en charge toutes les unités liées dans la catégorie superficie, vous permettant de convertir entre n'importe quelle combinaison avec une seule saisie."
        },
        "howItWorks": {
        ...
        "considerations": {
          ...
          "items": [
            {
              "text": "Estimation rapide : 1 acre ≈ 0,405 hectares",
              "type": "info"
            },
            {
      ...
      "faqs": [
        ...
        },
        {
          ...
          "answer": "Ce convertisseur supporte toutes les unités dans la catégorie superficie : acres, hectares, m2, km2, ft2, yd2. Sélectionnez n'importe laquelle dans le menu déroulant."
        },
        {
    ...
    de: {
      "name": "Acres zu Hektar Umrechner",
      "slug": "acres-zu-hektar-umrechner",
      "subtitle": "Wandeln Sie Acres in Hektar um für internationale Immobilien, Landwirtschaft und Grundstücksmessungen.",
      "breadcrumb": "Acres zu Hektar",
      "seo": {
        "title": "Acres zu Hektar Umrechner - Flächenumrechnung",
        "description": "Rechnen Sie Acres sofort in Hektar um für internationale Immobilien, Landwirtschaft und Landmessung.",
        "shortDescription": "Wandeln Sie Acres in Hektar um für internationale Immobilien, Landwirtschaft und Grundstücke",
        "keywords": [
          "acres zu hektar",
          "acres zu ha",
          "flächenumrechner",
          "landwirtschaftliche flächenumrechnung",
          "grundstück hektar",
          "acre hektar rechner"
        ]
      },
      ...
      "education": {
        "whatIs": {
          ...
          "content": "Rechnen Sie Acres sofort in Hektar um für internationale Immobilien, Landwirtschaft und Landmessung. Dieser Umrechner unterstützt alle verwandten Einheiten in der Flächenkategorie und ermöglicht die Umrechnung zwischen beliebigen Kombinationen mit einer einzigen Eingabe."
        },
        "howItWorks": {
          "title": "So funktioniert die Umrechnung",
          "content": "Geben Sie Ihren Wert ein und wählen Sie die Quelleinheit aus dem Dropdown-Menü. Der Umrechner zeigt sofort das Äquivalent in allen anderen Einheiten dieses Typs an. Alle Umrechnungen verwenden präzise Faktoren internationaler Standards (NIST/BIPM)."
        },
        "considerations": {
          "title": "Wichtige Hinweise",
          "items": [
            {
              "text": "Schnelle Schätzung: 1 Acre ≈ 0,405 Hektar",
              "type": "info"
            },
            {
        ...
        "commonValues": {
          ...
          "items": [
            ...
            {
              "text": "Alle Ergebnisse aktualisieren sich in Echtzeit während der Eingabe.",
              "type": "info"
            },
            {
      ...
      "faqs": [
        ...
        },
        {
          ...
          "answer": "Dieser Umrechner unterstützt alle Einheiten in der Flächenkategorie: Acres, Hektar, m², km², ft², yd². Wählen Sie eine beliebige aus dem Dropdown-Menü."
        },
        {
...
export function calculateAcresToHectares(data: {
  ...
  const fromUnit = fieldUnits.amount || "acres";
  ...
  const allUnits = ["acres", "hectares", "m2", "km2", "ft2", "yd2"];
...
export default acresToHectaresConfig;
