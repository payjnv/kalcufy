...
export const tablespoonsToCupsConfig: CalculatorConfigV4 = {
  ...
  presets: [
    ...
    { id: "sixteen", icon: "☕", values: { amount: 16 } },
  ],
  ...
  t: {
    en: {
      ...
      breadcrumb: "Tablespoons to Cups",

      seo: {
        title: "Tablespoons to Cups Converter - Kitchen Measurement",
        description: "Convert tablespoons to cups for cooking and baking. 16 tablespoons = 1 cup. Includes teaspoons and milliliters.",
        shortDescription: "Convert tablespoons to cups, teaspoons, and milliliters for kitchen measurements",
      ...
      presets: {
        four: { label: "🥄 4 tbsp", description: "4 tbsp (¼ cup)" },
        eight: { label: "🥛 8 tbsp", description: "8 tbsp (½ cup)" },
        sixteen: { label: "☕ 16 tbsp", description: "16 tbsp (1 cup)" },
      },
      ...
      infoCards: {
        ...
        tips: {
          ...
          items: [
            "16 tablespoons = 1 cup | 1 tablespoon = 3 teaspoons",
      ...
      education: {
        whatIs: {
          ...
          content: "Convert tablespoons to cups for cooking and baking. 16 tablespoons = 1 cup. Includes teaspoons and milliliters. This converter supports all related units in the cooking_volume category, letting you convert between any combination with a single input.",
        },
        howItWorks: {
        ...
        considerations: {
          ...
          items: [
            { text: "16 tablespoons = 1 cup | 1 tablespoon = 3 teaspoons", type: "info" },
      ...
      faqs: [
        ...
        { question: "What units are supported?", answer: "This converter supports all units in the cooking_volume category: tbsp, cups, tsp, mL, fl_oz, L. Select any from the dropdown." },
    ...
    es: {
      "name": "Convertidor de Cucharadas a Tazas",
      "slug": "calculadora-cucharadas-a-tazas",
      "subtitle": "Convierte cucharadas a tazas, cucharaditas y mililitros para medidas de cocina.",
      "breadcrumb": "Cucharadas a Tazas",
      "seo": {
        "title": "Convertidor de Cucharadas a Tazas - Medidas de Cocina",
        "description": "Convierte cucharadas a tazas para cocinar y hornear. 16 cucharadas = 1 taza. Incluye cucharaditas y mililitros.",
        "shortDescription": "Convierte cucharadas a tazas, cucharaditas y mililitros para medidas de cocina",
        "keywords": [
          "cucharadas a tazas",
          "cdas a tazas",
          "cuántas cucharadas en una taza",
          "medidas de cocina",
          "conversión para hornear",
      ...
      "presets": {
        "four": {
          "label": "🥄 4 cdas",
          "description": "4 cdas (¼ taza)"
        },
        "eight": {
          "label": "🥛 8 cdas",
          "description": "8 cdas (½ taza)"
        },
        "sixteen": {
          "label": "☕ 16 cdas",
          "description": "16 cdas (1 taza)"
        }
      },
      "values": {},
      "formats": {
      ...
      "infoCards": {
        ...
        "tips": {
          ...
          "items": [
            "16 cucharadas = 1 taza | 1 cucharada = 3 cucharaditas",
      ...
      "education": {
        "whatIs": {
          ...
          "content": "Convierte cucharadas a tazas para cocinar y hornear. 16 cucharadas = 1 taza. Incluye cucharaditas y mililitros. Este convertidor admite todas las unidades relacionadas en la categoría volumen_cocina, permitiéndote convertir entre cualquier combinación con una sola entrada."
        },
        "howItWorks": {
        ...
        "considerations": {
          ...
          "items": [
            {
              "text": "16 cucharadas = 1 taza | 1 cucharada = 3 cucharaditas",
              "type": "info"
            },
            {
        ...
        "commonValues": {
          ...
          "items": [
            ...
            {
              "text": "Admite todas las unidades del grupo volumen_cocina.",
              "type": "info"
            }
          ]
        },
      ...
      "faqs": [
        ...
        {
          "question": "¿Puedo convertir en la dirección opuesta?",
        ...
        },
        {
          ...
          "answer": "Este convertidor admite todas las unidades de la categoría volumen_cocina: cdas, tazas, cditas, mL, oz líq, L. Selecciona cualquiera del menú desplegable."
        },
        {
          "question": "¿Esto funciona en móvil?",
          "answer": "Sí, este convertidor es completamente adaptable y funciona en cualquier dispositivo — teléfono, tableta o escritorio."
        },
        {
    ...
    pt: {
      "name": "Conversor de Colheres de Sopa para Xícaras",
      "slug": "calculadora-colheres-sopa-para-xicaras",
      "subtitle": "Converta colheres de sopa para xícaras, colheres de chá e mililitros para medidas culinárias.",
      "breadcrumb": "Colheres de Sopa para Xícaras",
      "seo": {
        "title": "Conversor de Colheres de Sopa para Xícaras - Medidas Culinárias",
        "description": "Converta colheres de sopa para xícaras para cozinhar e assar. 16 colheres de sopa = 1 xícara. Inclui colheres de chá e mililitros.",
        "shortDescription": "Converta colheres de sopa para xícaras, colheres de chá e mililitros para medidas culinárias",
        "keywords": [
          "colheres de sopa para xícaras",
          "colher de sopa para xícara",
          "quantas colheres de sopa em uma xícara",
          "medida culinária",
          "conversão para assar",
          "conversor de cozinha"
        ]
      },
      "inputs": {
        "amount": {
      ...
      "presets": {
        "four": {
          "label": "🥄 4 col. sopa",
          "description": "4 col. sopa (¼ xícara)"
        },
        "eight": {
          "label": "🥛 8 col. sopa",
          "description": "8 col. sopa (½ xícara)"
        },
        "sixteen": {
          "label": "☕ 16 col. sopa",
          "description": "16 col. sopa (1 xícara)"
        }
      },
      "values": {},
      "formats": {
      ...
      "infoCards": {
        ...
        "tips": {
          ...
          "items": [
            "16 colheres de sopa = 1 xícara | 1 colher de sopa = 3 colheres de chá",
            "Selecione qualquer unidade do menu suspenso para converter dessa unidade.",
            "Os resultados se atualizam instantaneamente conforme você digita.",
      ...
      "education": {
        "whatIs": {
          ...
          "content": "Converta colheres de sopa para xícaras para cozinhar e assar. 16 colheres de sopa = 1 xícara. Inclui colheres de chá e mililitros. Este conversor suporta todas as unidades relacionadas na categoria volume_culinario, permitindo converter entre qualquer combinação com uma única entrada."
        },
        "howItWorks": {
        ...
        "considerations": {
          ...
          "items": [
            {
              "text": "16 colheres de sopa = 1 xícara | 1 colher de sopa = 3 colheres de chá",
              "type": "info"
            },
            {
        ...
        "commonValues": {
          ...
          "items": [
            ...
            {
              "text": "Todos os resultados se atualizam em tempo real conforme você digita.",
              "type": "info"
            },
            {
            ...
            {
              "text": "Suporta todas as unidades do grupo volume_culinario.",
              "type": "info"
            }
          ]
        },
      ...
      "faqs": [
        ...
        },
        {
          ...
          "answer": "Este conversor suporta todas as unidades na categoria volume_culinario: col. sopa, xícaras, col. chá, mL, fl_oz, L. Selecione qualquer uma no menu suspenso."
        },
        {
    ...
    fr: {
      "name": "Convertisseur Cuillères à Soupe vers Tasses",
      "slug": "calculateur-cuilleres-soupe-vers-tasses",
      "subtitle": "Convertissez les cuillères à soupe en tasses, cuillères à café et millilitres pour les mesures de cuisine.",
      "breadcrumb": "Cuillères à Soupe vers Tasses",
      "seo": {
        "title": "Convertisseur Cuillères à Soupe vers Tasses - Mesure Culinaire",
        "description": "Convertissez les cuillères à soupe en tasses pour la cuisine et la pâtisserie. 16 cuillères à soupe = 1 tasse. Inclut les cuillères à café et millilitres.",
        "shortDescription": "Convertissez les cuillères à soupe en tasses, cuillères à café et millilitres pour les mesures de cuisine",
        "keywords": [
          "cuillères à soupe vers tasses",
          "c. à soupe vers tasses",
      ...
      "presets": {
        "four": {
          "label": "🥄 4 c. à soupe",
          "description": "4 c. à soupe (¼ tasse)"
        },
        "eight": {
          "label": "🥛 8 c. à soupe",
          "description": "8 c. à soupe (½ tasse)"
        },
        "sixteen": {
          "label": "☕ 16 c. à soupe",
          "description": "16 c. à soupe (1 tasse)"
        }
      },
      "values": {},
      "formats": {
      ...
      "infoCards": {
        ...
        "tips": {
          ...
          "items": [
            "16 cuillères à soupe = 1 tasse | 1 cuillère à soupe = 3 cuillères à café",
      ...
      "education": {
        "whatIs": {
          ...
          "content": "Convertissez les cuillères à soupe en tasses pour la cuisine et la pâtisserie. 16 cuillères à soupe = 1 tasse. Inclut les cuillères à café et millilitres. Ce convertisseur prend en charge toutes les unités connexes de la catégorie volume_culinaire, vous permettant de convertir entre toute combinaison avec une seule saisie."
        },
        "howItWorks": {
        ...
        "considerations": {
          ...
          "items": [
            {
              "text": "16 cuillères à soupe = 1 tasse | 1 cuillère à soupe = 3 cuillères à café",
              "type": "info"
            },
            {
        ...
        "commonValues": {
          ...
          "items": [
            ...
            {
              "text": "Prend en charge toutes les unités du groupe volume_culinaire.",
              "type": "info"
            }
          ]
        },
      ...
      "faqs": [
        ...
        },
        {
          ...
          "answer": "Ce convertisseur prend en charge toutes les unités de la catégorie volume_culinaire : c. à soupe, tasses, c. à café, mL, fl oz, L. Sélectionnez n'importe laquelle dans la liste déroulante."
        },
        {
    ...
    de: {
      "name": "Esslöffel zu Tassen Umrechner",
      "slug": "essloeffel-zu-tassen-rechner",
      "subtitle": "Rechnen Sie Esslöffel in Tassen, Teelöffel und Milliliter für Küchenmessungen um.",
      "breadcrumb": "Esslöffel zu Tassen",
      "seo": {
        "title": "Esslöffel zu Tassen Umrechner - Küchenmessungen",
        "description": "Rechnen Sie Esslöffel in Tassen zum Kochen und Backen um. 16 Esslöffel = 1 Tasse. Enthält Teelöffel und Milliliter.",
        "shortDescription": "Rechnen Sie Esslöffel in Tassen, Teelöffel und Milliliter für Küchenmessungen um",
        "keywords": [
          "Esslöffel zu Tassen",
          "EL zu Tassen",
          "wie viele Esslöffel in einer Tasse",
          "Kochmessungen",
          "Backumrechnung",
          "Küchenumrechner"
        ]
      ...
      "presets": {
        "four": {
          "label": "🥄 4 EL",
          "description": "4 EL (¼ Tasse)"
        },
        "eight": {
          "label": "🥛 8 EL",
          "description": "8 EL (½ Tasse)"
        },
        "sixteen": {
          "label": "☕ 16 EL",
          "description": "16 EL (1 Tasse)"
        }
      },
      "values": {},
      "formats": {
      ...
      "infoCards": {
        ...
        "tips": {
          ...
          "items": [
            "16 Esslöffel = 1 Tasse | 1 Esslöffel = 3 Teelöffel",
      ...
      "education": {
        "whatIs": {
          ...
          "content": "Rechnen Sie Esslöffel in Tassen zum Kochen und Backen um. 16 Esslöffel = 1 Tasse. Enthält Teelöffel und Milliliter. Dieser Umrechner unterstützt alle verwandten Einheiten in der Kategorie Kochvolumen und ermöglicht es Ihnen, zwischen beliebigen Kombinationen mit einer einzigen Eingabe umzurechnen."
        },
        "howItWorks": {
        ...
        "considerations": {
          ...
          "items": [
            {
              "text": "16 Esslöffel = 1 Tasse | 1 Esslöffel = 3 Teelöffel",
              "type": "info"
            },
            {
            ...
            {
              "text": "Bei sehr großen oder kleinen Zahlen kann die wissenschaftliche Notation verwendet werden.",
              "type": "info"
            },
            {
      ...
      "faqs": [
        ...
        },
        {
          ...
          "answer": "Dieser Umrechner unterstützt alle Einheiten in der Kochvolumen-Kategorie: EL, Tassen, TL, mL, fl_oz, L. Wählen Sie eine beliebige aus dem Dropdown-Menü."
        },
        {
...
export function calculateTablespoonsToCups(data: {
  ...
  const fromUnit = fieldUnits.amount || "tbsp";
  ...
  const allUnits = ["tbsp", "cups", "tsp", "mL", "fl_oz", "L"];
...
export default tablespoonsToCupsConfig;
