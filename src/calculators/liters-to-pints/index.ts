...
export const litersToPintsConfig: CalculatorConfigV4 = {
  id: "liters-to-pints",
  version: "4.0",
  category: "conversion",
  icon: "🍺",
  ...
  presets: [
    { id: "halfLiter", icon: "🥤", values: { amount: 0.5 } },
    { id: "oneLiter", icon: "🍺", values: { amount: 1 } },
    { id: "threeLiters", icon: "🫗", values: { amount: 3 } },
  ],

  t: {
    en: {
      name: "Liters to Pints Converter",
      slug: "liters-to-pints",
      subtitle: "Convert liters to US and UK pints for beverages, cooking, and everyday use.",
      breadcrumb: "Liters to Pints",

      seo: {
        title: "Liters to Pints Converter - Volume Conversion Tool",
        description: "Convert liters to pints instantly. Supports both US and UK pints for beverages, cooking, and everyday measurements.",
        shortDescription: "Convert liters to US and UK pints for beverages, cooking, and everyday use.",
      ...
      presets: {
        halfLiter: { label: "🥤 0.5 L", description: "0.5 L (1.06 pt)" },
        oneLiter: { label: "🍺 1 L", description: "1 L (2.11 pt)" },
        threeLiters: { label: "🫗 3 L", description: "3 L (6.34 pt)" },
      },
      ...
      infoCards: {
        ...
        tips: {
          ...
          items: [
            "Quick estimate: 1 liter ≈ 2.11 US pints",
      ...
      education: {
        whatIs: {
          ...
          content: "Convert liters to pints instantly. Supports both US and UK pints for beverages, cooking, and everyday measurements. This converter supports all related units in the volume category, letting you convert between any combination with a single input.",
        },
        howItWorks: {
        ...
        considerations: {
          ...
          items: [
            { text: "Quick estimate: 1 liter ≈ 2.11 US pints", type: "info" },
      ...
      faqs: [
        ...
        { question: "What units are supported?", answer: "This converter supports all units in the volume category: L, pt_us, gal_us, fl_oz, mL, cups. Select any from the dropdown." },
    ...
    es: {
      "name": "Convertidor de Litros a Pintas",
      "slug": "calculadora-litros-a-pintas",
      "subtitle": "Convierte litros a pintas estadounidenses y británicas para bebidas, cocina y uso cotidiano.",
      "breadcrumb": "Litros a Pintas",
      "seo": {
        "title": "Convertidor de Litros a Pintas - Herramienta de Conversión de Volumen",
        "description": "Convierte litros a pintas al instante. Compatible con pintas estadounidenses y británicas para bebidas, cocina y medidas cotidianas.",
        "shortDescription": "Convierte litros a pintas estadounidenses y británicas para bebidas, cocina y uso cotidiano.",
        "keywords": [
          "litros a pintas",
          "L a pintas",
          "métrico a pintas",
          "convertidor pinta cerveza",
          "conversión litros pintas",
          "convertidor volumen"
        ]
      },
      "inputs": {
      ...
      "presets": {
        "halfLiter": {
          "label": "🥤 0.5 L",
          "description": "0.5 L (1.06 pt)"
        },
        "oneLiter": {
          "label": "🍺 1 L",
          "description": "1 L (2.11 pt)"
        },
        "threeLiters": {
          "label": "🫗 3 L",
          "description": "3 L (6.34 pt)"
        }
      },
      "values": {},
      "formats": {
      ...
      "infoCards": {
        ...
        "tips": {
          ...
          "items": [
            "Estimación rápida: 1 litro ≈ 2.11 pintas estadounidenses",
      ...
      "education": {
        "whatIs": {
          ...
          "content": "Convierte litros a pintas al instante. Compatible con pintas estadounidenses y británicas para bebidas, cocina y medidas cotidianas. Este convertidor admite todas las unidades relacionadas en la categoría de volumen, permitiéndote convertir entre cualquier combinación con una sola entrada."
        },
        "howItWorks": {
        ...
        "considerations": {
          ...
          "items": [
            {
              "text": "Estimación rápida: 1 litro ≈ 2.11 pintas estadounidenses",
              "type": "info"
            },
            {
      ...
      "faqs": [
        ...
        },
        {
          ...
          "answer": "Este convertidor admite todas las unidades en la categoría de volumen: L, pt_us, gal_us, fl_oz, mL, tazas. Selecciona cualquiera del menú desplegable."
        },
        {
    ...
    pt: {
      "name": "Conversor de Litros para Pints",
      "slug": "calculadora-litros-para-pints",
      "subtitle": "Converta litros para pints americanos e britânicos para bebidas, culinária e uso cotidiano.",
      "breadcrumb": "Litros para Pints",
      "seo": {
        "title": "Conversor de Litros para Pints - Ferramenta de Conversão de Volume",
        "description": "Converta litros para pints instantaneamente. Suporta pints americanos e britânicos para bebidas, culinária e medições do dia a dia.",
        "shortDescription": "Converta litros para pints americanos e britânicos para bebidas, culinária e uso cotidiano.",
        "keywords": [
          "litros para pints",
          "L para pints",
          "métrico para pints",
          "conversor pint cerveja",
          "conversão litros pints",
          "conversor volume"
        ]
      },
      "inputs": {
      ...
      "infoCards": {
        ...
        "tips": {
          ...
          "items": [
            "Estimativa rápida: 1 litro ≈ 2,11 pints americanos",
      ...
      "education": {
        "whatIs": {
          ...
          "content": "Converta litros para pints instantaneamente. Suporta pints americanos e britânicos para bebidas, culinária e medições do dia a dia. Este conversor suporta todas as unidades relacionadas na categoria de volume, permitindo converter entre qualquer combinação com uma única entrada."
        },
        "howItWorks": {
        ...
        "considerations": {
          ...
          "items": [
            {
              "text": "Estimativa rápida: 1 litro ≈ 2,11 pints americanos",
              "type": "info"
            },
            {
      ...
      "faqs": [
        ...
        },
        {
          ...
          "answer": "Este conversor suporta todas as unidades na categoria de volume: L, pt_us, gal_us, fl_oz, mL, xícaras. Selecione qualquer uma no menu suspenso."
        },
        {
    ...
    fr: {
      "name": "Convertisseur Litres vers Pintes",
      "slug": "calculateur-litres-vers-pintes",
      "subtitle": "Convertissez les litres en pintes américaines et britanniques pour les boissons, la cuisine et l'usage quotidien.",
      "breadcrumb": "Litres vers Pintes",
      "seo": {
        "title": "Convertisseur Litres vers Pintes - Outil de Conversion de Volume",
        "description": "Convertissez les litres en pintes instantanément. Prend en charge les pintes américaines et britanniques pour les boissons, la cuisine et les mesures quotidiennes.",
        "shortDescription": "Convertissez les litres en pintes américaines et britanniques pour les boissons, la cuisine et l'usage quotidien.",
        "keywords": [
          "litres vers pintes",
          "L vers pintes",
          "métrique vers pintes",
          "convertisseur pinte bière",
          "conversion litres pintes",
      ...
      "infoCards": {
        ...
        "tips": {
          ...
          "items": [
            "Estimation rapide : 1 litre ≈ 2,11 pintes américaines",
      ...
      "education": {
        "whatIs": {
          ...
          "content": "Convertissez les litres en pintes instantanément. Prend en charge les pintes américaines et britanniques pour les boissons, la cuisine et les mesures quotidiennes. Ce convertisseur prend en charge toutes les unités connexes dans la catégorie volume, vous permettant de convertir entre n'importe quelle combinaison avec une seule saisie."
        },
        "howItWorks": {
        ...
        "considerations": {
          ...
          "items": [
            {
              "text": "Estimation rapide : 1 litre ≈ 2,11 pintes américaines",
              "type": "info"
            },
            {
      ...
      "faqs": [
        ...
        },
        {
          ...
          "answer": "Ce convertisseur prend en charge toutes les unités de la catégorie volume : L, pt_us, gal_us, fl_oz, mL, tasses. Sélectionnez n'importe laquelle dans le menu déroulant."
        },
        {
    ...
    de: {
      "name": "Liter zu Pints Umrechner",
      "slug": "liter-zu-pints-rechner",
      "subtitle": "Liter in US- und UK-Pints für Getränke, Kochen und den täglichen Gebrauch umrechnen.",
      "breadcrumb": "Liter zu Pints",
      "seo": {
        "title": "Liter zu Pints Umrechner - Volumen Umrechnungstool",
        "description": "Liter sofort in Pints umrechnen. Unterstützt sowohl US- als auch UK-Pints für Getränke, Kochen und alltägliche Messungen.",
        "shortDescription": "Liter in US- und UK-Pints für Getränke, Kochen und den täglichen Gebrauch umrechnen.",
        "keywords": [
          "liter zu pints",
          "L zu pints",
          "metrisch zu pints",
          "bier pint umrechner",
          "liter pints umrechnung",
          "volumen umrechner"
        ]
      },
      "inputs": {
      ...
      "infoCards": {
        ...
        "tips": {
          ...
          "items": [
            "Schnelle Schätzung: 1 Liter ≈ 2,11 US-Pints",
      ...
      "education": {
        "whatIs": {
          ...
          "content": "Rechnen Sie Liter sofort in Pints um. Unterstützt sowohl US- als auch UK-Pints für Getränke, Kochen und alltägliche Messungen. Dieser Umrechner unterstützt alle verwandten Einheiten in der Volumenkategorie und ermöglicht es Ihnen, mit einer einzigen Eingabe zwischen beliebigen Kombinationen umzurechnen."
        },
        "howItWorks": {
        ...
        "considerations": {
          ...
          "items": [
            {
              "text": "Schnelle Schätzung: 1 Liter ≈ 2,11 US-Pints",
              "type": "info"
            },
            {
        ...
        "commonValues": {
          ...
          "items": [
            ...
            {
              "text": "Teilen Sie Ergebnisse über den Teilen-Button unten.",
              "type": "info"
            },
            {
      ...
      "faqs": [
        ...
        },
        {
          ...
          "answer": "Dieser Umrechner unterstützt alle Einheiten in der Volumenkategorie: L, pt_us, gal_us, fl_oz, mL, Tassen. Wählen Sie eine beliebige aus dem Dropdown-Menü."
        },
        {
...
export function calculateLitersToPints(data: {
  ...
  const allUnits = ["L", "pt_us", "gal_us", "fl_oz", "mL", "cups"];
...
export default litersToPintsConfig;
