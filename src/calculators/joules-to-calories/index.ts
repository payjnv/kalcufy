...
export const joulesToCaloriesConfig: CalculatorConfigV4 = {
  ...
  presets: [
    ...
    { id: "fourThousand", icon: "🍎", values: { amount: 4184 } },
    { id: "million", icon: "⚡", values: { amount: 1000000 } },
  ],
  ...
  t: {
    en: {
      ...
      breadcrumb: "Joules to Calories",

      seo: {
        title: "Joules to Calories Converter - Energy Conversion Tool",
        description: "Convert joules to calories for physics, chemistry, and nutrition. 1 calorie = 4.184 joules.",
        shortDescription: "Convert joules to calories for physics, chemistry, nutrition, and energy calcula",
      ...
      presets: {
        thousand: { label: "🔬 1,000 J", description: "1,000 J (239 cal)" },
        fourThousand: { label: "🍎 4,184 J", description: "4,184 J (1 kcal)" },
        million: { label: "⚡ 1 MJ", description: "1 MJ (239 kcal)" },
      },
      ...
      infoCards: {
        ...
        tips: {
          ...
          items: [
            "1 calorie = 4.184 joules | 1 food Calorie (kcal) = 4,184 J",
      ...
      education: {
        whatIs: {
          ...
          content: "Convert joules to calories for physics, chemistry, and nutrition. 1 calorie = 4.184 joules. This converter supports all related units in the energy category, letting you convert between any combination with a single input.",
        },
        howItWorks: {
        ...
        considerations: {
          ...
          items: [
            { text: "1 calorie = 4.184 joules | 1 food Calorie (kcal) = 4,184 J", type: "info" },
      ...
      faqs: [
        ...
        { question: "What units are supported?", answer: "This converter supports all units in the energy category: J, cal, kcal, kJ, BTU, Wh, eV. Select any from the dropdown." },
    ...
    es: {
      "name": "Convertidor de Julios a Calorías",
      "slug": "calculadora-convertidor-julios-calorias",
      "subtitle": "Convierte julios a calorías para cálculos de física, química, nutrición y energía.",
      "breadcrumb": "Julios a Calorías",
      "seo": {
        "title": "Convertidor de Julios a Calorías - Herramienta de Conversión de Energía",
        "description": "Convierte julios a calorías para física, química y nutrición. 1 caloría = 4.184 julios.",
        "shortDescription": "Convierte julios a calorías para cálculos de física, química, nutrición y energía",
        "keywords": [
          "julios a calorías",
          "J a cal",
          "convertidor de energía",
          "convertidor de física",
          "energía química",
          "julios calorías nutrición"
        ]
      },
      "calculator": {
      ...
      "presets": {
        "thousand": {
          "label": "🔬 1,000 J",
          "description": "1,000 J (239 cal)"
        },
        "fourThousand": {
          "label": "🍎 4,184 J",
          "description": "4,184 J (1 kcal)"
        },
        "million": {
          "label": "⚡ 1 MJ",
          "description": "1 MJ (239 kcal)"
        }
      },
      "values": {},
      "formats": {
      ...
      "infoCards": {
        ...
        "tips": {
          ...
          "items": [
            "1 caloría = 4.184 julios | 1 Caloría alimentaria (kcal) = 4,184 J",
      ...
      "education": {
        "whatIs": {
          ...
          "content": "Convierte julios a calorías para física, química y nutrición. 1 caloría = 4.184 julios. Este convertidor soporta todas las unidades relacionadas en la categoría de energía, permitiéndote convertir entre cualquier combinación con una sola entrada."
        },
        "howItWorks": {
        ...
        "considerations": {
          ...
          "items": [
            {
              "text": "1 caloría = 4.184 julios | 1 Caloría alimentaria (kcal) = 4,184 J",
              "type": "info"
            },
            {
        ...
        "commonValues": {
          ...
          "items": [
            ...
            {
              "text": "Soporta todas las unidades del grupo de energía.",
              "type": "info"
            }
          ]
        },
      ...
      "faqs": [
        ...
        },
        {
          ...
          "answer": "Este convertidor soporta todas las unidades en la categoría de energía: J, cal, kcal, kJ, BTU, Wh, eV. Selecciona cualquiera del menú desplegable."
        },
        {
    ...
    pt: {
      "name": "Conversor de Joules para Calorias",
      "slug": "calculadora-joules-para-calorias",
      "subtitle": "Converta joules para calorias em física, química, nutrição e cálculos de energia.",
      "breadcrumb": "Joules para Calorias",
      "seo": {
        "title": "Conversor de Joules para Calorias - Ferramenta de Conversão de Energia",
        "description": "Converta joules para calorias em física, química e nutrição. 1 caloria = 4,184 joules.",
        "shortDescription": "Converta joules para calorias em física, química, nutrição e cálculos de energia",
        "keywords": [
      ...
      "inputs": {
        "amount": {
          "label": "Energia",
          "helpText": "Insira a energia para converter"
        }
      },
      "results": {
        "primary": {
      ...
      "infoCards": {
        ...
        "tips": {
          ...
          "items": [
            "1 caloria = 4,184 joules | 1 Caloria alimentar (kcal) = 4.184 J",
      ...
      "education": {
        "whatIs": {
          ...
          "content": "Converta joules para calorias em física, química e nutrição. 1 caloria = 4,184 joules. Este conversor suporta todas as unidades relacionadas na categoria de energia, permitindo converter entre qualquer combinação com uma única entrada."
        },
        "howItWorks": {
        ...
        "considerations": {
          ...
          "items": [
            {
              "text": "1 caloria = 4,184 joules | 1 Caloria alimentar (kcal) = 4.184 J",
              "type": "info"
            },
            {
        ...
        "commonValues": {
          ...
          "items": [
            ...
            {
              "text": "Suporta todas as unidades no grupo de energia.",
              "type": "info"
            }
          ]
        },
      ...
      "faqs": [
        ...
        },
        {
          ...
          "answer": "Este conversor suporta todas as unidades na categoria de energia: J, cal, kcal, kJ, BTU, Wh, eV. Selecione qualquer uma do menu suspenso."
        },
        {
    ...
    fr: {
      "name": "Convertisseur Joules vers Calories",
      "slug": "calculateur-joules-vers-calories",
      "subtitle": "Convertissez les joules en calories pour les calculs de physique, chimie, nutrition et énergie.",
      "breadcrumb": "Joules vers Calories",
      "seo": {
        "title": "Convertisseur Joules vers Calories - Outil de Conversion d'Énergie",
        "description": "Convertissez les joules en calories pour la physique, chimie et nutrition. 1 calorie = 4,184 joules.",
        "shortDescription": "Convertissez les joules en calories pour les calculs de physique, chimie, nutrition et énergie",
        "keywords": [
          "joules vers calories",
          "J vers cal",
          "convertisseur énergie",
          "convertisseur physique",
          "énergie chimie",
          "nutrition joules calories"
        ]
      },
      "calculator": {
      ...
      "infoCards": {
        ...
        "tips": {
          ...
          "items": [
            "1 calorie = 4,184 joules | 1 Calorie alimentaire (kcal) = 4 184 J",
      ...
      "education": {
        "whatIs": {
          ...
          "content": "Convertissez les joules en calories pour la physique, chimie et nutrition. 1 calorie = 4,184 joules. Ce convertisseur prend en charge toutes les unités liées dans la catégorie énergie, vous permettant de convertir entre n'importe quelle combinaison avec une seule saisie."
        },
        "howItWorks": {
        ...
        "considerations": {
          ...
          "items": [
            {
              "text": "1 calorie = 4,184 joules | 1 Calorie alimentaire (kcal) = 4 184 J",
              "type": "info"
            },
            {
      ...
      "faqs": [
        ...
        },
        {
          ...
          "answer": "Ce convertisseur prend en charge toutes les unités de la catégorie énergie : J, cal, kcal, kJ, BTU, Wh, eV. Sélectionnez n'importe laquelle dans le menu déroulant."
        },
        {
    ...
    de: {
      "name": "Joule zu Kalorien Umrechner",
      "slug": "joule-zu-kalorien-umrechner",
      "subtitle": "Konvertieren Sie Joule in Kalorien für Physik-, Chemie-, Ernährungs- und Energieberechnungen.",
      "breadcrumb": "Joule zu Kalorien",
      "seo": {
        "title": "Joule zu Kalorien Umrechner - Energie-Umrechnungstool",
        "description": "Konvertieren Sie Joule in Kalorien für Physik, Chemie und Ernährung. 1 Kalorie = 4,184 Joule.",
        "shortDescription": "Konvertieren Sie Joule in Kalorien für Physik-, Chemie-, Ernährungs- und Energieberechn",
        "keywords": [
          "Joule zu Kalorien",
          "J zu cal",
          "Energieumrechner",
      ...
      "inputs": {
        "amount": {
          "label": "Energie",
          "helpText": "Geben Sie die zu konvertierende Energie ein"
        }
      },
      "results": {
        "primary": {
      ...
      "infoCards": {
        ...
        "tips": {
          ...
          "items": [
            "1 Kalorie = 4,184 Joule | 1 Nahrungskalorie (kcal) = 4.184 J",
      ...
      "education": {
        "whatIs": {
          ...
          "content": "Konvertieren Sie Joule in Kalorien für Physik, Chemie und Ernährung. 1 Kalorie = 4,184 Joule. Dieser Umrechner unterstützt alle verwandten Einheiten in der Energiekategorie und ermöglicht es Ihnen, zwischen beliebigen Kombinationen mit einer einzigen Eingabe umzurechnen."
        },
        "howItWorks": {
        ...
        "considerations": {
          ...
          "items": [
            {
              "text": "1 Kalorie = 4,184 Joule | 1 Nahrungskalorie (kcal) = 4.184 J",
              "type": "info"
            },
            {
      ...
      "faqs": [
        {
          ...
          "answer": "Alle Umrechnungen verwenden exakte Faktoren aus den internationalen Standards NIST und BIPM. Ergebnisse sind auf mindestens 6 signifikante Stellen genau."
        },
        {
        ...
        },
        {
          ...
          "answer": "Dieser Umrechner unterstützt alle Einheiten in der Energiekategorie: J, cal, kcal, kJ, BTU, Wh, eV. Wählen Sie eine beliebige aus dem Dropdown-Menü."
        },
        {
...
export function calculateJoulesToCalories(data: {
  ...
  const fromUnit = fieldUnits.amount || "J";
  ...
  const allUnits = ["J", "cal", "kcal", "kJ", "BTU", "Wh", "eV"];
...
export default joulesToCaloriesConfig;
