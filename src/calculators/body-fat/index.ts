...
export const bodyFatConfig: CalculatorConfigV4 = {
    ...
    en: {
      ...
      inputs: {
        method: {
          ...
          helpText: "Each method uses different measurements — inputs adjust automatically",
          options: {
            navy: "🎖️ U.S. Navy",
            bmi: "⚖️ BMI Method",
            cunbae: "🔬 CUN-BAE",
            bai: "📏 BAI (No Scale)",
            rfm: "📐 RFM (Height + Waist)",
          },
        },
        gender: {
          label: "Gender",
          helpText: "Body fat formulas differ significantly by gender",
          options: { male: "Male", female: "Female" },
        },
        age: {
          label: "Age",
          helpText: "Used by BMI and CUN-BAE methods for age-adjusted estimates",
        },
        weight: {
          label: "Weight",
          helpText: "Required for Navy, BMI, CUN-BAE, and RFM methods",
        },
        height: {
          label: "Height",
          helpText: "Required for all methods",
        },
        waist: {
          label: "Waist Circumference",
          helpText: "Navy: at navel level for men, narrowest point for women. RFM: at navel.",
        },
        neck: {
          label: "Neck Circumference",
          helpText: "Measure just below the larynx (Adam's apple), tape sloping slightly downward",
        },
        hip: {
          label: "Hip Circumference",
          helpText: "Measure at the widest part of the buttocks, tape horizontal",
        },
      },
      ...
      presets: {
        ...
        noScale: { label: "No Scale Needed", description: "BAI: only hip + height" },
      },
      ...
      referenceData: {
        categories: {
          ...
          items: {
            ...
            average: { label: "Average", value: "18-24% ♂ | 25-31% ♀" },
  ...
  inputs: [
    ...
    },
    {
      ...
      max: 80,
      suffix: "years",
      showWhen: { field: "method", value: ["bmi", "cunbae"] },
    },
    // ─── WEIGHT (with unitType dropdown) ───
    {
      id: "weight",
      type: "number",
      defaultValue: null,
      ...
      min: 80,
      max: 500,
      showWhen: { field: "method", value: ["navy", "bmi", "cunbae"] },
    },
    // ─── HEIGHT (with unitType dropdown) ───
    {
      id: "height",
      type: "number",
      defaultValue: null,
    ...
    // ─── WAIST (with unitType dropdown) ───
    {
      ...
      min: 20,
      max: 60,
      showWhen: { field: "method", value: ["navy", "rfm"] },
    },
    // ─── NECK (with unitType dropdown) ───
    {
      id: "neck",
      type: "number",
      defaultValue: null,
      ...
      min: 10,
      max: 24,
      showWhen: { field: "method", value: "navy" },
    },
    // ─── HIP (with unitType dropdown) ───
    {
      id: "hip",
      type: "number",
      defaultValue: null,
      ...
      max: 60,
      showWhen: [
        { field: "method", value: "navy", AND: { field: "gender", value: "female" } },
        { field: "method", value: "bai" },
      ],
    },
  ],
