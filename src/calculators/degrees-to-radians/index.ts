...
export const degreesToRadiansConfig: CalculatorConfigV4 = {
  ...
  presets: [
    { id: "right", icon: "📐", values: { amount: 90 } },
    { id: "straight", icon: "↔️", values: { amount: 180 } },
    { id: "full", icon: "🔄", values: { amount: 360 } },
  ],
  ...
  t: {
    en: {
      ...
      breadcrumb: "Degrees to Radians",

      seo: {
        title: "Degrees to Radians Converter - Angle Conversion Tool",
        description: "Convert degrees to radians and gradians instantly. Essential for math, physics, engineering, and programming.",
        shortDescription: "Convert degrees to radians and gradians for math, physics, and programming.",
      ...
      calculator: { yourInformation: "Enter Angle" },
      ui: { yourInformation: "Enter Angle", calculate: "Convert", reset: "Reset", results: "Results" },

      inputs: {
        amount: { label: "Angle", helpText: "Enter the angle to convert" },
      },
      ...
      presets: {
        right: { label: "📐 90°", description: "90° (π/2 rad)" },
        straight: { label: "↔️ 180°", description: "180° (π rad)" },
        full: { label: "🔄 360°", description: "360° (2π rad)" },
      },
      ...
      infoCards: {
        ...
        tips: {
          ...
          items: [
            "Key values: 90° = π/2, 180° = π, 360° = 2π",
      ...
      education: {
        whatIs: {
          ...
          content: "Convert degrees to radians and gradians instantly. Essential for math, physics, engineering, and programming. This converter supports all related units in the angle category, letting you convert between any combination with a single input.",
        },
        howItWorks: {
        ...
        considerations: {
          ...
          items: [
            { text: "Key values: 90° = π/2, 180° = π, 360° = 2π", type: "info" },
      ...
      faqs: [
        ...
        { question: "What units are supported?", answer: "This converter supports all units in the angle category: deg, rad, grad. Select any from the dropdown." },
    ...
    es: {
      "name": "Convertidor de Grados a Radianes",
      "slug": "calculadora-grados-radianes",
      "subtitle": "Convierte grados a radianes y gradianes para matemáticas, física y programación.",
      "breadcrumb": "Grados a Radianes",
      "seo": {
        "title": "Convertidor de Grados a Radianes - Herramienta de Conversión de Ángulos",
        "description": "Convierte grados a radianes y gradianes al instante. Esencial para matemáticas, física, ingeniería y programación.",
        "shortDescription": "Convierte grados a radianes y gradianes para matemáticas, física y programación.",
        "keywords": [
          "grados a radianes",
          "deg a rad",
          "convertidor de ángulos",
          "convertidor de trigonometría",
          "conversión de ángulos matemáticos",
          "calculadora grados radianes"
        ]
      },
      "inputs": {
        "amount": {
          "label": "Ángulo",
          "helpText": "Introduce el ángulo a convertir"
        }
      },
      "results": {
        "primary": {
      ...
      "presets": {
        "right": {
          "label": "📐 90°",
          "description": "90° (π/2 rad)"
        },
        "straight": {
          "label": "↔️ 180°",
          "description": "180° (π rad)"
        },
        "full": {
          "label": "🔄 360°",
          "description": "360° (2π rad)"
        }
      },
      "values": {},
      "formats": {
      ...
      "infoCards": {
        ...
        "tips": {
          ...
          "items": [
            "Valores clave: 90° = π/2, 180° = π, 360° = 2π",
      ...
      "education": {
        "whatIs": {
          ...
          "content": "Convierte grados a radianes y gradianes al instante. Esencial para matemáticas, física, ingeniería y programación. Este convertidor soporta todas las unidades relacionadas en la categoría de ángulos, permitiendo convertir entre cualquier combinación con una sola entrada."
        },
        "howItWorks": {
        ...
        "considerations": {
          ...
          "items": [
            {
              "text": "Valores clave: 90° = π/2, 180° = π, 360° = 2π",
              "type": "info"
            },
            {
      ...
      "faqs": [
        ...
        },
        {
          ...
          "answer": "Este convertidor soporta todas las unidades en la categoría de ángulos: grados, radianes, gradianes. Selecciona cualquiera del menú desplegable."
        },
        {
    ...
    pt: {
      ...
      "slug": "calculadora-graus-para-radianos",
      "subtitle": "Converta graus para radianos e grados para matemática, física e programação.",
      "breadcrumb": "Graus para Radianos",
      "seo": {
        "title": "Conversor de Graus para Radianos - Ferramenta de Conversão de Ângulos",
        "description": "Converta graus para radianos e grados instantaneamente. Essencial para matemática, física, engenharia e programação.",
        "shortDescription": "Converta graus para radianos e grados para matemática, física e programação.",
        "keywords": [
          "graus para radianos",
          "graus para rad",
          "conversor de ângulos",
          "conversor trigonometria",
          "conversão ângulo matemática",
          "calculadora graus radianos"
        ]
      },
      "inputs": {
        "amount": {
          "label": "Ângulo",
          "helpText": "Digite o ângulo para converter"
        }
      },
      "results": {
        "primary": {
      ...
      "infoCards": {
        ...
        "tips": {
          ...
          "items": [
            "Valores principais: 90° = π/2, 180° = π, 360° = 2π",
            "Selecione qualquer unidade do menu para converter a partir dessa unidade.",
      ...
      "education": {
        "whatIs": {
          ...
          "content": "Converta graus para radianos e grados instantaneamente. Essencial para matemática, física, engenharia e programação. Este conversor suporta todas as unidades relacionadas na categoria de ângulos, permitindo converter entre qualquer combinação com uma única entrada."
        },
        "howItWorks": {
        ...
        "considerations": {
          ...
          "items": [
            {
              "text": "Valores principais: 90° = π/2, 180° = π, 360° = 2π",
              "type": "info"
            },
            {
              "text": "Selecione qualquer unidade do menu para alterar a unidade de origem.",
              "type": "info"
            },
            {
          ...
          "examples": [
            {
              ...
              "steps": [
                ...
                "Use o menu para alterar a unidade de origem"
              ],
            ...
            },
            {
              ...
              "steps": [
                "Altere o menu para a unidade de destino",
                "Digite seu valor",
                "Leia o resultado na unidade original"
              ],
              "result": "Funciona nos dois sentidos — apenas altere o menu"
            }
          ]
        }
      },
      "faqs": [
        ...
        },
        {
          ...
          "answer": "Este conversor suporta todas as unidades na categoria de ângulos: graus, rad, grad. Selecione qualquer uma no menu suspenso."
        },
        {
    ...
    fr: {
      "name": "Convertisseur Degrés vers Radians",
      "slug": "calculateur-degres-vers-radians",
      "subtitle": "Convertir les degrés en radians et gradians pour les mathématiques, la physique et la programmation.",
      "breadcrumb": "Degrés vers Radians",
      "seo": {
        "title": "Convertisseur Degrés vers Radians - Outil de Conversion d'Angles",
        "description": "Convertir instantanément les degrés en radians et gradians. Essentiel pour les mathématiques, la physique, l'ingénierie et la programmation.",
        "shortDescription": "Convertir les degrés en radians et gradians pour les mathématiques, la physique et la programmation.",
        "keywords": [
          "degrés vers radians",
          "deg vers rad",
          "convertisseur angle",
          "convertisseur trigonométrie",
          "conversion angle mathématiques",
          "calculateur degrés radians"
        ]
      },
      "inputs": {
        "amount": {
          "label": "Angle",
          "helpText": "Entrez l'angle à convertir"
        }
      },
      "results": {
        "primary": {
      ...
      "infoCards": {
        ...
        "tips": {
          ...
          "items": [
            "Valeurs clés : 90° = π/2, 180° = π, 360° = 2π",
      ...
      "education": {
        "whatIs": {
          ...
          "content": "Convertir instantanément les degrés en radians et gradians. Essentiel pour les mathématiques, la physique, l'ingénierie et la programmation. Ce convertisseur prend en charge toutes les unités liées dans la catégorie des angles, vous permettant de convertir entre n'importe quelle combinaison avec une seule saisie."
        },
        "howItWorks": {
        ...
        "considerations": {
          ...
          "items": [
            {
              "text": "Valeurs clés : 90° = π/2, 180° = π, 360° = 2π",
              "type": "info"
            },
            {
        ...
        "commonValues": {
          ...
          "items": [
            {
              "text": "Voir la carte de Référence Rapide pour les valeurs courantes.",
              "type": "info"
            },
            {
      ...
      "faqs": [
        ...
        },
        {
          ...
          "answer": "Ce convertisseur prend en charge toutes les unités de la catégorie des angles : deg, rad, grad. Sélectionnez n'importe laquelle dans le menu déroulant."
        },
        {
    ...
    de: {
      "name": "Grad zu Bogenmaß Umrechner",
      "slug": "grad-zu-bogenmass-rechner",
      "subtitle": "Konvertieren Sie Grad zu Bogenmaß und Gon für Mathematik, Physik und Programmierung.",
      "breadcrumb": "Grad zu Bogenmaß",
      "seo": {
        "title": "Grad zu Bogenmaß Umrechner - Winkel Umrechnungstool",
        "description": "Konvertieren Sie Grad zu Bogenmaß und Gon sofort. Unverzichtbar für Mathematik, Physik, Ingenieurwesen und Programmierung.",
        "shortDescription": "Konvertieren Sie Grad zu Bogenmaß und Gon für Mathematik, Physik und Programmierung.",
        "keywords": [
          "Grad zu Bogenmaß",
          "Grad zu Radiant",
          "Winkelumrechner",
          "Trigonometrie Umrechner",
          "Mathematik Winkelumrechnung",
          "Grad Bogenmaß Rechner"
        ]
      },
      "inputs": {
        "amount": {
          "label": "Winkel",
          "helpText": "Geben Sie den zu konvertierenden Winkel ein"
        }
      },
      "results": {
        "primary": {
      ...
      "infoCards": {
        ...
        "tips": {
          ...
          "items": [
            "Schlüsselwerte: 90° = π/2, 180° = π, 360° = 2π",
            "Wählen Sie eine beliebige Einheit aus dem Dropdown-Menü, um stattdessen von dieser Einheit zu konvertieren.",
      ...
      "education": {
        "whatIs": {
          ...
          "content": "Konvertieren Sie Grad zu Bogenmaß und Gon sofort. Unverzichtbar für Mathematik, Physik, Ingenieurwesen und Programmierung. Dieser Umrechner unterstützt alle verwandten Einheiten in der Winkelkategorie und ermöglicht es Ihnen, zwischen jeder Kombination mit einer einzigen Eingabe zu konvertieren."
        },
        "howItWorks": {
        ...
        "considerations": {
          ...
          "items": [
            {
              "text": "Schlüsselwerte: 90° = π/2, 180° = π, 360° = 2π",
              "type": "info"
            },
            {
      ...
      "faqs": [
        ...
        },
        {
          ...
          "answer": "Ja! Ändern Sie einfach die Einheit im Dropdown-Menü, um von jeder Einheit zu allen anderen zu konvertieren. Der Umrechner ist vollständig bidirektional."
        },
        {
          "question": "Welche Einheiten werden unterstützt?",
          "answer": "Dieser Umrechner unterstützt alle Einheiten in der Winkelkategorie: Grad, Radiant, Gon. Wählen Sie eine beliebige aus dem Dropdown-Menü."
        },
        {
...
export function calculateDegreesToRadians(data: {
  ...
  const fromUnit = fieldUnits.amount || "deg";

  if (amount === undefined || amount === null || amount < 0) {
    return { values: {}, formatted: {}, summary: "", isValid: false };
  }

  const unitGroup = UNIT_REGISTRY["angle"];
  ...
  for (const unit of units) {
    try {
      const converted = convert(amount, fromUnit, unit.id, "angle");
...
export default degreesToRadiansConfig;
