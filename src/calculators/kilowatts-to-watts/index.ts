...
export const kilowattsToWattsConfig: CalculatorConfigV4 = {
  ...
  t: {
    en: {
      name: "Kilowatts to Watts Converter",
      slug: "kilowatts-to-watts",
      subtitle: "Convert kilowatts to watts for solar panels, appliances, and electricity calculations.",
      breadcrumb: "Kilowatts to Watts",

      seo: {
        title: "Kilowatts to Watts Converter - Power Conversion Tool",
        description: "Convert kilowatts to watts instantly. 1 kW = 1,000 W. Essential for solar panels, appliances, and electricity calculations.",
        shortDescription: "Convert kilowatts to watts for solar panels, appliances, and electricity calcula",
      ...
      presets: {
        one: { label: "💡 1 kW", description: "1 kW (1,000 W)" },
        five: { label: "☀️ 5 kW", description: "5 kW (solar system)" },
        ten: { label: "⚡ 10 kW", description: "10 kW (10,000 W)" },
      },
      ...
      infoCards: {
        ...
        tips: {
          ...
          items: [
            "1 kW = 1,000 W | A 5 kW solar system = 5,000 watts",
      ...
      education: {
        whatIs: {
          ...
          content: "Convert kilowatts to watts instantly. 1 kW = 1,000 W. Essential for solar panels, appliances, and electricity calculations. This converter supports all related units in the power category, letting you convert between any combination with a single input.",
        },
        howItWorks: {
        ...
        considerations: {
          ...
          items: [
            { text: "1 kW = 1,000 W | A 5 kW solar system = 5,000 watts", type: "info" },
      ...
      faqs: [
        ...
        { question: "What units are supported?", answer: "This converter supports all units in the power category: kW, W, MW, HP, BTUh, mW. Select any from the dropdown." },
    ...
    es: {
      "name": "Convertidor de Kilovatios a Vatios",
      "slug": "calculadora-kilovatios-a-vatios",
      "subtitle": "Convierte kilovatios a vatios para paneles solares, electrodomésticos y cálculos eléctricos.",
      "breadcrumb": "Kilovatios a Vatios",
      "seo": {
        "title": "Convertidor de Kilovatios a Vatios - Herramienta de Conversión de Potencia",
        "description": "Convierte kilovatios a vatios instantáneamente. 1 kW = 1,000 W. Esencial para paneles solares, electrodomésticos y cálculos eléctricos.",
        "shortDescription": "Convierte kilovatios a vatios para paneles solares, electrodomésticos y cálculos eléctricos",
        "keywords": [
          "kilovatios a vatios",
          "kW a W",
          "convertidor de potencia",
          "vatios paneles solares",
          "calculadora potencia electrodomésticos",
      ...
      "infoCards": {
        ...
        "tips": {
          ...
          "items": [
            "1 kW = 1,000 W | Un sistema solar de 5 kW = 5,000 vatios",
      ...
      "education": {
        "whatIs": {
          ...
          "content": "Convierte kilovatios a vatios instantáneamente. 1 kW = 1,000 W. Esencial para paneles solares, electrodomésticos y cálculos eléctricos. Este convertidor soporta todas las unidades relacionadas en la categoría de potencia, permitiéndote convertir entre cualquier combinación con una sola entrada."
        },
        "howItWorks": {
        ...
        "considerations": {
          ...
          "items": [
            {
              "text": "1 kW = 1,000 W | Un sistema solar de 5 kW = 5,000 vatios",
              "type": "info"
            },
            {
        ...
        "commonValues": {
          ...
          "items": [
            ...
            {
              "text": "Soporta todas las unidades en el grupo de potencia.",
              "type": "info"
            }
          ]
        },
      ...
      "faqs": [
        ...
        },
        {
          ...
          "answer": "Este convertidor soporta todas las unidades en la categoría de potencia: kW, W, MW, HP, BTU/h, mW. Selecciona cualquiera del menú desplegable."
        },
        {
    ...
    pt: {
      "name": "Conversor de Quilowatts para Watts",
      "slug": "calculadora-quilowatts-para-watts",
      "subtitle": "Converta quilowatts para watts para painéis solares, aparelhos e cálculos de eletricidade.",
      "breadcrumb": "Quilowatts para Watts",
      "seo": {
        "title": "Conversor de Quilowatts para Watts - Ferramenta de Conversão de Potência",
        "description": "Converta quilowatts para watts instantaneamente. 1 kW = 1.000 W. Essencial para painéis solares, aparelhos e cálculos de eletricidade.",
        "shortDescription": "Converta quilowatts para watts para painéis solares, aparelhos e cálculos de eletricidade",
        "keywords": [
          "quilowatts para watts",
          "kW para W",
          "conversor de potência",
          "potência de painéis solares",
          "calculadora de potência de aparelhos",
      ...
      "infoCards": {
        ...
        "tips": {
          ...
          "items": [
            "1 kW = 1.000 W | Um sistema solar de 5 kW = 5.000 watts",
      ...
      "education": {
        "whatIs": {
          ...
          "content": "Converta quilowatts para watts instantaneamente. 1 kW = 1.000 W. Essencial para painéis solares, aparelhos e cálculos de eletricidade. Este conversor suporta todas as unidades relacionadas na categoria de potência, permitindo converter entre qualquer combinação com uma única entrada."
        },
        "howItWorks": {
        ...
        "considerations": {
          ...
          "items": [
            {
              "text": "1 kW = 1.000 W | Um sistema solar de 5 kW = 5.000 watts",
              "type": "info"
            },
            {
        ...
        "commonValues": {
          ...
          "items": [
            ...
            {
              "text": "Suporta todas as unidades do grupo de potência.",
              "type": "info"
            }
          ]
        },
      ...
      "faqs": [
        ...
        },
        {
          ...
          "answer": "Este conversor suporta todas as unidades na categoria de potência: kW, W, MW, HP, BTU/h, mW. Selecione qualquer uma no menu suspenso."
        },
        {
    ...
    fr: {
      "name": "Convertisseur Kilowatts vers Watts",
      "slug": "calculateur-kilowatts-vers-watts",
      "subtitle": "Convertissez les kilowatts en watts pour panneaux solaires, appareils électriques et calculs d'électricité.",
      "breadcrumb": "Kilowatts vers Watts",
      "seo": {
        "title": "Convertisseur Kilowatts vers Watts - Outil de Conversion de Puissance",
        "description": "Convertissez instantanément les kilowatts en watts. 1 kW = 1 000 W. Essentiel pour panneaux solaires, appareils électriques et calculs d'électricité.",
        "shortDescription": "Convertissez les kilowatts en watts pour panneaux solaires, appareils électriques et calculs d'électricité",
        "keywords": [
          "kilowatts vers watts",
          "kW vers W",
          "convertisseur puissance",
          "puissance panneau solaire",
          "calculateur puissance appareil",
      ...
      "infoCards": {
        ...
        "tips": {
          ...
          "items": [
            "1 kW = 1 000 W | Un système solaire de 5 kW = 5 000 watts",
      ...
      "education": {
        "whatIs": {
          ...
          "content": "Convertissez instantanément les kilowatts en watts. 1 kW = 1 000 W. Essentiel pour panneaux solaires, appareils électriques et calculs d'électricité. Ce convertisseur prend en charge toutes les unités liées dans la catégorie puissance, vous permettant de convertir entre n'importe quelle combinaison avec une seule saisie."
        },
        "howItWorks": {
        ...
        "considerations": {
          ...
          "items": [
            {
              "text": "1 kW = 1 000 W | Un système solaire de 5 kW = 5 000 watts",
              "type": "info"
            },
            {
      ...
      "faqs": [
        ...
        },
        {
          ...
          "answer": "Ce convertisseur prend en charge toutes les unités de la catégorie puissance : kW, W, MW, HP, BTU/h, mW. Sélectionnez n'importe laquelle dans le menu déroulant."
        },
        {
    ...
    de: {
      "name": "Kilowatt zu Watt Umrechner",
      "slug": "kilowatt-zu-watt-rechner",
      "subtitle": "Rechnen Sie Kilowatt in Watt um für Solaranlagen, Geräte und Elektrizitätsberechnungen.",
      "breadcrumb": "Kilowatt zu Watt",
      "seo": {
        "title": "Kilowatt zu Watt Umrechner - Leistungsumrechnung Tool",
        "description": "Rechnen Sie Kilowatt sofort in Watt um. 1 kW = 1.000 W. Unverzichtbar für Solaranlagen, Geräte und Elektrizitätsberechnungen.",
        "shortDescription": "Rechnen Sie Kilowatt in Watt um für Solaranlagen, Geräte und Elektrizitätsberechnungen",
        "keywords": [
          "Kilowatt zu Watt",
          "kW zu W",
          "Leistungsumrechner",
          "Solaranlagen Wattleistung",
          "Geräte Leistungsrechner",
          "Elektrizitäts Umrechnung"
        ]
      },
      "calculator": {
      ...
      "infoCards": {
        ...
        "tips": {
          ...
          "items": [
            "1 kW = 1.000 W | Eine 5 kW Solaranlage = 5.000 Watt",
      ...
      "education": {
        "whatIs": {
          ...
          "content": "Rechnen Sie Kilowatt sofort in Watt um. 1 kW = 1.000 W. Unverzichtbar für Solaranlagen, Geräte und Elektrizitätsberechnungen. Dieser Umrechner unterstützt alle verwandten Einheiten in der Leistungskategorie und ermöglicht es Ihnen, zwischen jeder Kombination mit einer einzigen Eingabe umzurechnen."
        },
        "howItWorks": {
        ...
        "considerations": {
          ...
          "items": [
            {
              "text": "1 kW = 1.000 W | Eine 5 kW Solaranlage = 5.000 Watt",
              "type": "info"
            },
            {
      ...
      "faqs": [
        ...
        },
        {
          ...
          "answer": "Dieser Umrechner unterstützt alle Einheiten in der Leistungskategorie: kW, W, MW, PS, BTU/h, mW. Wählen Sie beliebige aus dem Dropdown."
        },
        {
...
export function calculateKilowattsToWatts(data: {
  ...
  const fromUnit = fieldUnits.amount || "kW";
  ...
  const allUnits = ["kW", "W", "MW", "HP", "BTUh", "mW"];
...
export default kilowattsToWattsConfig;
