...
export const caratsToGramsConfig: CalculatorConfigV4 = {
  id: "carats-to-grams",
  version: "4.0",
  category: "conversion",
  icon: "💎",
  ...
  t: {
    en: {
      ...
      breadcrumb: "Carats to Grams",

      seo: {
        title: "Carats to Grams Converter - Gemstone Weight Tool",
        description: "Convert carats to grams for diamonds, gemstones, and jewelry. 1 carat = 0.2 grams. Essential for jewelers and buyers.",
        shortDescription: "Convert carats to grams for diamonds, gemstones, and jewelry measurements.",
      ...
      presets: {
        one: { label: "💎 1 ct", description: "1 ct (0.2 g)" },
        two: { label: "💍 2 ct", description: "2 ct (0.4 g)" },
        five: { label: "👑 5 ct", description: "5 ct (1.0 g)" },
      },
      ...
      education: {
        whatIs: {
          ...
          content: "Convert carats to grams for diamonds, gemstones, and jewelry. 1 carat = 0.2 grams. Essential for jewelers and buyers. This converter supports all related units in the mass category, letting you convert between any combination with a single input.",
        },
        howItWorks: {
        ...
        considerations: {
          ...
          items: [
            { text: "1 carat = 0.2 grams = 200 milligrams", type: "info" },
      ...
      faqs: [
        ...
        { question: "What units are supported?", answer: "This converter supports all units in the mass category: carat, g, mg, oz, kg. Select any from the dropdown." },
    ...
    es: {
      "name": "Convertidor de Quilates a Gramos",
      "slug": "calculadora-quilates-a-gramos",
      "subtitle": "Convierte quilates a gramos para diamantes, gemas y medidas de joyería.",
      "breadcrumb": "Quilates a Gramos",
      "seo": {
        "title": "Convertidor de Quilates a Gramos - Herramienta de Peso de Gemas",
        "description": "Convierte quilates a gramos para diamantes, gemas y joyería. 1 quilate = 0.2 gramos. Esencial para joyeros y compradores.",
        "shortDescription": "Convierte quilates a gramos para medidas de diamantes, gemas y joyería.",
        "keywords": [
          "quilates a gramos",
          "ct a g",
          "convertidor peso diamante",
          "peso gemas",
          "convertidor quilates joyería",
          "conversión quilate gramo"
        ]
      },
      "inputs": {
        "amount": {
      ...
      "presets": {
        "one": {
          "label": "💎 1 ct",
          "description": "1 ct (0.2 g)"
        },
        "two": {
          "label": "💍 2 ct",
          "description": "2 ct (0.4 g)"
        },
        "five": {
          "label": "👑 5 ct",
          "description": "5 ct (1.0 g)"
        }
      },
      "values": {},
      "formats": {
      ...
      "infoCards": {
        ...
        "tips": {
          ...
          "items": [
            "1 quilate = 0.2 gramos = 200 miligramos",
      ...
      "education": {
        "whatIs": {
          ...
          "content": "Convierte quilates a gramos para diamantes, gemas y joyería. 1 quilate = 0.2 gramos. Esencial para joyeros y compradores. Este convertidor admite todas las unidades relacionadas en la categoría de masa, permitiéndote convertir entre cualquier combinación con una sola entrada."
        },
        "howItWorks": {
        ...
        "considerations": {
          ...
          "items": [
            {
              "text": "1 quilate = 0.2 gramos = 200 miligramos",
              "type": "info"
            },
            {
        ...
        "commonValues": {
          ...
          "items": [
            ...
            {
              "text": "Comparte resultados usando el botón Compartir debajo.",
              "type": "info"
            },
            {
      ...
      "faqs": [
        ...
        },
        {
          ...
          "answer": "Este convertidor admite todas las unidades en la categoría de masa: quilate, g, mg, oz, kg. Selecciona cualquiera del menú desplegable."
        },
        {
    ...
    pt: {
      "name": "Conversor de Quilates para Gramas",
      "slug": "calculadora-quilates-para-gramas",
      "subtitle": "Converta quilates para gramas para diamantes, pedras preciosas e medições de joias.",
      "breadcrumb": "Quilates para Gramas",
      "seo": {
        "title": "Conversor de Quilates para Gramas - Ferramenta de Peso de Pedras Preciosas",
        "description": "Converta quilates para gramas para diamantes, pedras preciosas e joias. 1 quilate = 0,2 gramas. Essencial para joalheiros e compradores.",
        "shortDescription": "Converta quilates para gramas para diamantes, pedras preciosas e medições de joias.",
        "keywords": [
          "quilates para gramas",
          "ct para g",
          "conversor peso diamante",
          "peso pedra preciosa",
          "conversor quilate joia",
          "conversão quilate grama"
        ]
      },
      "inputs": {
        "amount": {
      ...
      "infoCards": {
        ...
        "tips": {
          ...
          "items": [
            "1 quilate = 0,2 gramas = 200 miligramas",
      ...
      "education": {
        "whatIs": {
          ...
          "content": "Converta quilates para gramas para diamantes, pedras preciosas e joias. 1 quilate = 0,2 gramas. Essencial para joalheiros e compradores. Este conversor suporta todas as unidades relacionadas na categoria de massa, permitindo converter entre qualquer combinação com uma única entrada."
        },
        "howItWorks": {
        ...
        "considerations": {
          ...
          "items": [
            {
              "text": "1 quilate = 0,2 gramas = 200 miligramas",
              "type": "info"
            },
            {
      ...
      "faqs": [
        ...
        },
        {
          ...
          "answer": "Este conversor suporta todas as unidades na categoria de massa: quilate, g, mg, oz, kg. Selecione qualquer uma no menu suspenso."
        },
        {
    ...
    fr: {
      "name": "Convertisseur Carats vers Grammes",
      "slug": "calculateur-carats-vers-grammes",
      "subtitle": "Convertir les carats en grammes pour les diamants, pierres précieuses et bijoux.",
      "breadcrumb": "Carats vers Grammes",
      "seo": {
        "title": "Convertisseur Carats vers Grammes - Outil de Poids des Pierres Précieuses",
        "description": "Convertir les carats en grammes pour les diamants, pierres précieuses et bijoux. 1 carat = 0,2 grammes. Essentiel pour bijoutiers et acheteurs.",
        "shortDescription": "Convertir les carats en grammes pour les diamants, pierres précieuses et bijoux.",
        "keywords": [
          "carats vers grammes",
          "ct vers g",
          "convertisseur poids diamant",
          "poids pierre précieuse",
          "convertisseur carat bijoux",
          "conversion carat gramme"
        ]
      },
      "inputs": {
        "amount": {
      ...
      "infoCards": {
        ...
        "tips": {
          ...
          "items": [
            "1 carat = 0,2 grammes = 200 milligrammes",
      ...
      "education": {
        "whatIs": {
          ...
          "content": "Convertir les carats en grammes pour les diamants, pierres précieuses et bijoux. 1 carat = 0,2 grammes. Essentiel pour les bijoutiers et acheteurs. Ce convertisseur prend en charge toutes les unités liées dans la catégorie masse, vous permettant de convertir entre toute combinaison avec une seule saisie."
        },
        "howItWorks": {
        ...
        "considerations": {
          ...
          "items": [
            {
              "text": "1 carat = 0,2 grammes = 200 milligrammes",
              "type": "info"
            },
            {
      ...
      "faqs": [
        ...
        },
        {
          ...
          "answer": "Ce convertisseur prend en charge toutes les unités de la catégorie masse : carat, g, mg, oz, kg. Sélectionnez n'importe laquelle dans le menu déroulant."
        },
        {
    ...
    de: {
      "name": "Karat zu Gramm Umrechner",
      "slug": "karat-zu-gramm-rechner",
      "subtitle": "Karat in Gramm umrechnen für Diamanten, Edelsteine und Schmuck-Messungen.",
      "breadcrumb": "Karat zu Gramm",
      "seo": {
        "title": "Karat zu Gramm Umrechner - Edelstein Gewicht Tool",
        "description": "Karat in Gramm umrechnen für Diamanten, Edelsteine und Schmuck. 1 Karat = 0,2 Gramm. Unverzichtbar für Juweliere und Käufer.",
        "shortDescription": "Karat in Gramm umrechnen für Diamanten, Edelsteine und Schmuck-Messungen.",
        "keywords": [
          "karat zu gramm",
          "ct zu g",
          "diamant gewicht umrechner",
          "edelstein gewicht",
          "schmuck karat umrechner",
          "karat gramm umrechnung"
        ]
      },
      "inputs": {
        "amount": {
      ...
      "infoCards": {
        ...
        "tips": {
          ...
          "items": [
            "1 Karat = 0,2 Gramm = 200 Milligramm",
      ...
      "education": {
        "whatIs": {
          ...
          "content": "Karat in Gramm umrechnen für Diamanten, Edelsteine und Schmuck. 1 Karat = 0,2 Gramm. Unverzichtbar für Juweliere und Käufer. Dieser Umrechner unterstützt alle verwandten Einheiten in der Masse-Kategorie und ermöglicht die Umrechnung zwischen beliebigen Kombinationen mit einer einzigen Eingabe."
        },
        "howItWorks": {
        ...
        "considerations": {
          ...
          "items": [
            {
              "text": "1 Karat = 0,2 Gramm = 200 Milligramm",
              "type": "info"
            },
            {
        ...
        "commonValues": {
          ...
          "items": [
            ...
            {
              "text": "Unterstützt alle Einheiten in der Masse-Gruppe.",
              "type": "info"
            }
          ]
        },
      ...
      "faqs": [
        ...
        },
        {
          ...
          "answer": "Dieser Umrechner unterstützt alle Einheiten in der Masse-Kategorie: Karat, g, mg, oz, kg. Wählen Sie eine beliebige aus dem Dropdown-Menü."
        },
        {
...
export function calculateCaratsToGrams(data: {
  ...
  const fromUnit = fieldUnits.amount || "carat";
  ...
  const allUnits = ["carat", "g", "mg", "oz", "kg"];
...
export default caratsToGramsConfig;
