...
export const kgToGramsConfig: CalculatorConfigV4 = {
  id: "kg-to-grams",
  version: "4.0",
  category: "conversion",
  icon: "⚖️",
  ...
  t: {
    en: {
      ...
      breadcrumb: "Kilograms to Grams",

      seo: {
        title: "KG to Grams Converter - Weight Conversion Tool",
        description: "Convert kilograms to grams instantly. 1 kg = 1000 g. Essential for cooking, science, and everyday measurements.",
        shortDescription: "Convert kilograms to grams for cooking, science, and everyday weight measurement",
      ...
      presets: {
        quarter: { label: "🧈 250 g", description: "250 g" },
        one: { label: "⚖️ 1 kg", description: "1 kg (1,000 g)" },
        five: { label: "📦 5 kg", description: "5 kg (5,000 g)" },
      },
      ...
      education: {
        whatIs: {
          ...
          content: "Convert kilograms to grams instantly. 1 kg = 1000 g. Essential for cooking, science, and everyday measurements. This converter supports all related units in the mass category, letting you convert between any combination with a single input.",
        },
        howItWorks: {
        ...
        considerations: {
          ...
          items: [
            { text: "1 kilogram = 1,000 grams = 2.205 pounds", type: "info" },
      ...
      faqs: [
        ...
        { question: "What units are supported?", answer: "This converter supports all units in the mass category: kg, g, mg, lbs, oz. Select any from the dropdown." },
    ...
    es: {
      "name": "Convertidor de Kilogramos a Gramos",
      "slug": "calculadora-kilogramos-a-gramos",
      "subtitle": "Convierte kilogramos a gramos para cocina, ciencia y mediciones de peso cotidianas.",
      "breadcrumb": "Kilogramos a Gramos",
      "seo": {
        "title": "Convertidor de KG a Gramos - Herramienta de Conversión de Peso",
        "description": "Convierte kilogramos a gramos al instante. 1 kg = 1000 g. Esencial para cocina, ciencia y mediciones cotidianas.",
        "shortDescription": "Convierte kilogramos a gramos para cocina, ciencia y medición de peso cotidiana",
        "keywords": [
          "kg a gramos",
          "kilogramos a gramos",
          "convertidor de peso",
      ...
      "presets": {
        ...
        "one": {
          "label": "⚖️ 1 kg",
          "description": "1 kg (1,000 g)"
        },
        "five": {
          "label": "📦 5 kg",
          "description": "5 kg (5,000 g)"
        }
      },
      "values": {},
      "formats": {
      ...
      "infoCards": {
        ...
        "tips": {
          ...
          "items": [
            "1 kilogramo = 1,000 gramos = 2.205 libras",
            ...
            "Usa las opciones preestablecidas para valores de conversión comunes."
          ]
        }
      },
      "education": {
        "whatIs": {
          ...
          "content": "Convierte kilogramos a gramos al instante. 1 kg = 1000 g. Esencial para cocina, ciencia y mediciones cotidianas. Este convertidor soporta todas las unidades relacionadas en la categoría de masa, permitiéndote convertir entre cualquier combinación con una sola entrada."
        },
        "howItWorks": {
        ...
        "considerations": {
          ...
          "items": [
            {
              "text": "1 kilogramo = 1,000 gramos = 2.205 libras",
              "type": "info"
            },
            {
        ...
        "commonValues": {
          ...
          "items": [
            {
              "text": "Usa las opciones preestablecidas arriba para cantidades frecuentemente utilizadas.",
              "type": "info"
            },
            {
            ...
            {
              "text": "Soporta todas las unidades en el grupo de masa.",
              "type": "info"
            }
          ]
        },
      ...
      "faqs": [
        ...
        },
        {
          ...
          "answer": "Este convertidor soporta todas las unidades en la categoría de masa: kg, g, mg, lbs, oz. Selecciona cualquiera del menú desplegable."
        },
        {
    ...
    pt: {
      "name": "Conversor de Quilogramas para Gramas",
      "slug": "calculadora-kg-para-gramas",
      "subtitle": "Converta quilogramas para gramas para culinária, ciência e medições de peso do dia a dia.",
      "breadcrumb": "Quilogramas para Gramas",
      "seo": {
        "title": "Conversor KG para Gramas - Ferramenta de Conversão de Peso",
        "description": "Converta quilogramas para gramas instantaneamente. 1 kg = 1000 g. Essencial para culinária, ciência e medições cotidianas.",
        "shortDescription": "Converta quilogramas para gramas para culinária, ciência e medição de peso cotidiano",
        "keywords": [
          "kg para gramas",
          ...
          "conversão kg g",
          "peso métrico",
          "conversor de peso culinário"
        ]
      },
      "inputs": {
        "amount": {
          "label": "Peso",
          "helpText": "Insira o peso para converter"
        }
      },
      "results": {
        "primary": {
      ...
      "infoCards": {
        ...
        "tips": {
          ...
          "items": [
            "1 quilograma = 1.000 gramas = 2,205 libras",
      ...
      "education": {
        "whatIs": {
          ...
          "content": "Converta quilogramas para gramas instantaneamente. 1 kg = 1000 g. Essencial para culinária, ciência e medições cotidianas. Este conversor suporta todas as unidades relacionadas na categoria de massa, permitindo converter entre qualquer combinação com uma única entrada."
        },
        "howItWorks": {
        ...
        "considerations": {
          ...
          "items": [
            {
              "text": "1 quilograma = 1.000 gramas = 2,205 libras",
              "type": "info"
            },
            {
      ...
      "faqs": [
        {
          ...
          "answer": "Todas as conversões usam fatores exatos dos padrões internacionais NIST e BIPM. Os resultados são precisos em pelo menos 6 dígitos significativos."
        },
        {
        ...
        },
        {
          ...
          "answer": "Este conversor suporta todas as unidades da categoria de massa: kg, g, mg, lbs, oz. Selecione qualquer uma do menu suspenso."
        },
        {
    ...
    fr: {
      "name": "Convertisseur Kilogrammes vers Grammes",
      "slug": "calculateur-kilogrammes-vers-grammes",
      "subtitle": "Convertissez les kilogrammes en grammes pour la cuisine, les sciences et les mesures de poids quotidiennes.",
      "breadcrumb": "Kilogrammes vers Grammes",
      "seo": {
        "title": "Convertisseur KG vers Grammes - Outil de Conversion de Poids",
        "description": "Convertissez les kilogrammes en grammes instantanément. 1 kg = 1000 g. Essentiel pour la cuisine, les sciences et les mesures quotidiennes.",
        "shortDescription": "Convertissez les kilogrammes en grammes pour la cuisine, les sciences et les mesures de poids quotidiennes",
        "keywords": [
          "kg vers grammes",
          "kilogrammes vers grammes",
          "convertisseur poids",
          "conversion kg g",
          "poids métrique",
          "convertisseur poids cuisine"
        ]
      },
      "inputs": {
        "amount": {
      ...
      "infoCards": {
        ...
        "tips": {
          ...
          "items": [
            "1 kilogramme = 1 000 grammes = 2,205 livres",
      ...
      "education": {
        "whatIs": {
          ...
          "content": "Convertissez les kilogrammes en grammes instantanément. 1 kg = 1000 g. Essentiel pour la cuisine, les sciences et les mesures quotidiennes. Ce convertisseur prend en charge toutes les unités connexes dans la catégorie masse, vous permettant de convertir entre n'importe quelle combinaison avec une seule saisie."
        },
        "howItWorks": {
        ...
        "considerations": {
          ...
          "items": [
            {
              "text": "1 kilogramme = 1 000 grammes = 2,205 livres",
              "type": "info"
            },
            {
      ...
      "faqs": [
        ...
        },
        {
          ...
          "answer": "Ce convertisseur prend en charge toutes les unités de la catégorie masse : kg, g, mg, lbs, oz. Sélectionnez n'importe laquelle dans le menu déroulant."
        },
        {
    ...
    de: {
      "name": "Kilogramm zu Gramm Umrechner",
      "slug": "kilogramm-zu-gramm-rechner",
      "subtitle": "Kilogramm in Gramm umrechnen für Kochen, Wissenschaft und alltägliche Gewichtsmessungen.",
      "breadcrumb": "Kilogramm zu Gramm",
      "seo": {
        "title": "KG zu Gramm Umrechner - Gewichts-Umrechnungstool",
        "description": "Kilogramm sofort in Gramm umrechnen. 1 kg = 1000 g. Unverzichtbar für Kochen, Wissenschaft und alltägliche Messungen.",
        "shortDescription": "Kilogramm in Gramm umrechnen für Kochen, Wissenschaft und alltägliche Gewichtsmessungen",
        "keywords": [
          "kg zu gramm",
          "kilogramm zu gramm",
          "gewichtsumrechner",
      ...
      "infoCards": {
        ...
        "tips": {
          ...
          "items": [
            "1 Kilogramm = 1.000 Gramm = 2,205 Pfund",
      ...
      "education": {
        "whatIs": {
          ...
          "content": "Kilogramm sofort in Gramm umrechnen. 1 kg = 1000 g. Unverzichtbar für Kochen, Wissenschaft und alltägliche Messungen. Dieser Umrechner unterstützt alle verwandten Einheiten in der Massekategorie und ermöglicht die Umrechnung zwischen beliebigen Kombinationen mit einer einzigen Eingabe."
        },
        "howItWorks": {
        ...
        "considerations": {
          ...
          "items": [
            {
              "text": "1 Kilogramm = 1.000 Gramm = 2,205 Pfund",
              "type": "info"
            },
            {
      ...
      "faqs": [
        ...
        },
        {
          ...
          "answer": "Dieser Umrechner unterstützt alle Einheiten in der Massekategorie: kg, g, mg, lbs, oz. Wählen Sie eine beliebige aus dem Dropdown-Menü."
        },
        {
...
export function calculateKgToGrams(data: {
...
export default kgToGramsConfig;
