...
export const ouncesToGramsConfig: CalculatorConfigV4 = {
  id: "ounces-to-grams",
  version: "4.0",
  category: "conversion",
  icon: "⚖️",
  ...
  t: {
    en: {
      ...
      breadcrumb: "Ounces to Grams",

      seo: {
        title: "Ounces to Grams Converter - Weight Conversion Tool",
        description: "Convert ounces to grams instantly. Perfect for cooking, baking, jewelry, and international recipe conversions.",
        shortDescription: "Convert ounces to grams for cooking, baking, jewelry, and shipping measurements.",
      ...
      presets: {
        one: { label: "💎 1 oz", description: "1 oz (28.35g)" },
        four: { label: "🧈 4 oz = ¼ lb", description: "4 oz = ¼ lb (113g)" },
        eight: { label: "📦 8 oz = ½ lb", description: "8 oz = ½ lb (227g)" },
      },
      ...
      infoCards: {
        ...
        tips: {
          ...
          items: [
            "Quick estimate: 1 ounce ≈ 28.35 grams",
      ...
      education: {
        whatIs: {
          ...
          content: "Convert ounces to grams instantly. Perfect for cooking, baking, jewelry, and international recipe conversions. This converter supports all related units in the mass category, letting you convert between any combination with a single input.",
        },
        howItWorks: {
        ...
        considerations: {
          ...
          items: [
            { text: "Quick estimate: 1 ounce ≈ 28.35 grams", type: "info" },
      ...
      faqs: [
        ...
        { question: "What units are supported?", answer: "This converter supports all units in the mass category: oz, g, kg, lbs, mg. Select any from the dropdown." },
    ...
    es: {
      "name": "Convertidor de Onzas a Gramos",
      "slug": "calculadora-onzas-a-gramos",
      "subtitle": "Convierte onzas a gramos para cocinar, hornear, joyería y medidas de envío.",
      "breadcrumb": "Onzas a Gramos",
      "seo": {
        "title": "Convertidor de Onzas a Gramos - Herramienta de Conversión de Peso",
        "description": "Convierte onzas a gramos al instante. Perfecto para cocinar, hornear, joyería y conversiones de recetas internacionales.",
        "shortDescription": "Convierte onzas a gramos para cocinar, hornear, joyería y medidas de envío.",
        "keywords": [
          "onzas a gramos",
          "oz a g",
          "convertidor onza gramo",
          "conversión de peso",
          "cocina oz a gramos",
      ...
      "presets": {
        "one": {
          "label": "💎 1 oz",
          "description": "1 oz (28.35g)"
        },
        "four": {
          "label": "🧈 4 oz = ¼ lb",
          "description": "4 oz = ¼ lb (113g)"
        },
        "eight": {
          "label": "📦 8 oz = ½ lb",
          "description": "8 oz = ½ lb (227g)"
        }
      },
      "values": {},
      "formats": {
      ...
      "infoCards": {
        ...
        "tips": {
          ...
          "items": [
            "Estimación rápida: 1 onza ≈ 28.35 gramos",
      ...
      "education": {
        "whatIs": {
          ...
          "content": "Convierte onzas a gramos al instante. Perfecto para cocinar, hornear, joyería y conversiones de recetas internacionales. Este convertidor admite todas las unidades relacionadas en la categoría de masa, permitiéndote convertir entre cualquier combinación con una sola entrada."
        },
        "howItWorks": {
        ...
        "considerations": {
          ...
          "items": [
            {
              "text": "Estimación rápida: 1 onza ≈ 28.35 gramos",
              "type": "info"
            },
            {
      ...
      "faqs": [
        ...
        },
        {
          ...
          "answer": "Este convertidor admite todas las unidades en la categoría de masa: oz, g, kg, lbs, mg. Selecciona cualquiera del menú desplegable."
        },
        {
    ...
    pt: {
      ...
      "slug": "calculadora-oncas-para-gramas",
      "subtitle": "Converta onças para gramas para culinária, confeitaria, joalheria e medições de envio.",
      "breadcrumb": "Onças para Gramas",
      "seo": {
        "title": "Conversor de Onças para Gramas - Ferramenta de Conversão de Peso",
        "description": "Converta onças para gramas instantaneamente. Perfeito para culinária, confeitaria, joalheria e conversões de receitas internacionais.",
        "shortDescription": "Converta onças para gramas para culinária, confeitaria, joalheria e medições de envio.",
        "keywords": [
          "onças para gramas",
          "oz para g",
          "conversor onça grama",
          "conversão de peso",
          "culinária oz para gramas",
      ...
      "infoCards": {
        ...
        "tips": {
          ...
          "items": [
            "Estimativa rápida: 1 onça ≈ 28,35 gramas",
      ...
      "education": {
        "whatIs": {
          ...
          "content": "Converta onças para gramas instantaneamente. Perfeito para culinária, confeitaria, joalheria e conversões de receitas internacionais. Este conversor suporta todas as unidades relacionadas na categoria de massa, permitindo converter entre qualquer combinação com uma única entrada."
        },
        "howItWorks": {
        ...
        "considerations": {
          ...
          "items": [
            {
              "text": "Estimativa rápida: 1 onça ≈ 28,35 gramas",
              "type": "info"
            },
            {
      ...
      "faqs": [
        ...
        },
        {
          ...
          "answer": "Este conversor suporta todas as unidades na categoria de massa: oz, g, kg, lbs, mg. Selecione qualquer uma no menu suspenso."
        },
        {
    ...
    fr: {
      "name": "Convertisseur Onces vers Grammes",
      "slug": "calculateur-onces-vers-grammes",
      "subtitle": "Convertissez les onces en grammes pour la cuisine, la pâtisserie, la bijouterie et les mesures d'expédition.",
      "breadcrumb": "Onces vers Grammes",
      "seo": {
        "title": "Convertisseur Onces vers Grammes - Outil de Conversion de Poids",
        "description": "Convertissez instantanément les onces en grammes. Parfait pour la cuisine, la pâtisserie, la bijouterie et les conversions de recettes internationales.",
        "shortDescription": "Convertissez les onces en grammes pour la cuisine, la pâtisserie, la bijouterie et les mesures d'expédition.",
        "keywords": [
          "onces vers grammes",
          "oz vers g",
          "convertisseur once gramme",
          "conversion poids",
          "cuisine oz vers grammes",
      ...
      "infoCards": {
        ...
        "tips": {
          ...
          "items": [
            "Estimation rapide : 1 once ≈ 28,35 grammes",
      ...
      "education": {
        "whatIs": {
          ...
          "content": "Convertissez instantanément les onces en grammes. Parfait pour la cuisine, la pâtisserie, la bijouterie et les conversions de recettes internationales. Ce convertisseur prend en charge toutes les unités connexes dans la catégorie masse, vous permettant de convertir entre toute combinaison avec une seule saisie."
        },
        "howItWorks": {
        ...
        "considerations": {
          ...
          "items": [
            {
              "text": "Estimation rapide : 1 once ≈ 28,35 grammes",
              "type": "info"
            },
            {
      ...
      "faqs": [
        {
          ...
          "answer": "Toutes les conversions utilisent des facteurs exacts issus des normes internationales NIST et BIPM. Les résultats sont précis à au moins 6 chiffres significatifs."
        },
        {
        ...
        },
        {
          ...
          "answer": "Ce convertisseur prend en charge toutes les unités de la catégorie masse : oz, g, kg, lbs, mg. Sélectionnez n'importe laquelle dans le menu déroulant."
        },
        {
    ...
    de: {
      "name": "Unzen zu Gramm Umrechner",
      "slug": "unzen-zu-gramm-rechner",
      "subtitle": "Unzen in Gramm umrechnen für Kochen, Backen, Schmuck und Versandgewichte.",
      "breadcrumb": "Unzen zu Gramm",
      "seo": {
        "title": "Unzen zu Gramm Umrechner - Gewichts-Umrechnungstool",
        "description": "Unzen sofort in Gramm umrechnen. Perfekt für Kochen, Backen, Schmuck und internationale Rezept-Umrechnungen.",
        "shortDescription": "Unzen in Gramm umrechnen für Kochen, Backen, Schmuck und Versandgewichte.",
        "keywords": [
          "Unzen zu Gramm",
          "oz zu g",
          "Unzen Gramm Umrechner",
          "Gewichtsumrechnung",
          "Kochen oz zu Gramm",
          "Imperial zu metrisches Gewicht"
        ]
      },
      "inputs": {
        "amount": {
      ...
      "infoCards": {
        ...
        "tips": {
          ...
          "items": [
            "Schnelle Schätzung: 1 Unze ≈ 28,35 Gramm",
      ...
      "education": {
        "whatIs": {
          ...
          "content": "Unzen sofort in Gramm umrechnen. Perfekt für Kochen, Backen, Schmuck und internationale Rezept-Umrechnungen. Dieser Umrechner unterstützt alle verwandten Einheiten in der Gewichtskategorie und ermöglicht es Ihnen, zwischen jeder Kombination mit einer einzigen Eingabe zu konvertieren."
        },
        "howItWorks": {
          "title": "So funktioniert die Umrechnung",
        ...
        "considerations": {
          ...
          "items": [
            {
              "text": "Schnelle Schätzung: 1 Unze ≈ 28,35 Gramm",
              "type": "info"
            },
            {
      ...
      "faqs": [
        ...
        },
        {
          ...
          "answer": "Dieser Umrechner unterstützt alle Einheiten in der Gewichtskategorie: oz, g, kg, lbs, mg. Wählen Sie eine beliebige aus dem Dropdown-Menü."
        },
        {
...
export function calculateOuncesToGrams(data: {
...
export default ouncesToGramsConfig;
