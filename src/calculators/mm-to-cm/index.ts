...
export const mmToCmConfig: CalculatorConfigV4 = {
  id: "mm-to-cm",
  version: "4.0",
  category: "conversion",
  icon: "📏",
  ...
  presets: [
    ...
    { id: "twoFiftyFour", icon: "📏", values: { amount: 25.4 } },
  ],
  ...
  t: {
    en: {
      ...
      seo: {
        title: "MM to CM Converter - Length Conversion Tool",
        description: "Convert millimeters to centimeters instantly. 10 mm = 1 cm. Essential for engineering, manufacturing, and everyday measurements.",
        shortDescription: "Convert millimeters to centimeters for engineering, manufacturing, and everyday ",
      ...
      presets: {
        ten: { label: "📏 10 mm", description: "10 mm (1 cm)" },
        hundred: { label: "📐 100 mm", description: "100 mm (10 cm)" },
        twoFiftyFour: { label: "📏 25.4 mm", description: "25.4 mm (1 inch)" },
      },
      ...
      infoCards: {
        ...
        tips: {
          ...
          items: [
            "10 mm = 1 cm | 25.4 mm = 1 inch | 304.8 mm = 1 foot",
      ...
      education: {
        whatIs: {
          ...
          content: "Convert millimeters to centimeters instantly. 10 mm = 1 cm. Essential for engineering, manufacturing, and everyday measurements. This converter supports all related units in the length_small category, letting you convert between any combination with a single input.",
        },
        howItWorks: {
        ...
        considerations: {
          ...
          items: [
            { text: "10 mm = 1 cm | 25.4 mm = 1 inch | 304.8 mm = 1 foot", type: "info" },
      ...
      faqs: [
        ...
        { question: "What units are supported?", answer: "This converter supports all units in the length_small category: mm, cm, in, um, mil. Select any from the dropdown." },
    ...
    es: {
      "name": "Convertidor de MM a CM",
      "slug": "calculadora-milimetros-centimetros",
      "subtitle": "Convierte milímetros a centímetros para ingeniería, manufactura y uso cotidiano.",
      "breadcrumb": "MM a CM",
      "seo": {
        "title": "Convertidor de MM a CM - Herramienta de Conversión de Longitud",
        "description": "Convierte milímetros a centímetros instantáneamente. 10 mm = 1 cm. Esencial para ingeniería, manufactura y mediciones cotidianas.",
        "shortDescription": "Convierte milímetros a centímetros para ingeniería, manufactura y uso cotidiano",
        "keywords": [
          "mm a cm",
      ...
      "infoCards": {
        ...
        "tips": {
          ...
          "items": [
            "10 mm = 1 cm | 25.4 mm = 1 pulgada | 304.8 mm = 1 pie",
      ...
      "education": {
        "whatIs": {
          ...
          "content": "Convierte milímetros a centímetros instantáneamente. 10 mm = 1 cm. Esencial para ingeniería, manufactura y mediciones cotidianas. Este convertidor admite todas las unidades relacionadas en la categoría de longitud_pequeña, permitiéndote convertir entre cualquier combinación con una sola entrada."
        },
        "howItWorks": {
        ...
        "considerations": {
          ...
          "items": [
            {
              "text": "10 mm = 1 cm | 25.4 mm = 1 pulgada | 304.8 mm = 1 pie",
              "type": "info"
            },
            {
      ...
      "faqs": [
        ...
        },
        {
          ...
          "answer": "Este convertidor soporta todas las unidades en la categoría longitud_pequeña: mm, cm, in, um, mil. Selecciona cualquiera del menú desplegable."
        },
        {
    ...
    pt: {
      "name": "Conversor de MM para CM",
      "slug": "calculadora-milimetros-para-centimetros",
      "subtitle": "Converta milímetros para centímetros para engenharia, manufatura e uso cotidiano.",
      "breadcrumb": "MM para CM",
      "seo": {
        "title": "Conversor de MM para CM - Ferramenta de Conversão de Comprimento",
        "description": "Converta milímetros para centímetros instantaneamente. 10 mm = 1 cm. Essencial para engenharia, manufatura e medições do dia a dia.",
        "shortDescription": "Converta milímetros para centímetros para engenharia, manufatura e uso cotidiano",
        "keywords": [
          "mm para cm",
          ...
          "conversão métrica",
          "calculadora mm cm",
          "ferramenta de medição de precisão"
        ]
      },
      "inputs": {
        "amount": {
      ...
      "presets": {
        ...
        "twoFiftyFour": {
          "label": "📏 25,4 mm",
          "description": "25,4 mm (1 polegada)"
        }
      },
      "values": {},
      "formats": {
      ...
      "infoCards": {
        ...
        "tips": {
          ...
          "items": [
            "10 mm = 1 cm | 25,4 mm = 1 polegada | 304,8 mm = 1 pé",
            "Selecione qualquer unidade do menu suspenso para converter desta unidade.",
      ...
      "education": {
        "whatIs": {
          ...
          "content": "Converta milímetros para centímetros instantaneamente. 10 mm = 1 cm. Essencial para engenharia, manufatura e medições do dia a dia. Este conversor suporta todas as unidades relacionadas na categoria comprimento_pequeno, permitindo converter entre qualquer combinação com uma única entrada."
        },
        "howItWorks": {
        ...
        "considerations": {
          ...
          "items": [
            {
              "text": "10 mm = 1 cm | 25,4 mm = 1 polegada | 304,8 mm = 1 pé",
              "type": "info"
            },
            {
      ...
      "faqs": [
        ...
        },
        {
          ...
          "answer": "Este conversor suporta todas as unidades na categoria comprimento_pequeno: mm, cm, pol, um, mil. Selecione qualquer uma no menu suspenso."
        },
        {
    ...
    fr: {
      "name": "Convertisseur MM en CM",
      "slug": "calculateur-mm-vers-cm",
      "subtitle": "Convertissez les millimètres en centimètres pour l'ingénierie, la fabrication et l'usage quotidien.",
      "breadcrumb": "MM vers CM",
      "seo": {
        "title": "Convertisseur MM en CM - Outil de Conversion de Longueur",
        "description": "Convertissez les millimètres en centimètres instantanément. 10 mm = 1 cm. Essentiel pour l'ingénierie, la fabrication et les mesures quotidiennes.",
        "shortDescription": "Convertissez les millimètres en centimètres pour l'ingénierie, la fabrication et l'usage quotidien",
        "keywords": [
          "mm en cm",
      ...
      "presets": {
        ...
        "twoFiftyFour": {
          "label": "📏 25,4 mm",
          "description": "25,4 mm (1 pouce)"
        }
      },
      "values": {},
      "formats": {
        "summary": "Résultat de la conversion"
      },
      "infoCards": {
        "results": {
        ...
        "tips": {
          ...
          "items": [
            "10 mm = 1 cm | 25,4 mm = 1 pouce | 304,8 mm = 1 pied",
      ...
      "education": {
        "whatIs": {
          ...
          "content": "Convertissez les millimètres en centimètres instantanément. 10 mm = 1 cm. Essentiel pour l'ingénierie, la fabrication et les mesures quotidiennes. Ce convertisseur supporte toutes les unités liées dans la catégorie longueur_petite, vous permettant de convertir entre toute combinaison avec une seule saisie."
        },
        "howItWorks": {
        ...
        "considerations": {
          ...
          "items": [
            {
              "text": "10 mm = 1 cm | 25,4 mm = 1 pouce | 304,8 mm = 1 pied",
              "type": "info"
            },
            {
        ...
        "commonValues": {
          ...
          "items": [
            {
              "text": "Utilisez les présélections ci-dessus pour les quantités fréquemment utilisées.",
              "type": "info"
            },
            {
            ...
            {
              "text": "Supporte toutes les unités du groupe longueur_petite.",
              "type": "info"
            }
          ]
        },
      ...
      "faqs": [
        ...
        },
        {
          ...
          "answer": "Ce convertisseur supporte toutes les unités de la catégorie longueur_petite : mm, cm, po, μm, mil. Sélectionnez n'importe laquelle dans le menu déroulant."
        },
        {
    ...
    de: {
      "name": "MM zu CM Umrechner",
      "slug": "millimeter-zu-zentimeter-rechner",
      "subtitle": "Konvertieren Sie Millimeter in Zentimeter für Technik, Fertigung und den täglichen Gebrauch.",
      "breadcrumb": "MM zu CM",
      "seo": {
        "title": "MM zu CM Umrechner - Längenumrechnungstool",
        "description": "Konvertieren Sie Millimeter sofort in Zentimeter. 10 mm = 1 cm. Unverzichtbar für Technik, Fertigung und alltägliche Messungen.",
        "shortDescription": "Konvertieren Sie Millimeter in Zentimeter für Technik, Fertigung und den täglichen",
        "keywords": [
          "mm zu cm",
          "millimeter zu zentimeter",
          "längenumrechner",
          "metrische umrechnung",
          "mm cm rechner",
          "präzisionsmessungstool"
        ]
      },
      "inputs": {
        "amount": {
          "label": "Länge",
          "helpText": "Geben Sie die zu konvertierende Länge ein"
        }
      },
      "results": {
        "primary": {
      ...
      "infoCards": {
        ...
        "tips": {
          ...
          "items": [
            "10 mm = 1 cm | 25,4 mm = 1 Zoll | 304,8 mm = 1 Fuß",
            "Wählen Sie eine beliebige Einheit aus der Dropdown-Liste aus, um stattdessen von dieser Einheit zu konvertieren.",
      ...
      "education": {
        "whatIs": {
          ...
          "content": "Konvertieren Sie Millimeter sofort in Zentimeter. 10 mm = 1 cm. Unverzichtbar für Technik, Fertigung und alltägliche Messungen. Dieser Umrechner unterstützt alle verwandten Einheiten in der Kategorie kleine_Längen und ermöglicht es Ihnen, zwischen beliebigen Kombinationen mit einer einzigen Eingabe zu konvertieren."
        },
        "howItWorks": {
          "title": "So konvertieren Sie",
          "content": "Geben Sie Ihren Wert ein und wählen Sie die Ausgangseinheit aus der Dropdown-Liste. Der Umrechner zeigt sofort das Äquivalent in allen anderen Einheiten dieses Typs an. Alle Umrechnungen verwenden präzise Faktoren aus internationalen Standards (NIST/BIPM)."
        },
        "considerations": {
          "title": "Wichtige Hinweise",
          "items": [
            {
              "text": "10 mm = 1 cm | 25,4 mm = 1 Zoll | 304,8 mm = 1 Fuß",
              "type": "info"
            },
            {
              "text": "Wählen Sie eine beliebige Einheit aus der Dropdown-Liste, um die Ausgangseinheit zu ändern.",
              "type": "info"
            },
            {
        ...
        "commonValues": {
          ...
          "items": [
            ...
            {
              "text": "Unterstützt alle Einheiten in der Gruppe kleine_Längen.",
              "type": "info"
            }
          ]
        },
      ...
      "faqs": [
        ...
        },
        {
          ...
          "answer": "Dieser Umrechner unterstützt alle Einheiten in der Kategorie kleine_Längen: mm, cm, in, um, mil. Wählen Sie eine beliebige aus der Dropdown-Liste."
        },
        {
...
export function calculateMmToCm(data: {
  ...
  const allUnits = ["mm", "cm", "in", "um", "mil"];
