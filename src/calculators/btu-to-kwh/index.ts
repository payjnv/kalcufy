...
export const btuToKwhConfig: CalculatorConfigV4 = {
  id: "btu-to-kwh",
  version: "4.0",
  category: "conversion",
  icon: "🔥",
  ...
  presets: [
    { id: "tenThousand", icon: "🔥", values: { amount: 10000 } },
    { id: "fifty", icon: "❄️", values: { amount: 50000 } },
    { id: "hundred", icon: "🏠", values: { amount: 100000 } },
  ],
  ...
  t: {
    en: {
      ...
      breadcrumb: "BTU to kWh",

      seo: {
        title: "BTU to kWh Converter - Energy Conversion Tool",
        description: "Convert BTU to kilowatt-hours for HVAC sizing, energy costs, and heating calculations. 3,412 BTU = 1 kWh.",
        shortDescription: "Convert BTU to kilowatt-hours for HVAC, energy costs, and heating calculations.",
      ...
      presets: {
        tenThousand: { label: "🔥 10,000 BTU", description: "10,000 BTU (2.93 kWh)" },
        fifty: { label: "❄️ 50,000 BTU", description: "50,000 BTU (14.65 kWh)" },
        hundred: { label: "🏠 100,000 BTU", description: "100,000 BTU (furnace)" },
      },
      ...
      infoCards: {
        ...
        tips: {
          ...
          items: [
            "3,412 BTU = 1 kWh | Divide BTU by 3,412 to get kWh",
      ...
      education: {
        whatIs: {
          ...
          content: "Convert BTU to kilowatt-hours for HVAC sizing, energy costs, and heating calculations. 3,412 BTU = 1 kWh. This converter supports all related units in the energy category, letting you convert between any combination with a single input.",
        },
        howItWorks: {
        ...
        considerations: {
          ...
          items: [
            { text: "3,412 BTU = 1 kWh | Divide BTU by 3,412 to get kWh", type: "info" },
      ...
      faqs: [
        ...
        { question: "What units are supported?", answer: "This converter supports all units in the energy category: BTU, kWh, J, kJ, MJ, Wh, kcal. Select any from the dropdown." },
    ...
    es: {
      "name": "Convertidor de BTU a kWh",
      "slug": "calculadora-btu-a-kwh",
      "subtitle": "Convierte BTU a kilovatios-hora para HVAC, costos energéticos y cálculos de calefacción.",
      "breadcrumb": "BTU a kWh",
      "seo": {
        "title": "Convertidor de BTU a kWh - Herramienta de Conversión de Energía",
        "description": "Convierte BTU a kilovatios-hora para dimensionamiento HVAC, costos energéticos y cálculos de calefacción. 3,412 BTU = 1 kWh.",
        "shortDescription": "Convierte BTU a kilovatios-hora para HVAC, costos energéticos y cálculos de calefacción.",
        "keywords": [
          "btu a kwh",
          "btu a kilovatios hora",
          "convertidor energía",
          "dimensionamiento hvac",
          "calculadora calefacción",
          "conversión costo energético"
        ]
      },
      "calculator": {
      ...
      "inputs": {
        "amount": {
          "label": "Energía",
          "helpText": "Ingrese la energía a convertir"
        }
      },
      "results": {
        "primary": {
      ...
      "presets": {
        ...
        "fifty": {
          "label": "❄️ 50,000 BTU",
          "description": "50,000 BTU (14.65 kWh)"
        },
        "hundred": {
          "label": "🏠 100,000 BTU",
          "description": "100,000 BTU (caldera)"
        }
      },
      "values": {},
      "formats": {
      ...
      "infoCards": {
        ...
        "tips": {
          ...
          "items": [
            "3,412 BTU = 1 kWh | Divida BTU por 3,412 para obtener kWh",
            ...
            "Use preestablecidos para valores de conversión comunes."
          ]
        }
      },
      "education": {
        "whatIs": {
          ...
          "content": "Convierte BTU a kilovatios-hora para dimensionamiento HVAC, costos energéticos y cálculos de calefacción. 3,412 BTU = 1 kWh. Este convertidor admite todas las unidades relacionadas en la categoría de energía, permitiéndole convertir entre cualquier combinación con una sola entrada."
        },
        "howItWorks": {
        ...
        "considerations": {
          ...
          "items": [
            {
              "text": "3,412 BTU = 1 kWh | Divida BTU por 3,412 para obtener kWh",
              "type": "info"
            },
            {
        ...
        "commonValues": {
          ...
          "items": [
            {
              "text": "Use preestablecidos arriba para cantidades frecuentemente usadas.",
              "type": "info"
            },
            {
          ...
          "examples": [
            {
              ...
              "steps": [
                ...
                "Lea resultado en unidad objetivo",
            ...
            },
            {
              ...
              "steps": [
                "Cambie el menú desplegable a la unidad objetivo",
                "Ingrese su valor",
      ...
      "faqs": [
        ...
        },
        {
          ...
          "answer": "Este convertidor admite todas las unidades en la categoría de energía: BTU, kWh, J, kJ, MJ, Wh, kcal. Seleccione cualquiera del menú desplegable."
        },
        {
          "question": "¿Esto funciona en móvil?",
          "answer": "Sí, este convertidor es completamente responsive y funciona en cualquier dispositivo — teléfono, tablet o computadora."
        },
        {
    ...
    pt: {
      "name": "Conversor BTU para kWh",
      "slug": "calculadora-btu-para-kwh",
      "subtitle": "Converta BTU para quilowatt-hora para cálculos de HVAC, custos energéticos e aquecimento.",
      "breadcrumb": "BTU para kWh",
      "seo": {
        "title": "Conversor BTU para kWh - Ferramenta de Conversão de Energia",
        "description": "Converta BTU para quilowatt-hora para dimensionamento de HVAC, custos energéticos e cálculos de aquecimento. 3.412 BTU = 1 kWh.",
        "shortDescription": "Converta BTU para quilowatt-hora para cálculos de HVAC, custos energéticos e aquecimento.",
        "keywords": [
          "btu para kwh",
          "btu para quilowatt hora",
          "conversor energia",
          "dimensionamento hvac",
          "calculadora aquecimento",
          "conversão custo energia"
        ]
      },
      "inputs": {
        "amount": {
      ...
      "presets": {
        ...
        "hundred": {
          "label": "🏠 100.000 BTU",
          "description": "100.000 BTU (fornalha)"
        }
      },
      "values": {},
      "formats": {
      ...
      "infoCards": {
        ...
        "tips": {
          ...
          "items": [
            "3.412 BTU = 1 kWh | Divida BTU por 3.412 para obter kWh",
      ...
      "education": {
        "whatIs": {
          ...
          "content": "Converta BTU para quilowatt-hora para dimensionamento de HVAC, custos energéticos e cálculos de aquecimento. 3.412 BTU = 1 kWh. Este conversor suporta todas as unidades relacionadas na categoria energia, permitindo converter entre qualquer combinação com uma única entrada."
        },
        "howItWorks": {
        ...
        "considerations": {
          ...
          "items": [
            {
              "text": "3.412 BTU = 1 kWh | Divida BTU por 3.412 para obter kWh",
              "type": "info"
            },
            {
        ...
        "commonValues": {
          ...
          "items": [
            {
              "text": "Use predefinições acima para valores frequentemente usados.",
              "type": "info"
            },
            {
      ...
      "faqs": [
        ...
        },
        {
          ...
          "answer": "Este conversor suporta todas as unidades na categoria energia: BTU, kWh, J, kJ, MJ, Wh, kcal. Selecione qualquer uma no menu suspenso."
        },
        {
    ...
    fr: {
      "name": "Convertisseur BTU vers kWh",
      "slug": "calculateur-conversion-btu-kwh",
      "subtitle": "Convertissez les BTU en kilowattheures pour les calculs CVC, coûts énergétiques et chauffage.",
      "breadcrumb": "BTU vers kWh",
      "seo": {
        "title": "Convertisseur BTU vers kWh - Outil de Conversion Énergétique",
        "description": "Convertissez les BTU en kilowattheures pour le dimensionnement CVC, coûts énergétiques et calculs de chauffage. 3 412 BTU = 1 kWh.",
        "shortDescription": "Convertissez les BTU en kilowattheures pour les calculs CVC, coûts énergétiques et chauffage.",
        "keywords": [
          "btu vers kwh",
          "btu vers kilowattheures",
          "convertisseur énergie",
          "dimensionnement cvc",
          "calculateur chauffage",
          "conversion coût énergétique"
        ]
      },
      "calculator": {
      ...
      "inputs": {
        "amount": {
          "label": "Énergie",
          "helpText": "Saisissez l'énergie à convertir"
        }
      },
      "results": {
        "primary": {
      ...
      "presets": {
        ...
        "hundred": {
          "label": "🏠 100 000 BTU",
          "description": "100 000 BTU (chaudière)"
        }
      },
      "values": {},
      "formats": {
      ...
      "infoCards": {
        ...
        "tips": {
          ...
          "items": [
            "3 412 BTU = 1 kWh | Divisez les BTU par 3 412 pour obtenir les kWh",
            "Sélectionnez n'importe quelle unité dans le menu déroulant pour convertir à partir de cette unité.",
            "Les résultats se mettent à jour instantanément lors de la saisie.",
      ...
      "education": {
        "whatIs": {
          ...
          "content": "Convertissez les BTU en kilowattheures pour le dimensionnement CVC, les coûts énergétiques et les calculs de chauffage. 3 412 BTU = 1 kWh. Ce convertisseur prend en charge toutes les unités associées dans la catégorie énergie, vous permettant de convertir entre toute combinaison avec une seule saisie."
        },
        "howItWorks": {
        ...
        "considerations": {
          ...
          "items": [
            {
              "text": "3 412 BTU = 1 kWh | Divisez les BTU par 3 412 pour obtenir les kWh",
              "type": "info"
            },
            {
        ...
        "commonValues": {
          ...
          "items": [
            ...
            {
              "text": "Tous les résultats se mettent à jour en temps réel lors de la saisie.",
              "type": "info"
            },
            {
      ...
      "faqs": [
        ...
        },
        {
          ...
          "answer": "Ce convertisseur prend en charge toutes les unités de la catégorie énergie : BTU, kWh, J, kJ, MJ, Wh, kcal. Sélectionnez-en une dans le menu déroulant."
        },
        {
          "question": "Cela fonctionne-t-il sur mobile ?",
          "answer": "Oui, ce convertisseur est entièrement responsive et fonctionne sur tout appareil — téléphone, tablette ou ordinateur."
        },
        {
          "question": "Puis-je partager mon résultat de conversion ?",
          "answer": "Oui ! Utilisez le bouton Partager les Résultats pour générer un lien avec votre conversion exacte que vous pouvez envoyer à quiconque."
        },
        {
    ...
    de: {
      "name": "BTU zu kWh Umrechner",
      "slug": "btu-zu-kwh-umrechner",
      "subtitle": "Rechnen Sie BTU in Kilowattstunden für HLK-, Energiekosten- und Heizungsberechnungen um.",
      "breadcrumb": "BTU zu kWh",
      "seo": {
        "title": "BTU zu kWh Umrechner - Energieumrechnungs-Tool",
        "description": "Rechnen Sie BTU in Kilowattstunden für HLK-Dimensionierung, Energiekosten und Heizungsberechnungen um. 3.412 BTU = 1 kWh.",
        "shortDescription": "Rechnen Sie BTU in Kilowattstunden für HLK-, Energiekosten- und Heizungsberechnungen um.",
        "keywords": [
          "btu zu kwh",
          "btu zu kilowattstunden",
          "energieumrechner",
          "hlk dimensionierung",
          "heizungsrechner",
          "energiekostenumrechnung"
        ]
      },
      "inputs": {
        "amount": {
      ...
      "presets": {
        ...
        "hundred": {
          "label": "🏠 100.000 BTU",
          "description": "100.000 BTU (Heizkessel)"
        }
      },
      "values": {},
      "formats": {
      ...
      "infoCards": {
        ...
        "tips": {
          ...
          "items": [
            "3.412 BTU = 1 kWh | Teilen Sie BTU durch 3.412, um kWh zu erhalten",
            "Wählen Sie eine beliebige Einheit aus der Dropdown-Liste, um von dieser Einheit zu konvertieren.",
      ...
      "education": {
        "whatIs": {
          ...
          "content": "Rechnen Sie BTU in Kilowattstunden für HLK-Dimensionierung, Energiekosten und Heizungsberechnungen um. 3.412 BTU = 1 kWh. Dieser Umrechner unterstützt alle verwandten Einheiten in der Energiekategorie und ermöglicht es Ihnen, zwischen jeder Kombination mit einer einzigen Eingabe zu konvertieren."
        },
        "howItWorks": {
          "title": "So rechnen Sie um",
          "content": "Geben Sie Ihren Wert ein und wählen Sie die Quelleinheit aus der Dropdown-Liste. Der Umrechner zeigt sofort das Äquivalent in allen anderen Einheiten dieses Typs. Alle Umrechnungen verwenden präzise Faktoren internationaler Standards (NIST/BIPM)."
        },
        "considerations": {
          "title": "Wichtige Hinweise",
          "items": [
            {
              "text": "3.412 BTU = 1 kWh | Teilen Sie BTU durch 3.412, um kWh zu erhalten",
              "type": "info"
            },
            {
            ...
            {
              "text": "Setzen Sie diese Seite als Lesezeichen für schnellen Zugriff auf diesen Umrechner.",
              "type": "info"
            }
          ]
        },
      ...
      "faqs": [
        ...
        },
        {
          ...
          "answer": "Dieser Umrechner unterstützt alle Einheiten in der Energiekategorie: BTU, kWh, J, kJ, MJ, Wh, kcal. Wählen Sie eine aus der Dropdown-Liste."
        },
        {
...
export function calculateBtuToKwh(data: {
  ...
  const fromUnit = fieldUnits.amount || "BTU";
  ...
  const allUnits = ["BTU", "kWh", "J", "kJ", "MJ", "Wh", "kcal"];
