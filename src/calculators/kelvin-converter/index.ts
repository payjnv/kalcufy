...
export const kelvinConverterConfig: CalculatorConfigV4 = {
  id: "kelvin-converter",
  version: "4.0",
  category: "conversion",
  icon: "🌡️",
  ...
  presets: [
    { id: "zero", icon: "❄️", values: { amount: 0 } },
    { id: "water", icon: "💧", values: { amount: 373.15 } },
    { id: "room", icon: "🏠", values: { amount: 293.15 } },
  ],

  t: {
    en: {
      name: "Kelvin Converter",
      slug: "kelvin-converter",
      subtitle: "Convert Kelvin to Celsius, Fahrenheit, and Rankine for science and engineering.",
      breadcrumb: "Kelvin",

      seo: {
        title: "Kelvin Converter - Temperature Conversion Tool",
        description: "Convert Kelvin to Celsius, Fahrenheit, and Rankine. Essential for science, physics, and engineering calculations.",
        shortDescription: "Convert Kelvin to Celsius, Fahrenheit, and Rankine for science and engineering.",
      ...
      calculator: { yourInformation: "Enter Temperature" },
      ui: { yourInformation: "Enter Temperature", calculate: "Convert", reset: "Reset", results: "Results" },

      inputs: {
        amount: { label: "Temperature", helpText: "Enter the temperature to convert" },
      },
      ...
      presets: {
        zero: { label: "❄️ 0 K", description: "0 K (absolute zero)" },
        water: { label: "💧 373.15 K", description: "373.15 K (100°C boiling)" },
        room: { label: "🏠 293.15 K", description: "293.15 K (20°C room temp)" },
      },
      ...
      education: {
        whatIs: {
          ...
          content: "Convert Kelvin to Celsius, Fahrenheit, and Rankine. Essential for science, physics, and engineering calculations. This converter supports all related units in the temperature category, letting you convert between any combination with a single input.",
        },
        howItWorks: {
        ...
        considerations: {
          ...
          items: [
            { text: "0 K = -273.15°C = -459.67°F (absolute zero)", type: "info" },
        ...
        commonValues: {
          ...
          items: [
            ...
            { text: "Supports all units in the temperature group.", type: "info" },
          ],
        },
        examples: {
      ...
      faqs: [
        ...
        { question: "What units are supported?", answer: "This converter supports all units in the temperature category: K, C, F, R. Select any from the dropdown." },
    ...
    es: {
      "name": "Convertidor de Kelvin",
      "slug": "calculadora-convertidor-kelvin",
      "subtitle": "Convierte Kelvin a Celsius, Fahrenheit y Rankine para ciencia e ingeniería.",
      "breadcrumb": "Kelvin",
      "seo": {
        "title": "Convertidor de Kelvin - Herramienta de Conversión de Temperatura",
        "description": "Convierte Kelvin a Celsius, Fahrenheit y Rankine. Esencial para cálculos de ciencia, física e ingeniería.",
        "shortDescription": "Convierte Kelvin a Celsius, Fahrenheit y Rankine para ciencia e ingeniería.",
        "keywords": [
          "convertidor kelvin",
          "kelvin a celsius",
          "kelvin a fahrenheit",
          ...
          "K a C",
          "calculadora temperatura cientifica"
        ]
      },
      "inputs": {
        "amount": {
          "label": "Temperatura",
          "helpText": "Ingrese la temperatura a convertir"
        }
      },
      "results": {
        "primary": {
      ...
      "presets": {
        "zero": {
          "label": "❄️ 0 K",
          "description": "0 K (cero absoluto)"
        },
        "water": {
          "label": "💧 373.15 K",
          "description": "373.15 K (100°C ebullición)"
        },
        "room": {
          "label": "🏠 293.15 K",
          "description": "293.15 K (20°C temp. ambiente)"
        }
      },
      "values": {},
      "formats": {
      ...
      "infoCards": {
        ...
        "tips": {
          ...
          "items": [
            ...
            "Usa los valores preestablecidos para conversiones comunes."
          ]
        }
      },
      "education": {
        "whatIs": {
          ...
          "content": "Convierte Kelvin a Celsius, Fahrenheit y Rankine. Esencial para cálculos de ciencia, física e ingeniería. Este convertidor soporta todas las unidades relacionadas en la categoría de temperatura, permitiéndote convertir entre cualquier combinación con una sola entrada."
        },
        "howItWorks": {
        ...
        "considerations": {
          ...
          "items": [
            {
              "text": "0 K = -273.15°C = -459.67°F (cero absoluto)",
              "type": "info"
            },
            {
            ...
            {
              "text": "Marca esta página como favorito para acceso rápido a este convertidor.",
              "type": "info"
            }
          ]
        },
        "commonValues": {
          ...
          "items": [
            {
              "text": "Usa los valores preestablecidos arriba para cantidades frecuentemente usadas.",
              "type": "info"
            },
            {
            ...
            {
              "text": "Soporta todas las unidades en el grupo de temperatura.",
              "type": "info"
            }
          ]
        },
      ...
      "faqs": [
        ...
        },
        {
          ...
          "answer": "Este convertidor soporta todas las unidades en la categoría de temperatura: K, C, F, R. Selecciona cualquiera del menú desplegable."
        },
        {
    ...
    pt: {
      "name": "Conversor de Kelvin",
      "slug": "calculadora-conversor-kelvin",
      "subtitle": "Converta Kelvin para Celsius, Fahrenheit e Rankine para ciência e engenharia.",
      "breadcrumb": "Kelvin",
      "seo": {
        "title": "Conversor de Kelvin - Ferramenta de Conversão de Temperatura",
        "description": "Converta Kelvin para Celsius, Fahrenheit e Rankine. Essencial para cálculos de ciência, física e engenharia.",
        "shortDescription": "Converta Kelvin para Celsius, Fahrenheit e Rankine para ciência e engenharia.",
        "keywords": [
          "conversor kelvin",
          "kelvin para celsius",
          ...
          "K para C",
          "calculadora temperatura científica"
        ]
      },
      "inputs": {
        "amount": {
          "label": "Temperatura",
          "helpText": "Digite a temperatura para converter"
        }
      },
      "results": {
        "primary": {
      ...
      "presets": {
        "zero": {
          "label": "❄️ 0 K",
          "description": "0 K (zero absoluto)"
        },
        "water": {
          "label": "💧 373,15 K",
          "description": "373,15 K (100°C fervura)"
        },
        "room": {
          "label": "🏠 293,15 K",
          "description": "293,15 K (20°C temp. ambiente)"
      ...
      "infoCards": {
        ...
        "tips": {
          ...
          "items": [
            "0 K = -273,15°C = -459,67°F (zero absoluto)",
      ...
      "education": {
        "whatIs": {
          ...
          "content": "Converta Kelvin para Celsius, Fahrenheit e Rankine. Essencial para cálculos de ciência, física e engenharia. Este conversor suporta todas as unidades relacionadas na categoria temperatura, permitindo converter entre qualquer combinação com uma única entrada."
        },
        "howItWorks": {
        ...
        "considerations": {
          ...
          "items": [
            {
              "text": "0 K = -273,15°C = -459,67°F (zero absoluto)",
              "type": "info"
            },
            {
        ...
        "commonValues": {
          ...
          "items": [
            ...
            {
              "text": "Suporta todas as unidades do grupo temperatura.",
              "type": "info"
            }
          ]
        },
      ...
      "faqs": [
        ...
        },
        {
          ...
          "answer": "Este conversor suporta todas as unidades na categoria temperatura: K, C, F, R. Selecione qualquer uma no menu suspenso."
        },
        {
    ...
    fr: {
      "name": "Convertisseur Kelvin",
      "slug": "calculateur-convertisseur-kelvin",
      "subtitle": "Convertissez les Kelvin en Celsius, Fahrenheit et Rankine pour la science et l'ingénierie.",
      "breadcrumb": "Kelvin",
      "seo": {
        "title": "Convertisseur Kelvin - Outil de Conversion de Température",
        "description": "Convertissez les Kelvin en Celsius, Fahrenheit et Rankine. Essentiel pour les calculs scientifiques, physiques et d'ingénierie.",
        "shortDescription": "Convertissez les Kelvin en Celsius, Fahrenheit et Rankine pour la science et l'ingénierie.",
        "keywords": [
          "convertisseur kelvin",
          "kelvin vers celsius",
          "kelvin vers fahrenheit",
          "convertisseur température",
          "K vers C",
          "calculateur température scientifique"
        ]
      },
      "inputs": {
        "amount": {
          "label": "Température",
          "helpText": "Entrez la température à convertir"
        }
      },
      "results": {
        "primary": {
      ...
      "presets": {
        "zero": {
          "label": "❄️ 0 K",
          "description": "0 K (zéro absolu)"
        },
        "water": {
          "label": "💧 373,15 K",
          "description": "373,15 K (100°C ébullition)"
        },
        "room": {
          "label": "🏠 293,15 K",
          "description": "293,15 K (20°C température ambiante)"
        }
      },
      "values": {},
      "formats": {
      ...
      "infoCards": {
        ...
        "tips": {
          ...
          "items": [
            "0 K = -273,15°C = -459,67°F (zéro absolu)",
      ...
      "education": {
        "whatIs": {
          ...
          "content": "Convertissez les Kelvin en Celsius, Fahrenheit et Rankine. Essentiel pour les calculs scientifiques, physiques et d'ingénierie. Ce convertisseur prend en charge toutes les unités connexes dans la catégorie température, vous permettant de convertir entre n'importe quelle combinaison avec une seule saisie."
        },
        "howItWorks": {
        ...
        "considerations": {
          ...
          "items": [
            {
              "text": "0 K = -273,15°C = -459,67°F (zéro absolu)",
              "type": "info"
            },
            {
        ...
        "commonValues": {
          ...
          "items": [
            ...
            {
              "text": "Prend en charge toutes les unités du groupe température.",
              "type": "info"
            }
          ]
        },
      ...
      "faqs": [
        ...
        },
        {
          ...
          "answer": "Ce convertisseur prend en charge toutes les unités de la catégorie température : K, C, F, R. Sélectionnez n'importe laquelle dans le menu déroulant."
        },
        {
    ...
    de: {
      "name": "Kelvin Umrechner",
      "slug": "kelvin-umrechner-rechner",
      "subtitle": "Kelvin in Celsius, Fahrenheit und Rankine für Wissenschaft und Technik umrechnen.",
      "breadcrumb": "Kelvin",
      "seo": {
        "title": "Kelvin Umrechner - Temperatur Umrechnungstool",
        "description": "Kelvin in Celsius, Fahrenheit und Rankine umrechnen. Unverzichtbar für Wissenschaft, Physik und technische Berechnungen.",
        "shortDescription": "Kelvin in Celsius, Fahrenheit und Rankine für Wissenschaft und Technik umrechnen.",
        "keywords": [
          "kelvin umrechner",
          "kelvin in celsius",
          ...
          "K in C",
          "wissenschaft temperatur rechner"
        ]
      },
      "inputs": {
        "amount": {
          "label": "Temperatur",
          "helpText": "Geben Sie die umzurechnende Temperatur ein"
        }
      },
      "results": {
        "primary": {
      ...
      "presets": {
        "zero": {
          "label": "❄️ 0 K",
          "description": "0 K (absoluter Nullpunkt)"
        },
        "water": {
          "label": "💧 373,15 K",
          "description": "373,15 K (100°C Siedepunkt)"
        },
        "room": {
          "label": "🏠 293,15 K",
          "description": "293,15 K (20°C Raumtemperatur)"
        }
      },
      "values": {},
      "formats": {
      ...
      "infoCards": {
        ...
        "tips": {
          ...
          "items": [
            "0 K = -273,15°C = -459,67°F (absoluter Nullpunkt)",
      ...
      "education": {
        "whatIs": {
          ...
          "content": "Kelvin in Celsius, Fahrenheit und Rankine umrechnen. Unverzichtbar für Wissenschaft, Physik und technische Berechnungen. Dieser Umrechner unterstützt alle verwandten Einheiten in der Temperaturkategorie und ermöglicht die Umrechnung zwischen beliebigen Kombinationen mit einer einzigen Eingabe."
        },
        "howItWorks": {
          "title": "So rechnen Sie um",
          "content": "Geben Sie Ihren Wert ein und wählen Sie die Quelleinheit aus dem Dropdown-Menü. Der Umrechner zeigt sofort den entsprechenden Wert in allen anderen Einheiten dieses Typs an. Alle Umrechnungen verwenden präzise Faktoren internationaler Standards (NIST/BIPM)."
        },
        "considerations": {
          "title": "Wichtige Hinweise",
          "items": [
            {
              "text": "0 K = -273,15°C = -459,67°F (absoluter Nullpunkt)",
              "type": "info"
            },
            {
            ...
            {
              "text": "Setzen Sie ein Lesezeichen auf diese Seite für schnellen Zugang zu diesem Umrechner.",
              "type": "info"
            }
          ]
        },
        "commonValues": {
          ...
          "items": [
            ...
            {
              "text": "Unterstützt alle Einheiten in der Temperaturgruppe.",
              "type": "info"
            }
          ]
        },
      ...
      "faqs": [
        {
          ...
          "answer": "Alle Umrechnungen verwenden exakte Faktoren der internationalen Standards NIST und BIPM. Die Ergebnisse sind auf mindestens 6 signifikante Stellen genau."
        },
        {
          "question": "Kann ich in umgekehrter Richtung umrechnen?",
          "answer": "Ja! Ändern Sie einfach die Einheit im Dropdown-Menü, um von beliebigen Einheiten in alle anderen umzurechnen. Der Umrechner ist vollständig bidirektional."
        },
        {
          "question": "Welche Einheiten werden unterstützt?",
          "answer": "Dieser Umrechner unterstützt alle Einheiten in der Temperaturkategorie: K, C, F, R. Wählen Sie beliebige aus dem Dropdown-Menü."
        },
        {
          "question": "Funktioniert das auf Mobilgeräten?",
          "answer": "Ja, dieser Umrechner ist vollständig responsiv und funktioniert auf jedem Gerät — Smartphone, Tablet oder Desktop."
        },
        {
...
export function calculateKelvinConverter(data: {
  ...
  const fromUnit = fieldUnits.amount || "K";

  if (amount === undefined || amount === null || amount < 0) {
    return { values: {}, formatted: {}, summary: "", isValid: false };
  }

  const unitGroup = UNIT_REGISTRY["temperature"];
  ...
  for (const unit of units) {
    try {
      const converted = convert(amount, fromUnit, unit.id, "temperature");
...
export default kelvinConverterConfig;
