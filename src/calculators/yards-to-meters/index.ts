...
export const yardsToMetersConfig: CalculatorConfigV4 = {
  id: "yards-to-meters",
  version: "4.0",
  category: "conversion",
  icon: "📏",
  ...
  presets: [
    ...
    { id: "thousand", icon: "🏃", values: { amount: 1760 } },
  ],
  ...
  t: {
    en: {
      ...
      breadcrumb: "Yards to Meters",

      seo: {
        title: "Yards to Meters Converter - Length Conversion Tool",
        description: "Convert yards to meters instantly. Essential for sports fields, fabric, construction, and international measurements.",
        shortDescription: "Convert yards to meters for sports, fabric, construction, and international meas",
      ...
      presets: {
        one: { label: "📏 1 yd", description: "1 yd (0.914 m)" },
        hundred: { label: "🏈 100 yd football field", description: "100 yd football field" },
        thousand: { label: "🏃 1760 yd = 1 mile", description: "1760 yd = 1 mile" },
      },
      ...
      infoCards: {
        ...
        tips: {
          ...
          items: [
            "Quick estimate: 1 yard ≈ 0.914 meters (slightly less than 1 meter)",
      ...
      education: {
        whatIs: {
          ...
          content: "Convert yards to meters instantly. Essential for sports fields, fabric, construction, and international measurements. This converter supports all related units in the length category, letting you convert between any combination with a single input.",
        },
        howItWorks: {
        ...
        considerations: {
          ...
          items: [
            { text: "Quick estimate: 1 yard ≈ 0.914 meters (slightly less than 1 meter)", type: "info" },
      ...
      faqs: [
        ...
        { question: "What units are supported?", answer: "This converter supports all units in the length category: yd, m, ft, in, cm, km, mi. Select any from the dropdown." },
    ...
    es: {
      "name": "Convertidor de Yardas a Metros",
      "slug": "calculadora-yardas-a-metros",
      "subtitle": "Convierte yardas a metros para deportes, telas, construcción y medidas internacionales.",
      "breadcrumb": "Yardas a Metros",
      "seo": {
        "title": "Convertidor de Yardas a Metros - Herramienta de Conversión de Longitud",
        "description": "Convierte yardas a metros al instante. Esencial para campos deportivos, telas, construcción y medidas internacionales.",
        "shortDescription": "Convierte yardas a metros para deportes, telas, construcción y medidas internacionales",
        "keywords": [
          "yardas a metros",
          "yd a m",
          "convertidor yarda metro",
          "conversión campo fútbol",
          "yardas tela a metros",
          "conversión longitud"
        ]
      },
      "inputs": {
        "amount": {
          "label": "Longitud",
          "helpText": "Ingrese la longitud a convertir"
        }
      },
      "results": {
        "primary": {
      ...
      "presets": {
        "one": {
          "label": "📏 1 yd",
          "description": "1 yd (0,914 m)"
        },
        "hundred": {
          "label": "🏈 100 yd campo de fútbol",
          "description": "100 yd campo de fútbol americano"
        },
        "thousand": {
          "label": "🏃 1760 yd = 1 milla",
          "description": "1760 yd = 1 milla"
        }
      },
      "values": {},
      "formats": {
      ...
      "infoCards": {
        ...
        "tips": {
          ...
          "items": [
            "Estimación rápida: 1 yarda ≈ 0,914 metros (ligeramente menos de 1 metro)",
      ...
      "education": {
        "whatIs": {
          ...
          "content": "Convierte yardas a metros al instante. Esencial para campos deportivos, telas, construcción y medidas internacionales. Este convertidor admite todas las unidades relacionadas en la categoría de longitud, permitiéndote convertir entre cualquier combinación con una sola entrada."
        },
        "howItWorks": {
        ...
        "considerations": {
          ...
          "items": [
            {
              "text": "Estimación rápida: 1 yarda ≈ 0,914 metros (ligeramente menos de 1 metro)",
              "type": "info"
            },
            {
      ...
      "faqs": [
        ...
        },
        {
          ...
          "answer": "Este convertidor admite todas las unidades en la categoría de longitud: yd, m, ft, in, cm, km, mi. Selecciona cualquiera del menú desplegable."
        },
        {
    ...
    pt: {
      "name": "Conversor de Jardas para Metros",
      "slug": "calculadora-jardas-para-metros",
      "subtitle": "Converta jardas para metros para esportes, tecidos, construção e medições internacionais.",
      "breadcrumb": "Jardas para Metros",
      "seo": {
        "title": "Conversor de Jardas para Metros - Ferramenta de Conversão de Comprimento",
        "description": "Converta jardas para metros instantaneamente. Essencial para campos esportivos, tecidos, construção e medições internacionais.",
        "shortDescription": "Converta jardas para metros para esportes, tecidos, construção e medições internacionais",
        "keywords": [
          "jardas para metros",
          "yd para m",
          "conversor jarda metro",
          "conversão campo futebol",
          "jardas tecido para metros",
      ...
      "presets": {
        "one": {
          "label": "📏 1 jarda",
          "description": "1 jarda (0,914 m)"
        },
        "hundred": {
          "label": "🏈 100 jardas campo futebol",
          "description": "100 jardas campo futebol"
        },
        "thousand": {
          "label": "🏃 1760 jardas = 1 milha",
          "description": "1760 jardas = 1 milha"
        }
      },
      "values": {},
      "formats": {
      ...
      "infoCards": {
        ...
        "tips": {
          ...
          "items": [
            "Estimativa rápida: 1 jarda ≈ 0,914 metros (um pouco menos que 1 metro)",
      ...
      "education": {
        "whatIs": {
          ...
          "content": "Converta jardas para metros instantaneamente. Essencial para campos esportivos, tecidos, construção e medições internacionais. Este conversor suporta todas as unidades relacionadas na categoria de comprimento, permitindo converter entre qualquer combinação com uma única entrada."
        },
        "howItWorks": {
        ...
        "considerations": {
          ...
          "items": [
            {
              "text": "Estimativa rápida: 1 jarda ≈ 0,914 metros (um pouco menos que 1 metro)",
              "type": "info"
            },
            {
            ...
            {
              "text": "Favorite esta página para acesso rápido a este conversor.",
              "type": "info"
            }
          ]
        },
        "commonValues": {
          ...
          "items": [
            ...
            {
              "text": "Todos os resultados se atualizam em tempo real enquanto você digita.",
              "type": "info"
            },
            {
      ...
      "faqs": [
        ...
        },
        {
          ...
          "answer": "Este conversor suporta todas as unidades na categoria de comprimento: jardas, m, pés, pol, cm, km, milhas. Selecione qualquer uma no menu suspenso."
        },
        {
    ...
    fr: {
      "name": "Convertisseur Yards vers Mètres",
      "slug": "calculateur-yards-vers-metres",
      "subtitle": "Convertissez les yards en mètres pour le sport, les tissus, la construction et les mesures internationales.",
      "breadcrumb": "Yards vers Mètres",
      "seo": {
        "title": "Convertisseur Yards vers Mètres - Outil de Conversion de Longueur",
        "description": "Convertissez instantanément les yards en mètres. Essentiel pour les terrains de sport, les tissus, la construction et les mesures internationales.",
        "shortDescription": "Convertissez les yards en mètres pour le sport, les tissus, la construction et les mesures internationales",
        "keywords": [
          "yards vers mètres",
          "yd vers m",
          "convertisseur yard mètre",
          "conversion terrain de football",
          "yards de tissu vers mètres",
      ...
      "presets": {
        ...
        "hundred": {
          "label": "🏈 100 yd terrain de football",
          "description": "100 yd terrain de football"
        },
        "thousand": {
          "label": "🏃 1760 yd = 1 mile",
          "description": "1760 yd = 1 mile"
        }
      },
      "values": {},
      "formats": {
      ...
      "infoCards": {
        ...
        "tips": {
          ...
          "items": [
            "Estimation rapide : 1 yard ≈ 0,914 mètres (légèrement moins d'1 mètre)",
      ...
      "education": {
        "whatIs": {
          ...
          "content": "Convertissez instantanément les yards en mètres. Essentiel pour les terrains de sport, les tissus, la construction et les mesures internationales. Ce convertisseur prend en charge toutes les unités liées dans la catégorie longueur, vous permettant de convertir entre n'importe quelle combinaison avec une seule saisie."
        },
        "howItWorks": {
        ...
        "considerations": {
          ...
          "items": [
            {
              "text": "Estimation rapide : 1 yard ≈ 0,914 mètres (légèrement moins d'1 mètre)",
              "type": "info"
            },
            {
      ...
      "faqs": [
        ...
        },
        {
          ...
          "answer": "Ce convertisseur prend en charge toutes les unités de la catégorie longueur : yd, m, ft, in, cm, km, mi. Sélectionnez n'importe laquelle dans le menu déroulant."
        },
        {
    ...
    de: {
      "name": "Yards zu Meter Umrechner",
      "slug": "yards-zu-meter-rechner",
      "subtitle": "Rechnen Sie Yards in Meter um für Sport, Stoffe, Bauwesen und internationale Messungen.",
      "breadcrumb": "Yards zu Meter",
      "seo": {
        "title": "Yards zu Meter Umrechner - Längenumrechnung Tool",
        "description": "Rechnen Sie Yards sofort in Meter um. Unverzichtbar für Sportplätze, Stoffe, Bauwesen und internationale Messungen.",
        "shortDescription": "Rechnen Sie Yards in Meter um für Sport, Stoffe, Bauwesen und internationale Mess",
        "keywords": [
          "yards zu meter",
          "yd zu m",
          "yard meter umrechner",
          "footballfeld umrechnung",
          "stoff yards zu meter",
          "längenumrechnung"
        ]
      },
      "inputs": {
      ...
      "presets": {
        ...
        "hundred": {
          "label": "🏈 100 yd Footballfeld",
          "description": "100 yd Footballfeld"
        },
        "thousand": {
          "label": "🏃 1760 yd = 1 Meile",
          "description": "1760 yd = 1 Meile"
        }
      },
      "values": {},
      "formats": {
      ...
      "infoCards": {
        ...
        "tips": {
          ...
          "items": [
            "Schnelle Schätzung: 1 Yard ≈ 0,914 Meter (etwas weniger als 1 Meter)",
      ...
      "education": {
        "whatIs": {
          ...
          "content": "Rechnen Sie Yards sofort in Meter um. Unverzichtbar für Sportplätze, Stoffe, Bauwesen und internationale Messungen. Dieser Umrechner unterstützt alle verwandten Einheiten in der Längenkategorie und ermöglicht die Umrechnung zwischen beliebigen Kombinationen mit einer einzigen Eingabe."
        },
        "howItWorks": {
        ...
        "considerations": {
          ...
          "items": [
            {
              "text": "Schnelle Schätzung: 1 Yard ≈ 0,914 Meter (etwas weniger als 1 Meter)",
              "type": "info"
            },
            {
      ...
      "faqs": [
        ...
        },
        {
          ...
          "answer": "Dieser Umrechner unterstützt alle Einheiten in der Längenkategorie: yd, m, ft, in, cm, km, mi. Wählen Sie eine beliebige aus dem Dropdown."
        },
        {
...
export function calculateYardsToMeters(data: {
  ...
  const fromUnit = fieldUnits.amount || "yd";
  ...
  const allUnits = ["yd", "m", "ft", "in", "cm", "km", "mi"];
...
export default yardsToMetersConfig;
