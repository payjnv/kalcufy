...
export const mpgToKmPerLiterConfig: CalculatorConfigV4 = {
  ...
  presets: [
    { id: "city", icon: "🏙️", values: { amount: 25 } },
    { id: "highway", icon: "🛣️", values: { amount: 35 } },
    { id: "hybrid", icon: "⚡", values: { amount: 50 } },
  ],

  t: {
    en: {
      name: "MPG to KM/L Converter",
      slug: "mpg-to-km-per-liter",
      subtitle: "Convert MPG to KM/L and L/100km for international fuel economy comparisons.",
      breadcrumb: "MPG to KM/L",

      seo: {
        title: "MPG to KM/L Converter - Fuel Economy Conversion",
        description: "Convert miles per gallon to kilometers per liter for international fuel economy comparison. Includes L/100km.",
        shortDescription: "Convert MPG to KM/L and L/100km for international fuel economy comparisons.",
      ...
      calculator: { yourInformation: "Enter Fuel Economy" },
      ui: { yourInformation: "Enter Fuel Economy", calculate: "Convert", reset: "Reset", results: "Results" },

      inputs: {
        amount: { label: "Fuel Economy", helpText: "Enter the fuel economy to convert" },
      },
      ...
      presets: {
        city: { label: "🏙️ 25 mpg", description: "25 mpg (city car)" },
        highway: { label: "🛣️ 35 mpg", description: "35 mpg (efficient)" },
        hybrid: { label: "⚡ 50 mpg", description: "50 mpg (hybrid)" },
      },
      ...
      infoCards: {
        ...
        tips: {
          ...
          items: [
            "Quick estimate: divide MPG by 2.35 for km/L",
      ...
      education: {
        whatIs: {
          ...
          content: "Convert miles per gallon to kilometers per liter for international fuel economy comparison. Includes L/100km. This converter supports all related units in the fuel_economy category, letting you convert between any combination with a single input.",
        },
        howItWorks: {
        ...
        considerations: {
          ...
          items: [
            { text: "Quick estimate: divide MPG by 2.35 for km/L", type: "info" },
      ...
      faqs: [
        ...
        { question: "What units are supported?", answer: "This converter supports all units in the fuel_economy category: mpg_us, mpg_uk, kmL, L100km. Select any from the dropdown." },
    ...
    es: {
      "name": "Convertidor MPG a KM/L",
      "slug": "calculadora-mpg-a-kilometros-por-litro",
      "subtitle": "Convierte MPG a KM/L y L/100km para comparaciones internacionales de economía de combustible.",
      "breadcrumb": "MPG a KM/L",
      "seo": {
        "title": "Convertidor MPG a KM/L - Conversión de Economía de Combustible",
        "description": "Convierte millas por galón a kilómetros por litro para comparación internacional de economía de combustible. Incluye L/100km.",
        "shortDescription": "Convierte MPG a KM/L y L/100km para comparaciones internacionales de economía de combustible.",
        "keywords": [
          "mpg a km/l",
          "convertidor economía combustible",
          "millas por galón a km por litro",
          "convertidor consumo gasolina",
          "convertidor consumo combustible",
          "convertidor mpg"
        ]
      },
      "calculator": {
      ...
      "inputs": {
        "amount": {
          ...
          "helpText": "Ingresa la economía de combustible a convertir"
        }
      },
      "results": {
        "primary": {
      ...
      "presets": {
        "city": {
          "label": "🏙️ 25 mpg",
          "description": "25 mpg (auto ciudad)"
        },
        "highway": {
          "label": "🛣️ 35 mpg",
          "description": "35 mpg (eficiente)"
        },
        "hybrid": {
          "label": "⚡ 50 mpg",
          "description": "50 mpg (híbrido)"
        }
      },
      "values": {},
      "formats": {
      ...
      "infoCards": {
        ...
        "tips": {
          ...
          "items": [
            "Estimación rápida: divide MPG por 2.35 para km/L",
      ...
      "education": {
        "whatIs": {
          ...
          "content": "Convierte millas por galón a kilómetros por litro para comparación internacional de economía de combustible. Incluye L/100km. Este convertidor soporta todas las unidades relacionadas en la categoría de economía de combustible, permitiéndote convertir entre cualquier combinación con una sola entrada."
        },
        "howItWorks": {
        ...
        "considerations": {
          ...
          "items": [
            {
              "text": "Estimación rápida: divide MPG por 2.35 para km/L",
              "type": "info"
            },
            {
            ...
            {
              "text": "Guarda esta página en favoritos para acceso rápido al convertidor.",
              "type": "info"
            }
          ]
        },
      ...
      "faqs": [
        ...
        },
        {
          ...
          "answer": "Este convertidor soporta todas las unidades en la categoría de economía de combustible: mpg_us, mpg_uk, kmL, L100km. Selecciona cualquiera del menú desplegable."
        },
        {
    ...
    pt: {
      "name": "Conversor MPG para KM/L",
      "slug": "calculadora-mpg-para-km-por-litro",
      "subtitle": "Converta MPG para KM/L e L/100km para comparações internacionais de economia de combustível.",
      "breadcrumb": "MPG para KM/L",
      "seo": {
        "title": "Conversor MPG para KM/L - Conversão de Economia de Combustível",
        "description": "Converta milhas por galão para quilômetros por litro para comparação internacional de economia de combustível. Inclui L/100km.",
        "shortDescription": "Converta MPG para KM/L e L/100km para comparações internacionais de economia de combustível.",
        "keywords": [
          "mpg para km/l",
          "conversor economia combustível",
          "milhas por galão para km por litro",
          "conversor consumo gasolina",
          "conversor consumo combustível",
          "conversor mpg"
        ]
      },
      "inputs": {
        "amount": {
          ...
          "helpText": "Digite a economia de combustível para converter"
        }
      },
      "results": {
        "primary": {
      ...
      "presets": {
        "city": {
          "label": "🏙️ 25 mpg",
          "description": "25 mpg (carro urbano)"
        },
        "highway": {
          "label": "🛣️ 35 mpg",
          "description": "35 mpg (eficiente)"
      ...
      "infoCards": {
        ...
        "tips": {
          ...
          "items": [
            "Estimativa rápida: divida MPG por 2,35 para obter km/L",
      ...
      "education": {
        "whatIs": {
          ...
          "content": "Converta milhas por galão para quilômetros por litro para comparação internacional de economia de combustível. Inclui L/100km. Este conversor suporta todas as unidades relacionadas na categoria economia_combustível, permitindo converter entre qualquer combinação com uma única entrada."
        },
        "howItWorks": {
        ...
        "considerations": {
          ...
          "items": [
            {
              "text": "Estimativa rápida: divida MPG por 2,35 para obter km/L",
              "type": "info"
            },
            {
      ...
      "faqs": [
        ...
        },
        {
          ...
          "answer": "Este conversor suporta todas as unidades na categoria economia_combustível: mpg_us, mpg_uk, kmL, L100km. Selecione qualquer uma no menu suspenso."
        },
        {
    ...
    fr: {
      "name": "Convertisseur MPG vers KM/L",
      "slug": "calculateur-mpg-vers-kilometres-par-litre",
      "subtitle": "Convertissez MPG en KM/L et L/100km pour des comparaisons internationales de consommation de carburant.",
      "breadcrumb": "MPG vers KM/L",
      "seo": {
        "title": "Convertisseur MPG vers KM/L - Conversion de Consommation de Carburant",
        "description": "Convertissez les miles par gallon en kilomètres par litre pour la comparaison internationale de consommation de carburant. Inclut L/100km.",
        "shortDescription": "Convertissez MPG en KM/L et L/100km pour des comparaisons internationales de consommation de carburant.",
        "keywords": [
          "mpg vers km/l",
          "convertisseur consommation carburant",
          "miles par gallon vers km par litre",
          "convertisseur consommation essence",
          "convertisseur consommation carburant",
          "convertisseur mpg"
        ]
      },
      "inputs": {
        "amount": {
          ...
          "helpText": "Entrez la consommation de carburant à convertir"
        }
      },
      "results": {
        "primary": {
      ...
      "presets": {
        "city": {
          "label": "🏙️ 25 mpg",
          "description": "25 mpg (voiture urbaine)"
        },
        "highway": {
          "label": "🛣️ 35 mpg",
          "description": "35 mpg (efficace)"
        },
        "hybrid": {
          "label": "⚡ 50 mpg",
          "description": "50 mpg (hybride)"
        }
      },
      "values": {},
      "formats": {
      ...
      "infoCards": {
        ...
        "tips": {
          ...
          "items": [
            "Estimation rapide : divisez MPG par 2,35 pour obtenir km/L",
      ...
      "education": {
        "whatIs": {
          ...
          "content": "Convertissez les miles par gallon en kilomètres par litre pour la comparaison internationale de consommation de carburant. Inclut L/100km. Ce convertisseur prend en charge toutes les unités liées dans la catégorie consommation_carburant, vous permettant de convertir entre toute combinaison avec une seule saisie."
        },
        "howItWorks": {
        ...
        "considerations": {
          ...
          "items": [
            {
              "text": "Estimation rapide : divisez MPG par 2,35 pour obtenir km/L",
              "type": "info"
            },
            {
      ...
      "faqs": [
        ...
        },
        {
          ...
          "answer": "Ce convertisseur prend en charge toutes les unités de la catégorie consommation_carburant : mpg_us, mpg_uk, kmL, L100km. Sélectionnez n'importe laquelle dans le menu déroulant."
        },
        {
    ...
    de: {
      "name": "MPG zu KM/L Umrechner",
      "slug": "meilen-pro-gallone-zu-kilometer-pro-liter-rechner",
      "subtitle": "Wandeln Sie MPG in KM/L und L/100km für internationale Kraftstoffverbrauchsvergleiche um.",
      "breadcrumb": "MPG zu KM/L",
      "seo": {
        "title": "MPG zu KM/L Umrechner - Kraftstoffverbrauch Umrechnung",
        "description": "Wandeln Sie Meilen pro Gallone in Kilometer pro Liter für internationale Kraftstoffverbrauchsvergleiche um. Inklusive L/100km.",
        "shortDescription": "Wandeln Sie MPG in KM/L und L/100km für internationale Kraftstoffverbrauchsvergleiche um.",
        "keywords": [
          "mpg zu km/l",
          "kraftstoffverbrauch umrechner",
          "meilen pro gallone zu km pro liter",
          "benzinverbrauch umrechner",
          "kraftstoffverbrauch konverter",
          "mpg umrechner"
        ]
      },
      "inputs": {
        "amount": {
          ...
          "helpText": "Geben Sie den umzurechnenden Kraftstoffverbrauch ein"
        }
      },
      "results": {
        "primary": {
      ...
      "presets": {
        "city": {
          "label": "🏙️ 25 mpg",
          "description": "25 mpg (Stadtauto)"
        },
        "highway": {
          "label": "🛣️ 35 mpg",
          "description": "35 mpg (effizient)"
        },
        "hybrid": {
          "label": "⚡ 50 mpg",
          "description": "50 mpg (Hybrid)"
        }
      },
      "values": {},
      "formats": {
      ...
      "infoCards": {
        ...
        "tips": {
          ...
          "items": [
            "Schnelle Schätzung: teilen Sie MPG durch 2,35 für km/L",
      ...
      "education": {
        "whatIs": {
          ...
          "content": "Wandeln Sie Meilen pro Gallone in Kilometer pro Liter für internationale Kraftstoffverbrauchsvergleiche um. Inklusive L/100km. Dieser Umrechner unterstützt alle verwandten Einheiten in der Kraftstoffverbrauch-Kategorie und ermöglicht es Ihnen, mit einer einzigen Eingabe zwischen beliebigen Kombinationen umzurechnen."
        },
        "howItWorks": {
        ...
        "considerations": {
          ...
          "items": [
            {
              "text": "Schnelle Schätzung: teilen Sie MPG durch 2,35 für km/L",
              "type": "info"
            },
            {
      ...
      "faqs": [
        {
          ...
          "answer": "Alle Umrechnungen verwenden exakte Faktoren aus NIST- und BIPM-Internationale Standards. Ergebnisse sind auf mindestens 6 signifikante Stellen genau."
        },
        {
          "question": "Kann ich in die umgekehrte Richtung umrechnen?",
          "answer": "Ja! Ändern Sie einfach die Einheit im Dropdown-Menü, um von einer beliebigen Einheit zu allen anderen umzurechnen. Der Umrechner ist vollständig bidirektional."
        },
        {
          "question": "Welche Einheiten werden unterstützt?",
          "answer": "Dieser Umrechner unterstützt alle Einheiten in der Kraftstoffverbrauch-Kategorie: mpg_us, mpg_uk, kmL, L100km. Wählen Sie eine beliebige aus dem Dropdown-Menü."
        },
        {
...
export function calculateMpgToKmPerLiter(data: {
  ...
  const fromUnit = fieldUnits.amount || "mpg_us";

  if (amount === undefined || amount === null || amount < 0) {
    return { values: {}, formatted: {}, summary: "", isValid: false };
  }

  const unitGroup = UNIT_REGISTRY["fuel_economy"];
  ...
  for (const unit of units) {
    try {
      const converted = convert(amount, fromUnit, unit.id, "fuel_economy");
  ...
  const allUnits = ["mpg_us", "mpg_uk", "kmL", "L100km"];
...
export default mpgToKmPerLiterConfig;
