...
export const autoLoanCalculatorConfig: CalculatorConfigV4 = {
  ...
  // ─── INPUTS ───
  inputs: [
    // Vehicle Price — currency dropdown// Down Payment — currency// Include Trade-In toggle// Trade-In Value — shown when includeTradein = true// Amount Owed on Trade-In — shown when includeTradein = true// Loan Term — stepper (years)// Interest Rate — number with %// Sales Tax Rate// Include Tax & Fees in Loan toggle// Title, Registration & Fees — currency// Include Extra Payment — toggle (V4.3)// Extra Monthly Payment — revealed when includeExtraPayment = true],
