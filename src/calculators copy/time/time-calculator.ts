...
export const timeCalculatorConfig: CalculatorConfigV4 = {
  ...
  presets: [
    {
      id: "workday",
      icon: "💼",
      values: { mode: "add", hours1: 8, minutes1: 30, seconds1: 0, hours2: 1, minutes2: 45, seconds2: 0 },
    },
    {
      id: "marathon",
      icon: "🏃",
      values: { mode: "subtract", hours1: 4, minutes1: 30, seconds1: 0, hours2: 3, minutes2: 15, seconds2: 45 },
    },
    {
      id: "cooking",
      icon: "🍳",
      values: { mode: "add", hours1: 0, minutes1: 45, seconds1: 0, hours2: 0, minutes2: 20, seconds2: 30 },
    },
  ],
  ...
  t: {
    en: {
      ...
      inputs: {
        ...
        hours1: { label: "Hours", helpText: "First time — hours" },
        minutes1: { label: "Minutes", helpText: "First time — minutes" },
        seconds1: { label: "Seconds", helpText: "First time — seconds" },
        hours2: { label: "Hours", helpText: "Second time — hours" },
        minutes2: { label: "Minutes", helpText: "Second time — minutes" },
        seconds2: { label: "Seconds", helpText: "Second time — seconds" },
      },
  ...
  inputs: [
    ...
    { id: "hours1",   type: "number", width: "third", defaultValue: null, placeholder: "2",  min: 0, max: 9999, suffix: "h" },
    { id: "minutes1", type: "number", width: "third", defaultValue: null, placeholder: "30", min: 0, max: 59, suffix: "min" },
    { id: "seconds1", type: "number", width: "third", defaultValue: null, placeholder: "0",  min: 0, max: 59, suffix: "sec" },
    { id: "hours2",   type: "number", width: "third", defaultValue: null, placeholder: "1",  min: 0, max: 9999, suffix: "h" },
    { id: "minutes2", type: "number", width: "third", defaultValue: null, placeholder: "15", min: 0, max: 59, suffix: "min" },
    { id: "seconds2", type: "number", width: "third", defaultValue: null, placeholder: "0",  min: 0, max: 59, suffix: "sec" },
  ],
...
export function calculateTimeCalculator(data: {
  ...
  const h1 = (values.hours1 as number) || 0;
  const m1 = (values.minutes1 as number) || 0;
  const s1 = (values.seconds1 as number) || 0;
  const h2 = (values.hours2 as number) || 0;
  const m2 = (values.minutes2 as number) || 0;
  const s2 = (values.seconds2 as number) || 0;
