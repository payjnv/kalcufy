...
const PT = {
  ...
  presets: { weightLoss: { label: "Perda de Peso", description: "Mulher, 30, atividade moderada" }, activeMale: { label: "Homem Ativo", description: "Homem, 28, muito ativo" }, beginner: { label: "Iniciante", description: "Homem, 35, levemente ativo" },
 },
...
const FR = {
  ...
  presets: { weightLoss: { label: "Perte de Poids", description: "Femme, 30, activité modérée" }, activeMale: { label: "Homme Actif", description: "Homme, 28, très actif" }, beginner: { label: "Débutant", description: "Homme, 35, légèrement actif" },
 },
...
const DE = {
  ...
  presets: { weightLoss: { label: "Gewichtsverlust", description: "Frau, 30, mäßige Aktivität" }, activeMale: { label: "Aktiver Mann", description: "Mann, 28, sehr aktiv" }, beginner: { label: "Anfänger", description: "Mann, 35, leicht aktiv" },
 },
...
export const tdeeCalculatorConfig: CalculatorConfigV4 = {
  ...
  presets: [
    {
      id: "weightLoss",
      icon: "🔥",
      values: { gender: "female", age: 30, weight: 150, height: 165, activityLevel: "moderate", bodyFatPercent: null },
    },
    {
      id: "activeMale",
      icon: "🏃",
      values: { gender: "male", age: 28, weight: 180, height: 180, activityLevel: "active", bodyFatPercent: null },
    },
    {
      id: "beginner",
      icon: "🚶",
      values: { gender: "male", age: 35, weight: 198, height: 175, activityLevel: "light", bodyFatPercent: null },
    },],
  ...
  results: [
    ...
    { id: "bmrHarris", type: "secondary", format: "number" },
    { id: "bmrKatch", type: "secondary", format: "number" },
...
export function calculateTdee(data: {
  ...
  // Tab 2: Formula Comparison
  const formulaData: Array<Record<string, unknown>> = [
    {
  ...
  return {
    ...
    metadata: {
      chartsData: {
        ...
        "formula-comparison": formulaData,
