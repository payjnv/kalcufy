        ...
        <section className="bg-slate-50 py-12">
          <div className="container mx-auto px-4 max-w-6xl">
            ...
            <p className="text-slate-600 mb-6">
              30-year-old male, 170 lbs (77 kg), moderately active, goal: build muscle
            </p>
            <div className="grid md:grid-cols-2 gap-6">
              <div className="bg-white rounded-xl p-5">
                <h4 className="font-bold text-slate-800 mb-3">Standard Range Method</h4>
                <div className="bg-slate-50 rounded-lg p-3 font-mono text-sm text-slate-700">
                  <p>Weight: 77 kg</p>
                  <p>Goal range: 1.6-2.2 g/kg (muscle building)</p>
                  <p>Min: 77 × 1.6 = 123g</p>
                  <p>Max: 77 × 2.2 = 169g</p>
                  <p className="font-bold text-blue-600 mt-2">Daily protein: 123-169g</p>
                </div>
              </div>
              <div className="bg-white rounded-xl p-5">
                <h4 className="font-bold text-slate-800 mb-3">Per Meal Distribution</h4>
                <div className="bg-slate-50 rounded-lg p-3 font-mono text-sm text-slate-700">
                  <p>Target: 150g protein/day</p>
                  <p>4 meals: 150 ÷ 4 = 37.5g each</p>
                  <p>Example: 2 chicken breasts + 1 egg</p>
                  <p className="font-bold text-blue-600 mt-2">~35-40g per meal</p>
                </div>
              </div>
            </div>
          </div>
