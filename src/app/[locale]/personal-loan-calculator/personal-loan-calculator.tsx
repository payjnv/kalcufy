                ...
                <div className="bg-white rounded-2xl p-6 md:p-8">
                  ...
                  <div className="bg-blue-50 rounded-xl p-6 mb-4">
                    <p className="font-mono text-slate-700">
                      ...
                      Monthly Rate: 10% ÷ 12 = 0.833%<br />
                      M = $20,000 × [0.00833(1.00833)<sup>36</sup>] / [(1.00833)<sup>36</sup>-1]<br />
                      <strong className="text-blue-600">M = $645/month</strong>
                    </p>
                  </div>
                  <p className="text-slate-600">
                    Over the life of the loan, you'll pay approximately <strong>$23,220</strong> total, with <strong>$3,220 in interest</strong>.
                  </p>
                </div>
