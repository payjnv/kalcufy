...
export default function CompoundInterestCalculator() {
  ...
  const { t, translations, loading } = useCalcTranslations(locale, CALCULATOR_SLUG);
            ...
            <div className="flex items-center gap-4 mb-2">
              ...
              <div>
                ...
                <div className="flex items-center gap-2 h-6">
                  <p className="text-slate-600">See how your money grows over time with compound interest</p>
                  {saveStatus !== 'idle' && (
                    <>
          ...
          <div className="container">
            <div className="grid lg:grid-cols-2 gap-8">
              ...
              <div className="bg-white rounded-2xl border border-slate-200 p-6 md:p-8">
                <h2 className="text-xl font-bold text-slate-900 mb-6">Investment Details</h2>
                ...
                <div className="mb-6">
                  <div className="flex justify-between items-center mb-2">
                    <label className="font-medium text-slate-700">Investment Period</label>
                    <div className="flex items-center bg-slate-100 rounded-lg px-3 py-1">
                      <input
                        type="text"
                        value={years}
                ...
                <div className="mb-6">
                  ...
                  <p className="text-xs text-slate-400 mt-1">When do you make your contributions?</p>
                </div>
                  ...
                  {showAdvanced && (
                    <div className="p-4 space-y-5 bg-white">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-slate-400 mt-1">Applied to interest earned (e.g., 25% marginal rate)</p>
                      </div>
                      ...
                      <div>
                        ...
                        <p className="text-xs text-slate-400 mt-1">Average U.S. inflation is ~3% per year</p>
                      </div>
                    </div>
                  )}
                </div>
              ...
              <div>
                ...
                <div className="bg-slate-50 rounded-2xl border border-slate-200 p-6 md:p-8 mb-4">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    <div className="bg-white rounded-xl p-4 border border-slate-200">
                      <p className="text-sm text-slate-600">Total Interest Earned</p>
                    ...
                    {inflationRate > 0 && (
                      <div className="col-span-2 bg-white rounded-xl p-4 border border-slate-200">
                        <p className="text-sm text-slate-600">Inflation-Adjusted Value</p>
                        <p className="text-xl font-bold text-amber-600">{formatMoney(inflationAdjustedValue)}</p>
                        <p className="text-xs text-slate-400 mt-1">Purchasing power in today's dollars</p>
                      </div>
                    )}
                  </div>
                </div>
            ...
            <div className="grid md:grid-cols-2 gap-6 mt-8">
              ...
              <div className="bg-white rounded-2xl border border-slate-200 p-6">
                <h3 className="text-lg font-bold text-slate-900 mb-4">💡 The Power of Starting Early</h3>
                <p className="text-slate-600 mb-4">
                  Time is the most important factor in compound interest. Consider:
                </p>
                <ul className="space-y-2 text-slate-600">
                  <li className="flex items-start gap-2">
                    <span className="text-blue-600 mt-1">•</span>
                    <span><strong>Start at 25:</strong> $200/mo at 7% = $528,000 by 65</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-blue-600 mt-1">•</span>
                    <span><strong>Start at 35:</strong> $200/mo at 7% = $244,000 by 65</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-blue-600 mt-1">•</span>
                    <span><strong>Start at 45:</strong> $200/mo at 7% = $104,000 by 65</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-blue-600 mt-1">•</span>
                    <span><strong>10 years earlier</strong> can mean 2x the ending balance!</span>
                  </li>
                </ul>
              </div>
              ...
              {/* Rule of 72 Table */}
              <div className="bg-white rounded-2xl border border-slate-200 p-6">
                <h3 className="text-lg font-bold text-slate-900 mb-4">📊 Rule of 72: Years to Double</h3>
                <div className="overflow-x-auto">
                  <table className="w-full text-sm">
                    <thead>
                      <tr className="border-b border-slate-200">
                        <th className="text-left py-2 font-semibold text-slate-700">Interest Rate</th>
                        <th className="text-right py-2 font-semibold text-slate-700">Years to Double</th>
                        <th className="text-right py-2 font-semibold text-slate-700">$10K Becomes</th>
                      </tr>
                    </thead>
                    <tbody>
                      <tr className="border-b border-slate-100">
                        <td className="py-2 text-slate-600">4%</td>
                        <td className="py-2 text-right font-medium text-blue-600">18 years</td>
                        <td className="py-2 text-right font-medium text-emerald-700">$20,000</td>
                      </tr>
                      <tr className="border-b border-slate-100">
                        <td className="py-2 text-slate-600">6%</td>
                        <td className="py-2 text-right font-medium text-blue-600">12 years</td>
                        <td className="py-2 text-right font-medium text-emerald-700">$20,000</td>
                      </tr>
                      <tr className="border-b border-slate-100">
                        <td className="py-2 text-slate-600">8%</td>
                        <td className="py-2 text-right font-medium text-blue-600">9 years</td>
                        <td className="py-2 text-right font-medium text-emerald-700">$20,000</td>
                      </tr>
                      <tr className="border-b border-slate-100">
                        <td className="py-2 text-slate-600">10%</td>
                        <td className="py-2 text-right font-medium text-blue-600">7.2 years</td>
                        <td className="py-2 text-right font-medium text-emerald-700">$20,000</td>
                      </tr>
                      <tr className="border-b border-slate-100">
                        <td className="py-2 text-slate-600">12%</td>
                        <td className="py-2 text-right font-medium text-blue-600">6 years</td>
                        <td className="py-2 text-right font-medium text-emerald-700">$20,000</td>
                      </tr>
                    </tbody>
                  </table>
                </div>
                <p className="text-xs text-slate-400 mt-3">*Formula: 72 ÷ Interest Rate = Years to Double</p>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="py-6 bg-white">
          <div className="container">
            <div className="bg-white rounded-2xl border border-slate-200 p-6 md:p-8">
              ...
              <p className="text-slate-600 mb-4">
                Let's calculate the future value of <strong>$10,000</strong> with <strong>$100/month</strong> contributions at <strong>7% interest</strong> compounded monthly for <strong>10 years</strong>:
              </p>
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  <div>
                    <p className="font-mono text-slate-700 text-sm">
                      ...
                      Monthly Contribution: $100<br />
                      Total Contributions: $22,000
                    </p>
                  </div>
                  <div>
                    <p className="font-mono text-slate-700 text-sm">
                      Interest Rate: 7% / 12 = 0.583%<br />
                      Periods: 10 × 12 = 120<br />
                      <strong className="text-blue-600">Future Value: $37,566</strong>
                    </p>
                  </div>
                </div>
              </div>
              <p className="text-slate-600">
                You invested <strong>$22,000</strong> and earned <strong className="text-green-600">$15,566 in interest</strong> - that's a 71% return on your contributions!
              </p>
            </div>
          </div>
        </section>
            ...
            <div className="grid lg:grid-cols-3 gap-8">
              ...
              <div className="lg:col-span-2 space-y-6">
                ...
                <div className="bg-white rounded-2xl p-6 md:p-8">
                  ...
                  <p className="text-slate-600 mb-4">
                    Compound interest is interest calculated on both the initial principal and the accumulated interest from previous periods. Unlike simple interest (which is only calculated on the principal), compound interest creates a "snowball effect" where your earnings generate their own earnings.
                  </p>
                  <p className="text-slate-600">
                    Albert Einstein reportedly called compound interest "the eighth wonder of the world," stating that those who understand it earn it, while those who don't pay it. This calculator helps you visualize how your money can grow exponentially over time.
                  </p>
                </div>
                ...
                <div className="bg-white rounded-2xl p-6 md:p-8">
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="flex gap-4"><span className="font-bold text-blue-600 w-8">t</span><span className="text-slate-600">= Number of years</span></div>
                  </div>
                </div>

                {/* Tips */}
                <div className="bg-white rounded-2xl p-6 md:p-8">
                  <h2 className="text-2xl font-bold text-slate-900 mb-4">💡 Maximize Your Compound Interest</h2>
                  <div className="space-y-4">
                    <div className="flex gap-4"><span className="text-2xl">⏰</span><div><h3 className="font-semibold text-slate-900">Start Early</h3><p className="text-slate-600">Time is more powerful than the amount you invest. Starting 10 years earlier can double your ending balance.</p></div></div>
                    <div className="flex gap-4"><span className="text-2xl">💰</span><div><h3 className="font-semibold text-slate-900">Contribute Regularly</h3><p className="text-slate-600">Consistent monthly contributions compound over time, turning small amounts into significant wealth.</p></div></div>
                    <div className="flex gap-4"><span className="text-2xl">🔄</span><div><h3 className="font-semibold text-slate-900">Reinvest Earnings</h3><p className="text-slate-600">Never withdraw your interest. Let it compound and generate its own returns.</p></div></div>
                    <div className="flex gap-4"><span className="text-2xl">📈</span><div><h3 className="font-semibold text-slate-900">Seek Higher Returns</h3><p className="text-slate-600">Even 1-2% higher returns make a massive difference over decades. Consider index funds or diversified investments.</p></div></div>
                  </div>
                </div>
