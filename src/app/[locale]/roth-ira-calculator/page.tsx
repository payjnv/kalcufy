          ...
          <div className="container">
            <div className="bg-white rounded-2xl border border-slate-200 p-6 md:p-8">
              ...
              <p className="text-slate-600 mb-4">
                Let's calculate the future value of <strong>$10,000</strong> with <strong>$7,000/year</strong> contributions at <strong>7% interest</strong> for <strong>35 years</strong>:
              </p>
              <div className="bg-blue-50 rounded-xl p-6 mb-4">
                <div className="grid md:grid-cols-2 gap-4">
                  <div className="font-mono text-slate-700 text-sm space-y-1">
                    <p>Initial Investment: $10,000</p>
                    <p>Annual Contribution: $7,000</p>
                    <p>Total Contributions: $255,000</p>
                  </div>
                  <div className="font-mono text-slate-700 text-sm space-y-1">
                    <p>Interest Rate: 7%</p>
                    <p>Years: 35</p>
                    <p className="text-blue-600 font-bold">Future Value: $1,066,000</p>
                  </div>
                </div>
              </div>
              <p className="text-slate-600">
                You invested <strong>$255,000</strong> and earned <strong className="text-cyan-600">$811,000 in earnings</strong> - that's a 318% return on your contributions, all tax-free!
              </p>
            </div>
          </div>
        </section>
