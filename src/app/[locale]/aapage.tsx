          ...
          <div className="container text-center">
            ...
            <div className="flex flex-wrap justify-center gap-10">
              <div className="text-center">
                ...
                <div className="text-slate-600 text-sm">{t("stats.calculations")}</div>
              </div>
              <div className="text-center">
                <div className="text-3xl font-bold text-blue-600">50K+</div>
                <div className="text-slate-600 text-sm">{t("stats.users")}</div>
              </div>
              <div className="text-center">
                <div className="text-3xl font-bold text-blue-600">{totalCalculators}+</div>
                <div className="text-slate-600 text-sm">{t("stats.calculators")}</div>
              </div>
            </div>
          </div>
        </section>
