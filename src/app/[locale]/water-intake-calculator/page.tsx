        ...
        <section className="bg-slate-50 py-12">
          <div className="container mx-auto px-4 max-w-6xl">
            ...
            <p className="text-slate-600 mb-6">
              30-year-old, 170 lbs (77 kg), moderately active, temperate climate
            </p>
            <div className="grid md:grid-cols-2 gap-6">
              <div className="bg-white rounded-xl p-5">
                <h4 className="font-bold text-slate-800 mb-3">Base Calculation</h4>
                <div className="bg-slate-50 rounded-lg p-3 font-mono text-sm text-slate-700">
                  <p>Weight: 170 lbs</p>
                  <p>Base: 170 × 0.5 = 85 oz</p>
                  <p>Activity modifier: +20%</p>
                  <p>85 × 1.2 = 102 oz</p>
                  <p className="font-bold text-blue-600 mt-2">Daily intake: ~102 oz (3 L)</p>
                </div>
              </div>
              <div className="bg-white rounded-xl p-5">
                <h4 className="font-bold text-slate-800 mb-3">Hourly Distribution</h4>
                <div className="bg-slate-50 rounded-lg p-3 font-mono text-sm text-slate-700">
                  <p>Daily target: 102 oz</p>
                  <p>Waking hours: 16</p>
                  <p>102 ÷ 16 = 6.4 oz/hour</p>
                  <p className="font-bold text-blue-600 mt-2">~1 glass every 1-2 hours</p>
                </div>
              </div>
            </div>
          </div>
