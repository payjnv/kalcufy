      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-blue-600 via-blue-700 to-indigo-800 p-12 flex-col justify-between">
        ...
        <div>
          <h1 className="text-4xl font-bold text-white mb-6">
            Calculate smarter,<br />decide better.
          </h1>
          <p className="text-blue-100 text-lg">
            Access 30+ professional calculators for finance, health, and more. Save your calculations and track your progress.
          </p>
        </div>
        ...
        <div className="flex items-center gap-4">
          ...
          <p className="text-blue-100 text-sm">Join 10,000+ users</p>
        </div>
      </div>
